...
// RUN: circt-synth %s -o %t.before.mlir --output-longest-path=- | FileCheck %s --check-prefix=LONGEST_PATH_BEFORE
// RUN: circt-synth %s -enable-sop-balancing -o %t.after.mlir --output-longest-path=- | FileCheck %s --check-prefix=LONGEST_PATH_AFTER
