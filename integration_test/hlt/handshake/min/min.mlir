...
// RUN: circt-opt %s.kernel -lower-std-to-handshake -canonicalize='top-down=true region-simplify=true' -handshake-insert-buffer='strategies=cycles' > ${TESTNAME}_handshake.mlir
