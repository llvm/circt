...
# CHECK: module  {
# CHECK:   hw.module.extern @ichi(input %a : i2, input %b : i3, output c : i4, output d : i5)
# CHECK:   hw.module @owo(output owo_result : i32) {
...
# CHECK:     hw.output
# CHECK:   }
# CHECK:   hw.module @nya(input %nya_input : i32) {
# CHECK:     hw.instance "uwu1" @uwu() -> ()
# CHECK:     hw.output
# CHECK:   }
# CHECK:   hw.module @test(output test_result : i32) {
