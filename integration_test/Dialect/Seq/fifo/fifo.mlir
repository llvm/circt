...
hw.module @fifo(input %clk : !seq.clock, input %rst : i1, input %inp : i32, input %rdEn : i1, input %wrEn : i1, output out: i32, output empty: i1, output full: i1, output almost_empty : i1, output almost_full : i1) {
