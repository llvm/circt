...
hw.module @top(input %in0: !dc.value<i64>, input %in1: !dc.value<i64>, input %in2: !dc.value<i64>, input %in3: !dc.value<i64>, input %in4: !dc.value<i64>, input %in5: !dc.value<i64>, input %in6: !dc.value<i64>, input %in7: !dc.value<i64>, input %in8: !dc.token, input %clock : i1, input %reset : i1, output %out0: !dc.value<i64>, out1: !dc.token) {
