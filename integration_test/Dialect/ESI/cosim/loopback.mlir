...
// RUN: circt-opt %t4.mlir --lower-esi-to-physical --lower-esi-ports --lower-esi-to-hw --lower-seq-to-sv --export-split-verilog -o %t3.mlir
...
hw.module @intLoopback(input %clk: !seq.clock, input %rst:i1) {
...
hw.module @twoListLoopback(input %clk: !seq.clock, input %rst:i1) {
...
hw.module @TwoChanLoopback(input %clk: !seq.clock) {
