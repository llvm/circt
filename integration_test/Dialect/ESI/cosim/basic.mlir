// REQUIRES: esi-cosim
// RUN: circt-opt %s --lower-esi-to-physical --lower-esi-ports --lower-esi-to-hw --lower-seq-to-sv | circt-opt --export-verilog -o %t3.mlir > %t1.sv
...
hw.module @array(input %clk: !seq.clock, input %rst: i1) {
