// REQUIRES: rtl-sim
// RUN: circt-opt %s --lower-esi-to-physical --lower-esi-ports --lower-esi-to-hw --lower-seq-to-sv -verify-diagnostics > %t1.mlir
...
hw.module.extern @IntCountProd(input %clk: !seq.clock, input %rst: i1, output %ints: !esi.channel<i32>) attributes {esi.bundle}
hw.module.extern @IntAcc(input %clk: !seq.clock, input %rst: i1, input %ints: !esi.channel<i32>, output %totalOut: i32) attributes {esi.bundle}
hw.module @top(input %clk: !seq.clock, input %rst: i1, output %totalOut: i32) {
