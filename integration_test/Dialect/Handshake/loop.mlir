...
// RUN: circt-opt %loop-handshake.mlir --lower-handshake-to-firrtl --firrtl-lower-types --lower-firrtl-to-hw --hw-cleanup --simple-canonicalizer --cse --hw-legalize-names > %loop-hw.mlir
