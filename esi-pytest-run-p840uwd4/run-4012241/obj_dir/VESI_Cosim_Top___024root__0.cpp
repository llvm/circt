            ...
            if (vlSymsp->_vm_contextp__->assertOnGet(2, 1)) {
                if (VL_UNLIKELY((vlSelfRef.ESI_Cosim_Top__DOT_____05Fcosim_hostmem_write_result__DOT__out_pipe__DOT__l_valid))) {
                    VL_WRITEF_NX("[%0t] %%Error: ESIPrimitives.sv:107: Assertion failed in %NESI_Cosim_Top.__cosim_hostmem_write_result.out_pipe: 'assert' failed.\n",0,
                                 64,VL_TIME_UNITED_Q(1),
                                 -12,vlSymsp->name());
                    VL_STOP_MT("/workspace/circt/esi-pytest-run-p840uwd4/hw/ESIPrimitives.sv", 107, "");
                }
            }
    ...
    do {
...
#endif
            VL_FATAL_MT("/workspace/circt/esi-pytest-run-p840uwd4/hw/ESI_Cosim_Top.sv", 18, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                VESI_Cosim_Top___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("/workspace/circt/esi-pytest-run-p840uwd4/hw/ESI_Cosim_Top.sv", 18, "", "Active region did not converge after 100 tries");
            }
