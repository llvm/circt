...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc9_TOP__Cosim_DpiPkg(std::string endpoint_id, const VlUnpacked<CData/*7:0*/, 8> &data, IData/*31:0*/ data_size, IData/*31:0*/ &cosim_ep_tryput__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc9_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc10_TOP__Cosim_DpiPkg(std::string endpoint_id, VlUnpacked<CData/*7:0*/, 13> &data, IData/*31:0*/ &data_size, IData/*31:0*/ &cosim_ep_tryget__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc10_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
    static const int data__Vopenprops__ulims[2] = {12, 0};
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc9_TOP__Cosim_DpiPkg(std::string endpoint_id, VlUnpacked<CData/*7:0*/, 1> &data, IData/*31:0*/ &data_size, IData/*31:0*/ &cosim_ep_tryget__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc9_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
    static const int data__Vopenprops__ulims[2] = {0, 0};
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_set_manifest__Vdpioc2_TOP__Cosim_DpiPkg(IData/*31:0*/ esi_version, const VlUnpacked<CData/*7:0*/, 1921> &compressed_manifest) {
    ...
    static const int compressed_manifest__Vopenprops__ulims[2] = {1920, 0};
