...
hw.module @constant_fold0(in %zeroWitdh: i0, out res: !sim.fstring) {
  ...
  %w0H = sim.fmt.hex %zeroWitdh, isUpper true, left_align false, paddingChar 48 : i0
  ...
  %w1H0 = sim.fmt.hex %cst0_1, isUpper true, left_align false, paddingChar 48 : i1
  ...
  %w1H1 = sim.fmt.hex %cst1_1, isUpper true, left_align false, paddingChar 48 : i1
  ...
  %w4H3 = sim.fmt.hex %cst3_4, isUpper true, left_align false, paddingChar 48 : i4
  ...
  %w5H10 = sim.fmt.hex %cst10_5, isUpper true, left_align false, paddingChar 48 : i5
  ...
  %w8H128 = sim.fmt.hex %cst128_8, isUpper true, left_align false, paddingChar 48 : i8
  ...
  %w22Hcafe = sim.fmt.hex %cstcafe_22, isUpper true, left_align false, paddingChar 48 : i22
...
hw.module @constant_fold1(out res: !sim.fstring) {
  ...
  %w123H42 = sim.fmt.hex %cst42_123, isUpper true, left_align false, paddingChar 48 : i123
...
hw.module @flatten_concat1(in %val : i8, out res: !sim.fstring) {
  ...
  %hexLowVal = sim.fmt.hex %val, isUpper false, left_align false, paddingChar 48 : i8
  %hexLowCat = sim.fmt.concat (%hexLowLit, %hexLowVal)

  %hexUpLit = sim.fmt.literal "HexUpper: "
  %hexUpVal = sim.fmt.hex %val, isUpper true, left_align false, paddingChar 48 : i8
