...
sim.func.dpi @foo(out arg0: i32, in %arg1: i32, out ret: i32 {sim.func.explicitly_returned})
...
sim.func.dpi @bar(out arg0: i32, in %arg1: i32, out ret: i32 {sim.func.explicitly_returned}) attributes {verilogName="bar_c_name"}
...
sim.func.dpi @baz(out arg0: i32, in %arg1: i32, out ret: i32 {sim.func.explicitly_returned}) attributes {verilogName="baz_c_name"}
...
sim.func.dpi @open_array_rw(in %wd: !llvm.ptr, out rd: !llvm.ptr {sim.func.dpi.byref})
