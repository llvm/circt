...
firrtl.circuit "NLAInlining" {
  // CHECK-NEXT: hw.globalRef @nla1 [@NLAInlining::@bar, @Bar]
  // CHECK-NEXT: hw.globalRef @nla2 [@NLAInlining::@bar, @Bar::@a]
  // CHECK-NEXT: hw.globalRef @nla3 [@NLAInlining::@bar, @Bar::@port]
  // CHECK-NOT:  hw.globalRef @nla4
  // CHECK-NOT:  hw.globalRef @nla5
  hw.globalRef @nla1 [@NLAInlining::@foo, @Foo::@bar, @Bar]
  hw.globalRef @nla2 [@NLAInlining::@foo, @Foo::@bar, @Bar::@a]
  hw.globalRef @nla3 [@NLAInlining::@foo, @Foo::@bar, @Bar::@port]
  hw.globalRef @nla4 [@NLAInlining::@foo, @Foo]
  hw.globalRef @nla5 [@NLAInlining::@foo, @Foo::@b]
  hw.globalRef @nla6 [@NLAInlining::@foo, @Foo::@port]
...
firrtl.circuit "NLAInliningNotMainRoot" {
  // CHECK-NEXT: hw.globalRef @nla1 [@NLAInliningNotMainRoot::@baz, @Baz::@a]
  // CHECK-NEXT: hw.globalRef @nla1_0 [@Foo::@baz, @Baz::@a]
  // CHECK-NEXT: hw.globalRef @nla2 [@NLAInliningNotMainRoot::@baz, @Baz::@port]
  // CHECK-NEXT: hw.globalRef @nla2_0 [@Foo::@baz, @Baz::@port]
  hw.globalRef @nla1 [@Bar::@baz, @Baz::@a]
  hw.globalRef @nla2 [@Bar::@baz, @Baz::@port]
...
firrtl.circuit "NLAFlattening" {
  // CHECK-NEXT: hw.globalRef @nla1 [@NLAFlattening::@foo, @Foo::@a]
  // CHECK-NEXT: hw.globalRef @nla2 [@NLAFlattening::@foo, @Foo::@port]
  // CHECK-NOT:  hw.globalRef @nla3
  // CHECK-NOT:  hw.globalRef @nla4
  hw.globalRef @nla1 [@NLAFlattening::@foo, @Foo::@bar, @Bar::@baz, @Baz::@a]
  hw.globalRef @nla2 [@NLAFlattening::@foo, @Foo::@bar, @Bar::@baz, @Baz::@port]
  hw.globalRef @nla3 [@NLAFlattening::@foo, @Foo::@bar, @Bar::@baz, @Baz]
  hw.globalRef @nla4 [@Foo::@bar, @Bar::@b]
  firrtl.module @Baz(
    in %port: !firrtl.uint<1> sym @port [{circt.nonlocal = @nla2, class = "nla2"}]
...
firrtl.circuit "NLAFlatteningChildRoot" {
  // CHECK-NOT:  hw.globalRef @nla1
  // CHECK-NOT:  hw.globalRef @nla2
  // CHECK-NEXT: hw.globalRef @nla3 [@Baz::@quz, @Quz::@b]
  // CHECK-NEXT: hw.globalRef @nla4 [@Baz::@quz, @Quz::@Quz_port]
  hw.globalRef @nla1 [@Bar::@qux, @Qux::@a]
  hw.globalRef @nla2 [@Bar::@qux, @Qux::@Qux_port]
  hw.globalRef @nla3 [@Baz::@quz, @Quz::@b]
  hw.globalRef @nla4 [@Baz::@quz, @Quz::@Quz_port]
...
firrtl.circuit "CollidingSymbols" {
  // CHECK-NEXT: hw.globalRef @nla1 [@CollidingSymbols::@[[FoobarSym:[_a-zA-Z0-9]+]], @Bar]
  hw.globalRef @nla1 [@CollidingSymbols::@foo, @Foo::@bar, @Bar]
...
firrtl.circuit "CollidingSymbolsPort" {
  // CHECK-NEXT: hw.globalRef @nla1 [@CollidingSymbolsPort::@foo, @Foo::@[[BarbSym:[_a-zA-Z0-9]+]]]
  hw.globalRef @nla1 [@CollidingSymbolsPort::@foo, @Foo::@bar, @Bar::@b]
...
firrtl.circuit "CollidingSymbolsReTop" {
  ...
  // CHECK-NEXT: hw.globalRef @nla1 [@CollidingSymbolsReTop::@[[TopbazSym:[_a-zA-Z0-9]+]], @Baz::@a]
  // CHECK-NEXT: hw.globalRef @nla1_0 [@Foo::@[[FoobazSym:[_a-zA-Z0-9]+]], @Baz::@a]
  hw.globalRef @nla1 [@Bar::@baz, @Baz::@a]
...
firrtl.circuit "CollidingSymbolsNLAFixup" {
  // CHECK: hw.globalRef @nla0 [@Foo::@bar, @Bar::@io]
  hw.globalRef @nla0 [@Foo::@bar, @Bar::@baz0, @Baz::@io]

  // CHECK: hw.globalRef @nla1 [@Foo::@bar, @Bar::@w]
  hw.globalRef @nla1 [@Foo::@bar, @Bar::@baz0, @Baz::@w]
...
hw.globalRef @nla_5560 [@Bar0::@leaf, @Leaf::@w]
hw.globalRef @nla_5561 [@Bar1::@leaf, @Leaf::@w]
...
hw.globalRef @nla_5560 [@AnnotationSplit1::@bar0, @Bar0::@leaf, @Leaf::@w]
hw.globalRef @nla_5561 [@AnnotationSplit1::@bar1, @Bar1::@leaf, @Leaf::@w]
firrtl.module @Leaf() attributes {annotations = [{class = "firrtl.passes.InlineAnnotation"}]} {
  %w = firrtl.wire sym @w {annotations = [
    {circt.nonlocal = @nla_5560, class = "test0"},
    {circt.nonlocal = @nla_5561, class = "test1"}]} : !firrtl.uint<8>
