...
module  {
  firrtl.circuit "Foo" attributes {annotations = [{class = "sifive.enterprise.grandcentral.AugmentedBundleType", defName = "View", elements = [{name = "sub_port", tpe = "sifive.enterprise.grandcentral.AugmentedGroundType"}]}]}  {
    ...
    firrtl.module @Foo(in %a: !firrtl.uint<1>) attributes {annotations = [{class = "sifive.enterprise.grandcentral.GrandCentralView$SerializedViewAnnotation", id = 0 : i64, type = "parent"}]} {
      ...
      %bar_a = firrtl.instance @Bar  {annotations = [{a}, {class = "sifive.enterprise.grandcentral.AugmentedGroundType", defName = "View", name = "sub_port", target = [".a"]}], name = "bar"} : !firrtl.uint<1>
...
module  {
  firrtl.circuit "Foo" attributes {annotations = [{class = "sifive.enterprise.grandcentral.AugmentedBundleType", defName = "View", elements = [{name = "sub_port", tpe = "sifive.enterprise.grandcentral.AugmentedGroundType"}]}]}  {
    firrtl.module @Foo(in %a: !firrtl.uint<1>) attributes {annotations = [{class = "sifive.enterprise.grandcentral.GrandCentralView$SerializedViewAnnotation", id = 0 : i64, type = "parent"}]} {
      ...
      %memory_b_r = firrtl.mem Undefined  {annotations = [{a}, {class = "sifive.enterprise.grandcentral.AugmentedGroundType", defName = "View", name = "some_mem", target = []}], depth = 16 : i64, name = "memory_b", portNames = ["r"], readLatency = 0 : i32, writeLatency = 1 : i32} : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: uint<8>>
    }
  }
}
