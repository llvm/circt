...
firrtl.circuit "BundlePropagation1"   {
  ...
  firrtl.module @BundlePropagation1(in %clock: !firrtl.clock, out %result: !firrtl.uint<3>) {
    ...
    %0 = firrtl.subfield %tmp[0] : !firrtl.bundle<a: uint<3>, b: uint<3>, c: uint<3>>
    %1 = firrtl.subfield %tmp[1] : !firrtl.bundle<a: uint<3>, b: uint<3>, c: uint<3>>
    %2 = firrtl.subfield %tmp[2] : !firrtl.bundle<a: uint<3>, b: uint<3>, c: uint<3>>
...
firrtl.circuit "InputPortTop"  {
  ...
  firrtl.module @InputPortChild2(in %in0: !firrtl.bundle<v: uint<1>>, in %in1: !firrtl.bundle<v: uint<1>>, out %out: !firrtl.bundle<v: uint<1>>) {
    %0 = firrtl.subfield %in1[0] : !firrtl.bundle<v: uint<1>>
    %1 = firrtl.subfield %in0[0] : !firrtl.bundle<v: uint<1>>
    %2 = firrtl.subfield %out[0] : !firrtl.bundle<v: uint<1>>
  ...
  firrtl.module @InputPortTop(in %x: !firrtl.bundle<v: uint<1>>, out %z: !firrtl.bundle<v: uint<1>>, out %z2: !firrtl.bundle<v: uint<1>>) {
    %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
    %0 = firrtl.subfield %z2[0] : !firrtl.bundle<v: uint<1>>
    %1 = firrtl.subfield %x[0] : !firrtl.bundle<v: uint<1>>
    %2 = firrtl.subfield %z[0] : !firrtl.bundle<v: uint<1>>
    ...
    %3 = firrtl.subfield %c_in1[0] : !firrtl.bundle<v: uint<1>>
    %4 = firrtl.subfield %c_in0[0] : !firrtl.bundle<v: uint<1>>
    %5 = firrtl.subfield %c_out[0] : !firrtl.bundle<v: uint<1>>
    ...
    %6 = firrtl.subfield %c2_in1[0] : !firrtl.bundle<v: uint<1>>
    %7 = firrtl.subfield %c2_in0[0] : !firrtl.bundle<v: uint<1>>
    %8 = firrtl.subfield %c2_out[0] : !firrtl.bundle<v: uint<1>>
...
firrtl.circuit "rhs_sink_output_used_as_wire" {
  ...
  firrtl.module @Bar(in %a: !firrtl.bundle<v: uint<1>>, in %b: !firrtl.bundle<v: uint<1>>, out %c: !firrtl.bundle<v: uint<1>>, out %d: !firrtl.bundle<v: uint<1>>) {
    %0 = firrtl.subfield %d[0] : !firrtl.bundle<v: uint<1>>
    %1 = firrtl.subfield %a[0] : !firrtl.bundle<v: uint<1>>
    %2 = firrtl.subfield %b[0] : !firrtl.bundle<v: uint<1>>
    %3 = firrtl.subfield %c[0] : !firrtl.bundle<v: uint<1>>
    firrtl.strictconnect %3, %2 : !firrtl.uint<1>
    %_c = firrtl.wire  : !firrtl.bundle<v: uint<1>>
    %4 = firrtl.subfield %_c[0] : !firrtl.bundle<v: uint<1>>
  ...
  firrtl.module @rhs_sink_output_used_as_wire(in %a: !firrtl.bundle<v: uint<1>>, in %b: !firrtl.bundle<v: uint<1>>, out %c: !firrtl.bundle<v: uint<1>>, out %d: !firrtl.bundle<v: uint<1>>) {
    ...
    %0 = firrtl.subfield %a[0] : !firrtl.bundle<v: uint<1>>
    %1 = firrtl.subfield %bar_a[0] : !firrtl.bundle<v: uint<1>>
    firrtl.strictconnect %1, %0 : !firrtl.uint<1>
    %2 = firrtl.subfield %b[0] : !firrtl.bundle<v: uint<1>>
    %3 = firrtl.subfield %bar_b[0] : !firrtl.bundle<v: uint<1>>
    firrtl.strictconnect %3, %2 : !firrtl.uint<1>
    %4 = firrtl.subfield %bar_c[0] : !firrtl.bundle<v: uint<1>>
    %5 = firrtl.subfield %c[0] : !firrtl.bundle<v: uint<1>>
    firrtl.strictconnect %5, %4 : !firrtl.uint<1>
    %6 = firrtl.subfield %bar_d[0] : !firrtl.bundle<v: uint<1>>
    %7 = firrtl.subfield %d[0] : !firrtl.bundle<v: uint<1>>
...
firrtl.circuit "Oscillators"  {
  ...
  firrtl.module @Foo(in %clock: !firrtl.clock, in %reset: !firrtl.asyncreset, out %a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>) {
    %c0_ui1 = firrtl.constant 0 : !firrtl.uint<1>
    %0 = firrtl.subfield %a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %1 = firrtl.subfield %a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
  ...
  firrtl.module @Bar(in %clock: !firrtl.clock, in %reset: !firrtl.asyncreset, out %a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>) {
    %c0_ui1 = firrtl.constant 0 : !firrtl.uint<1>
    %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
    %0 = firrtl.subfield %a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %1 = firrtl.subfield %a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %r = firrtl.reg %clock  : !firrtl.uint<1>
    %s = firrtl.regreset %clock, %reset, %c0_ui1  : !firrtl.asyncreset, !firrtl.uint<1>, !firrtl.uint<1>
  ...
  firrtl.module @Qux(in %clock: !firrtl.clock, in %reset: !firrtl.asyncreset, out %a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>) {
    ...
    %2 = firrtl.subfield %ext_a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %3 = firrtl.subfield %ext_a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %r = firrtl.reg %clock  : !firrtl.uint<1>
    %s = firrtl.regreset %clock, %reset, %c0_ui1  : !firrtl.asyncreset, !firrtl.uint<1>, !firrtl.uint<1>
  ...
  firrtl.module @Oscillators(in %clock: !firrtl.clock, in %reset: !firrtl.asyncreset, out %foo_a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>, out %bar_a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>, out %baz_a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>, out %qux_a: !firrtl.bundle<v1: uint<1>, v2: uint<1>>) {
    %0 = firrtl.subfield %qux_a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %1 = firrtl.subfield %qux_a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %2 = firrtl.subfield %baz_a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %3 = firrtl.subfield %baz_a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %4 = firrtl.subfield %bar_a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %5 = firrtl.subfield %bar_a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %6 = firrtl.subfield %foo_a[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %7 = firrtl.subfield %foo_a[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    ...
    %8 = firrtl.subfield %foo_a_0[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %9 = firrtl.subfield %foo_a_0[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    ...
    %10 = firrtl.subfield %bar_a_1[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %11 = firrtl.subfield %bar_a_1[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    ...
    %12 = firrtl.subfield %baz_a_2[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %13 = firrtl.subfield %baz_a_2[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    ...
    %14 = firrtl.subfield %qux_a_3[1] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
    %15 = firrtl.subfield %qux_a_3[0] : !firrtl.bundle<v1: uint<1>, v2: uint<1>>
...
firrtl.circuit "dntOutput"  {
  firrtl.module @dntOutput(out %b: !firrtl.bundle<v: uint<3>>, in %c: !firrtl.uint<1>) {
    %c2_ui3 = firrtl.constant 2 : !firrtl.uint<3>
    %0 = firrtl.subfield %b[0] : !firrtl.bundle<v: uint<3>>
    %int_b = firrtl.instance int  @foo(out b: !firrtl.bundle<v: uint<3>>)
    %1 = firrtl.subfield %int_b[0] : !firrtl.bundle<v: uint<3>>
