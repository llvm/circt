...
firrtl.circuit "xmr" {
  firrtl.module private @Test(out %x: !firrtl.ref<uint<2>>) {
    ...
    firrtl.ref.define %x, %1 : !firrtl.ref<uint<2>>, !firrtl.ref<uint<2>>
  }
  firrtl.module @xmr() {
...
firrtl.circuit "ForwardToInstance" {
  ...
  firrtl.module @Bar(out %_a: !firrtl.ref<uint<1>>) {
    ...
    firrtl.ref.define %_a, %bar_2 : !firrtl.ref<uint<1>>, !firrtl.ref<uint<1>>
  }
...
firrtl.circuit "DUT" {
  firrtl.module private @Submodule (out %ref_out1: !firrtl.ref<uint<1>>, out %ref_out2: !firrtl.ref<uint<4>>) {
    ...
    firrtl.ref.define %ref_out1, %1 : !firrtl.ref<uint<1>>, !firrtl.ref<uint<1>>
    ...
    firrtl.ref.define %ref_out2, %2 : !firrtl.ref<uint<4>>, !firrtl.ref<uint<4>>
  }
  firrtl.module @DUT() {
...
firrtl.circuit "UseRefsWithSinkFlow" {
  ...
  firrtl.module @UseRefsWithSinkFlow(in %x: !firrtl.uint<1>, out %y: !firrtl.uint<1>, out %z: !firrtl.uint<1>, out %zz: !firrtl.uint<1>, out %p: !firrtl.ref<uint<1>>) {
    ...
    firrtl.ref.define %p, %0 : !firrtl.ref<uint<1>>, !firrtl.ref<uint<1>>
    ...
    firrtl.ref.define %ic_p, %2 : !firrtl.ref<uint<1>>, !firrtl.ref<uint<1>>
