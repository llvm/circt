...
firrtl.circuit "AsyncResetConst" {
  firrtl.module @AsyncResetConst(
    ...
    firrtl.strictconnect %bundle0.a, %c0_ui : firrtl.uint<8>
    ...
    firrtl.strictconnect %bundle1, %bundle0 : firrtl.bundle<a: uint<8>>
    ...
    firrtl.strictconnect %vector0.a, %c0_ui : firrtl.uint<8>
    ...
    firrtl.strictconnect %vector1, %vector0 : firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>
    %5 = firrtl.regreset %clock, %reset, %vector1 : !firrtl.clock, !firrtl.asyncreset, !firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>, 1>

    firrtl.strictconnect %z0, %0 : firrtl.uint<8>
    firrtl.strictconnect %z1, %1 : firrtl.uint<8>
    firrtl.strictconnect %z2, %2 : firrtl.bundle<a: uint<8>>
    firrtl.strictconnect %z3, %3 : firrtl.bundle<a: uint<8>>
    firrtl.strictconnect %z4, %4 : firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>
    firrtl.strictconnect %z5, %5 : firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>
  }
}
