...
firrtl.circuit "AsyncResetConst" {
  firrtl.module @AsyncResetConst(
    ...
    %0 = firrtl.regreset %clock, %reset, %c0_ui {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<8>, !firrtl.uint<8>

    // Constant check should see through nodes.
    %node = firrtl.node %c0_ui : !firrtl.uint<8>
    %1 = firrtl.regreset %clock, %reset, %node {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<8>, !firrtl.uint<8>
    ...
    %2 = firrtl.regreset %clock, %reset, %bundle0 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.bundle<a: uint<8>>, !firrtl.bundle<a: uint<8>>
    ...
    %3 = firrtl.regreset %clock, %reset, %bundle1 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.bundle<a: uint<8>>, !firrtl.bundle<a: uint<8>>
    ...
    %4 = firrtl.regreset %clock, %reset, %vector0 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>, 1>

    // Constant check should see through multiple connect hops.
    %vector1 = firrtl.wire : !firrtl.vector<uint<8>, 1>
    firrtl.connect %vector1, %vector0 : !firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>, 1>
    %5 = firrtl.regreset %clock, %reset, %vector1 {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.vector<uint<8>, 1>, !firrtl.vector<uint<8>, 1>
