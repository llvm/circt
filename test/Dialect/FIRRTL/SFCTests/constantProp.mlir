...
firrtl.circuit "acrossWire"   {
  ...
  firrtl.module @acrossWire(in %x: !firrtl.uint<1>, out %y: !firrtl.uint<1>) {
    %_z = firrtl.wire useless_name : !firrtl.uint<1>
...
firrtl.circuit "padConstWire"   {
  ...
  firrtl.module @padConstWire(out %z: !firrtl.uint<16>) {
    %_w_a = firrtl.wire useless_name  : !firrtl.uint<8>
    %_w_b = firrtl.wire useless_name : !firrtl.uint<8>
...
firrtl.circuit "padConstReg"   {
  ...
  firrtl.module @padConstReg(in %clock: !firrtl.clock, out %z: !firrtl.uint<16>) {
    %r_a = firrtl.reg useless_name %clock  :  !firrtl.uint<8>
    %r_b = firrtl.reg useless_name %clock  :  !firrtl.uint<8>
    %c3_ui2 = firrtl.constant 3 : !firrtl.uint<2>
...
firrtl.circuit "padZeroReg"   {
  ...
  firrtl.module @padZeroReg(in %clock: !firrtl.clock, out %z: !firrtl.uint<16>) {
      %_r = firrtl.reg useless_name %clock  :  !firrtl.uint<8>
      %c0_ui1 = firrtl.constant 0 : !firrtl.uint<1>
      ...
      %_n = firrtl.node useless_name %c171_ui8  : !firrtl.uint<8>
...
firrtl.circuit "TailTester"   {
  ...
  firrtl.module @TailTester(out %out: !firrtl.uint<1>) {
    ...
    %_temp = firrtl.node useless_name %0  : !firrtl.uint<6>
    %1 = firrtl.head %_temp, 3 : (!firrtl.uint<6>) -> !firrtl.uint<3>
    %_head_temp = firrtl.node useless_name %1  : !firrtl.uint<3>
...
firrtl.circuit "TailTester2"   {
  ...
  firrtl.module @TailTester2(out %out: !firrtl.uint<1>) {
    ...
    %_tail_temp = firrtl.node useless_name %1  : !firrtl.uint<5>
...
firrtl.circuit "ZeroWidthAdd"   {
  ...
  firrtl.module @ZeroWidthAdd(in %x: !firrtl.uint<0>, out %y: !firrtl.uint<7>) {
    ...
    %_temp = firrtl.node useless_name %0  : !firrtl.uint<10>
