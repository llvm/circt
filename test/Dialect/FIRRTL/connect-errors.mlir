...
firrtl.module @test(in %a : !firrtl.bundle<f1: uint<1>>, out %b : !firrtl.bundle<f1: uint<1>>) {
  %0 = firrtl.subfield %a[0] : !firrtl.bundle<f1: uint<1>>
  %1 = firrtl.subfield %b[0] : !firrtl.bundle<f1: uint<1>>
...
firrtl.module @test(out %a: !firrtl.bundle<a: bundle<a flip: uint<1>>>) {
  ...
  %a_a = firrtl.subfield %a[0] : !firrtl.bundle<a: bundle<a flip: uint<1>>>
  %a_a_a = firrtl.subfield %a_a[0] : !firrtl.bundle<a flip: uint<1>>
  %ax_a = firrtl.subfield %ax[0] : !firrtl.bundle<a: bundle<a flip: uint<1>>>
  %ax_a_a = firrtl.subfield %ax_a[0] : !firrtl.bundle<a flip: uint<1>>
...
firrtl.module @test(out %a: !firrtl.bundle<a flip: bundle<a: uint<1>>>) {
  ...
  %a_a = firrtl.subfield %a[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
  %ax_a = firrtl.subfield %ax[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
...
firrtl.module @test(out %a: !firrtl.bundle<a flip: bundle<a: uint<1>>>) {
  %ax = firrtl.wire  : !firrtl.bundle<a flip: bundle<a: uint<1>>>
  %a_a = firrtl.subfield %a[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
  %a_a_a = firrtl.subfield %a_a[0] : !firrtl.bundle<a: uint<1>>
  %ax_a = firrtl.subfield %ax[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
  %ax_a_a = firrtl.subfield %ax_a[0] : !firrtl.bundle<a: uint<1>>
...
firrtl.module @test(out %a: !firrtl.bundle<a flip: bundle<a flip: uint<1>>>) {
  ...
  %a_a = firrtl.subfield %a[0] : !firrtl.bundle<a flip: bundle<a flip: uint<1>>>
  %ax_a = firrtl.subfield %ax[0] : !firrtl.bundle<a flip: bundle<a flip: uint<1>>>
...
firrtl.module @test(out %a: !firrtl.uint<1>) {
  ...
  %memory_r_en = firrtl.subfield %memory_r[1] : !firrtl.bundle<addr: uint<1>, en: uint<1>, clk: clock, data flip: uint<1>>
