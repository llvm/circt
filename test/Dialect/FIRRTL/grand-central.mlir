...
firrtl.circuit "Top" attributes {
  ...
  firrtl.module private @DUT() {
    ...
    firrtl.ref.define %companion_w1__gen_uint, %0 : !firrtl.ref<uint<1>>, !firrtl.ref<uint<1>>
    %1 = firrtl.ref.send %a_w2 : !firrtl.uint<2>
    firrtl.ref.define %companion_w2__gen_uint, %1 : !firrtl.ref<uint<2>>, !firrtl.ref<uint<2>>
  }
  firrtl.module @Top() {
    firrtl.instance dut  @DUT()
  }
