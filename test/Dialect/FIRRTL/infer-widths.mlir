...
firrtl.circuit "Foo" {
  ...
  firrtl.module @MuxBundleOperands(in %a: !firrtl.bundle<a: uint<8>>, in %p: !firrtl.uint<1>, out %c: !firrtl.bundle<a: uint>) {
    ...
    %0 = firrtl.subfield %w[0] : !firrtl.bundle<a: uint>
    %1 = firrtl.subfield %a[0] : !firrtl.bundle<a: uint<8>>
  ...
  firrtl.module @InferBundle(in %in : !firrtl.uint<3>, in %clk : !firrtl.clock) {
    ...
    %w_a = firrtl.subfield %w[0] : !firrtl.bundle<a: uint>
    %r_a = firrtl.subfield %r[0] : !firrtl.bundle<a: uint>
  ...
  firrtl.module @InferEmptyBundle(in %in : !firrtl.uint<3>) {
    ...
    %w_a = firrtl.subfield %w[0] : !firrtl.bundle<a: bundle<>, b: uint>
    %w_b = firrtl.subfield %w[1] : !firrtl.bundle<a: bundle<>, b: uint>
  ...
  firrtl.module @InferVectorFancy(in %in : !firrtl.uint<4>) {
    ...
    %wb_a = firrtl.subfield %wb[0] : !firrtl.bundle<a: uint>
  ...
  firrtl.module @InferElementAfterVector() {
    ...
    %w_a = firrtl.subfield %w[1] : !firrtl.bundle<a: vector<uint<10>, 10>, b: uint>
    %c2_ui3 = firrtl.constant 2 : !firrtl.uint<3>
  ...
  firrtl.module @InferComplexBundles() {
    ...
    %w_a = firrtl.subfield %w[0] : !firrtl.bundle<a: bundle<v: vector<uint, 10>>, b: bundle <v: vector<uint, 10>>>
    %w_a_v = firrtl.subfield %w_a[0] : !firrtl.bundle<v : vector<uint, 10>>
    %w_b = firrtl.subfield %w[1] : !firrtl.bundle<a: bundle<v: vector<uint, 10>>, b: bundle <v: vector<uint, 10>>>
    %w_b_v = firrtl.subfield %w_b[0] : !firrtl.bundle<v : vector<uint, 10>>
  ...
  firrtl.module @InferComplexVectors() {
    ...
    %w_2_a = firrtl.subfield %w_2[0] : !firrtl.bundle<a: uint, b: uint>
    %w_4 = firrtl.subindex %w[4] : !firrtl.vector<bundle<a: uint, b:uint>, 10>
    %w_4_b = firrtl.subfield %w_4[1] : !firrtl.bundle<a: uint, b: uint>
  ...
  firrtl.module @MemScalar(out %out: !firrtl.uint, out %dbg: !firrtl.ref<vector<uint, 8>>) {
    ...
    %m_p0_data = firrtl.subfield %m_p0[3] : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, data flip: uint>
    %m_p1_data = firrtl.subfield %m_p1[3] : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, data: uint, mask: uint<1>>
    %m_p2_wdata = firrtl.subfield %m_p2[5] : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, rdata flip: uint, wmode: uint<1>, wdata: uint, wmask: uint<1>>
    %c0_ui5 = firrtl.constant 0 : !firrtl.uint<5>
  ...
  firrtl.module @MemBundle(out %out: !firrtl.bundle<a: uint>) {
    ...
    %m_p0_data = firrtl.subfield %m_p0[3] : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, data flip: bundle<a: uint>>
    %m_p1_data = firrtl.subfield %m_p1[3] : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, data: bundle<a: uint>, mask: bundle<a: uint<1>>>
    %m_p2_wdata = firrtl.subfield %m_p2[5] : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, rdata flip: bundle<a: uint>, wmode: uint<1>, wdata: bundle<a: uint>, wmask: bundle<a: uint<1>>>
    %m_p1_data_a = firrtl.subfield %m_p1_data[0] : !firrtl.bundle<a: uint>
    %m_p2_wdata_a = firrtl.subfield %m_p2_wdata[0] : !firrtl.bundle<a: uint>
    %c0_ui5 = firrtl.constant 0 : !firrtl.uint<5>
    %c0_ui7 = firrtl.constant 0 : !firrtl.uint<7>
