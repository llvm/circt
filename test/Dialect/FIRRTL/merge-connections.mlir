...
firrtl.circuit "Test"   {
  ...
  firrtl.module @Test(in %a: !firrtl.vector<bundle<clock: clock, valid: uint<1>>, 2>, out %b: !firrtl.vector<bundle<clock: clock, valid: uint<1>>, 2>) {
     ...
     %2 = firrtl.subfield %0[0] : !firrtl.bundle<clock: clock, valid: uint<1>>
     %3 = firrtl.subfield %1[0] : !firrtl.bundle<clock: clock, valid: uint<1>>
     firrtl.strictconnect %3, %2 : !firrtl.clock
     %4 = firrtl.subfield %0[1] : !firrtl.bundle<clock: clock, valid: uint<1>>
     %5 = firrtl.subfield %1[1] : !firrtl.bundle<clock: clock, valid: uint<1>>
     ...
     %8 = firrtl.subfield %6[0] : !firrtl.bundle<clock: clock, valid: uint<1>>
     %9 = firrtl.subfield %7[0] : !firrtl.bundle<clock: clock, valid: uint<1>>
     firrtl.strictconnect %9, %8 : !firrtl.clock
     %10 = firrtl.subfield %6[1] : !firrtl.bundle<clock: clock, valid: uint<1>>
     %11 = firrtl.subfield %7[1] : !firrtl.bundle<clock: clock, valid: uint<1>>
  ...
  firrtl.module @Constant(out %a: !firrtl.bundle<b: uint<1>, c: uint<1>>) {
    ...
    %0 = firrtl.subfield %a[0] : !firrtl.bundle<b: uint<1>, c: uint<1>>
    %1 = firrtl.subfield %a[1] : !firrtl.bundle<b: uint<1>, c: uint<1>>
