...
// CHECK: hw.globalRef @nla_1 [@FooNL::@baz, @BazNL::@bar, @BarNL]
// CHECK: hw.globalRef @nla_0 [@FooNL::@baz, @BazNL::@bar, @BarNL::@w]
// CHECK: hw.globalRef @nla [@FooNL::@baz, @BazNL::@bar, @BarNL::@w2]
...
// CHECK: hw.globalRef @nla [@MemPortsNL::@child, @Child::@bar]
...
firrtl.circuit "Test" attributes {rawAnnotations = [
  ...
  // CHECK: hw.globalRef @nla [@Test::@exttest, @ExtTest]
...
firrtl.circuit "Test" attributes {rawAnnotations = [
  ...
  // CHECK: hw.globalRef @nla [@Test::@exttest, @ExtTest::@in]
...
// CHECK:      hw.globalRef [[NLA:@.+]] [@GCTDataTap::@im, @InnerMod::@w]
