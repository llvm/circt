...
firrtl.circuit "Annotations" {
  // CHECK: hw.globalRef [[NLA3:@nla.*]] [@Annotations::@annotations1, @Annotations0]
  // CHECK: hw.globalRef [[NLA2:@nla.*]] [@Annotations::@annotations0, @Annotations0::@e]
  // CHECK: hw.globalRef [[NLA1:@nla.*]] [@Annotations::@annotations0, @Annotations0::@c]
  // CHECK: hw.globalRef [[NLA0:@nla.*]] [@Annotations::@annotations1, @Annotations0::@b]
  // CHECK: hw.globalRef @annos_nla0 [@Annotations::@annotations0, @Annotations0::@d]
  // CHECK: hw.globalRef @annos_nla1 [@Annotations::@annotations1, @Annotations0::@d]
  hw.globalRef @annos_nla0 [@Annotations::@annotations0, @Annotations0::@d]
  hw.globalRef @annos_nla1 [@Annotations::@annotations1, @Annotations1::@i]
...
firrtl.circuit "PortAnnotations" {
  // CHECK: hw.globalRef [[NLA3:@nla.*]] [@PortAnnotations::@portannos0, @PortAnnotations0::@a]
  // CHECK: hw.globalRef [[NLA2:@nla.*]] [@PortAnnotations::@portannos1, @PortAnnotations0::@a]
  // CHECK: hw.globalRef [[NLA1:@nla.*]] [@PortAnnotations::@portannos0, @PortAnnotations0::@bar]
  // CHECK: hw.globalRef [[NLA0:@nla.*]] [@PortAnnotations::@portannos1, @PortAnnotations0::@bar]
...
firrtl.circuit "Breadcrumb" {
  ...
  hw.globalRef @breadcrumb_nla0 [@Breadcrumb::@breadcrumb0, @Breadcrumb0::@crumb0, @Crumb::@in]
  // CHECK:  @breadcrumb_nla1 [@Breadcrumb::@breadcrumb1, @Breadcrumb0::@crumb0, @Crumb::@in]
  hw.globalRef @breadcrumb_nla1 [@Breadcrumb::@breadcrumb1, @Breadcrumb1::@crumb1, @Crumb::@in]
  // CHECK:  @breadcrumb_nla2 [@Breadcrumb::@breadcrumb0, @Breadcrumb0::@crumb0, @Crumb::@w]
  hw.globalRef @breadcrumb_nla2 [@Breadcrumb::@breadcrumb0, @Breadcrumb0::@crumb0, @Crumb::@w]
  // CHECK:  @breadcrumb_nla3 [@Breadcrumb::@breadcrumb1, @Breadcrumb0::@crumb0, @Crumb::@w]
  hw.globalRef @breadcrumb_nla3 [@Breadcrumb::@breadcrumb1, @Breadcrumb1::@crumb1, @Crumb::@w]
...
firrtl.circuit "Context" {
  // CHECK: hw.globalRef [[NLA3:@nla.*]] [@Context::@context1, @Context0::@c0, @ContextLeaf::@w]
  // CHECK: hw.globalRef [[NLA1:@nla.*]] [@Context::@context1, @Context0::@c0, @ContextLeaf::@in]
  // CHECK: hw.globalRef [[NLA2:@nla.*]] [@Context::@context0, @Context0::@c0, @ContextLeaf::@w]
  // CHECK: hw.globalRef [[NLA0:@nla.*]] [@Context::@context0, @Context0::@c0, @ContextLeaf::@in]
  // CHECK-NOT: @context_nla0
  // CHECK-NOT: @context_nla1
  // CHECK-NOT: @context_nla2
  // CHECK-NOT: @context_nla3
  hw.globalRef @context_nla0 [@Context0::@c0, @ContextLeaf::@in]
  hw.globalRef @context_nla1 [@Context0::@c0, @ContextLeaf::@w]
  hw.globalRef @context_nla2 [@Context1::@c1, @ContextLeaf::@in]
  hw.globalRef @context_nla3 [@Context1::@c1, @ContextLeaf::@w]
...
firrtl.circuit "ExtModuleTest" {
  // CHECK: hw.globalRef @ext_nla [@ExtModuleTest::@e1, @ExtMod0]
  hw.globalRef @ext_nla [@ExtModuleTest::@e1, @ExtMod1]
...
firrtl.circuit "Foo"  {
  // CHECK: hw.globalRef @nla_1 [@Foo::@b, @A::@a]
  hw.globalRef @nla_1 [@Foo::@b, @B::@b]
...
firrtl.circuit "Chain" {
  // CHECK: hw.globalRef [[NLA0:@nla.*]] [@Chain::@chainB1, @ChainB0::@chainA0, @ChainA0::@extchain0, @ExtChain0]
  // CHECK: hw.globalRef [[NLA1:@nla.*]] [@Chain::@chainB0, @ChainB0::@chainA0, @ChainA0::@extchain0, @ExtChain0]
