...
firrtl.circuit "NLATop" {
  ...
  hw.globalRef @nla [#hw.innerNameRef<@NLATop::@test>, #hw.innerNameRef<@Aardvark::@test>, #hw.innerNameRef<@Zebra::@Zebra>]
  hw.globalRef @glbl_1 [#hw.innerNameRef<@NLATop::@test>,#hw.innerNameRef<@Aardvark::@test_1>, #hw.innerNameRef<@Zebra::@Zebra>]
  // CHECK: hw.globalRef @nla [#hw.innerNameRef<@T_NLATop::@test>, #hw.innerNameRef<@T_Aardvark::@test>, #hw.innerNameRef<@T_A_Z_Zebra::@Zebra>]
  // CHECK: hw.globalRef @glbl_1 [#hw.innerNameRef<@T_NLATop::@test>, #hw.innerNameRef<@T_Aardvark::@test_1>, #hw.innerNameRef<@T_A_Z_Zebra::@Zebra>]
  ...
  firrtl.module @NLATop()
    ...
    // CHECK:  firrtl.instance test  {annotations = [{circt.nonlocal = @nla, class = "circt.nonlocal"}, {circt.nonlocal = @glbl_1, class = "circt.nonlocal"}]} @T_Aardvark()
    firrtl.instance test  {annotations = [{circt.nonlocal = @nla, class = "circt.nonlocal"}, {circt.nonlocal = @glbl_1, class = "circt.nonlocal"} ]}@Aardvark()
  ...
  firrtl.module @Aardvark()
    ...
    firrtl.instance test1 {annotations = [{circt.nonlocal = @glbl_1, class = "circt.nonlocal"}]}@Zebra()
  }
