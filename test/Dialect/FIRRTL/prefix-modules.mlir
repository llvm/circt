...
firrtl.circuit "NLATop" {
  ...
  hw.globalRef @nla [@NLATop::@test, @Aardvark::@test, @Zebra]
  hw.globalRef @nla_1 [@NLATop::@test,@Aardvark::@test_1, @Zebra]
  // CHECK: hw.globalRef @nla [@T_NLATop::@test, @T_Aardvark::@test, @T_A_Z_Zebra]
  // CHECK: hw.globalRef @nla_1 [@T_NLATop::@test, @T_Aardvark::@test_1, @T_A_Z_Zebra]
...
// CHECK-LABEL: firrtl.circuit "FixNLA" {
  firrtl.circuit "FixNLA"   {
    hw.globalRef @nla_1 [@FixNLA::@bar, @Bar::@baz, @Baz]
    // CHECK:   hw.globalRef @nla_1 [@FixNLA::@bar, @Bar::@baz, @Baz]
    hw.globalRef @nla_2 [@FixNLA::@foo, @Foo::@bar, @Bar::@baz, @Baz::@s1]
    // CHECK:   hw.globalRef @nla_2 [@FixNLA::@foo, @X_Foo::@bar, @X_Bar::@baz, @X_Baz::@s1]
    hw.globalRef @nla_3 [@FixNLA::@bar, @Bar::@baz, @Baz]
    // CHECK:   hw.globalRef @nla_3 [@FixNLA::@bar, @Bar::@baz, @Baz]
    hw.globalRef @nla_4 [@Foo::@bar, @Bar::@baz, @Baz]
    // CHECK:       hw.globalRef @nla_4 [@X_Foo::@bar, @X_Bar::@baz, @X_Baz]
...
firrtl.circuit "Test"   {
  // CHECK: hw.globalRef @nla_1 [@Test::@foo1, @A_Foo1::@bar, @A_Bar]
  hw.globalRef @nla_1 [@Test::@foo1, @Foo1::@bar, @Bar]
  // CHECK: hw.globalRef @nla_2 [@Test::@foo2, @B_Foo2::@bar, @B_Bar]
  hw.globalRef @nla_2 [@Test::@foo2, @Foo2::@bar, @Bar]
