...
firrtl.module @Div(in %a: !firrtl.uint<4>,
  ...
  firrtl.strictconnect %f, %2 : firrtl.uint
  ...
  firrtl.strictconnect %h, %3 : firrtl.sint
...
firrtl.module @And(in %in: !firrtl.uint<4>,
  ...
  firrtl.strictconnect %out, %zw : firrtl.uint<4>
...
firrtl.module @Not(in %in: !firrtl.uint<4>,
  ...
  firrtl.strictconnect %outs, %3 : firrtl.uint<4>
...
firrtl.module @Cat(in %in4: !firrtl.uint<4>,
  ...
  firrtl.strictconnect %outcst, %8 : firrtl.uint<8>
  ...
  firrtl.strictconnect %outcst, %10 : firrtl.uint<8>
}
...
firrtl.module @Shr(in %in1u: !firrtl.uint<1>,
  ...
  firrtl.strictconnect %out1u, %9 : firrtl.uint<1>
}
...
firrtl.module @issue446(in %inp_1: !firrtl.sint<0>, out %tmp10: !firrtl.uint<1>) {
  ...
  firrtl.strictconnect %tmp10, %0 : firrtl.uint<1>
}
...
firrtl.module @xorUnsized(in %inp_1: !firrtl.sint, out %tmp10: !firrtl.uint) {
  ...
  firrtl.strictconnect %tmp10, %0 : firrtl.uint
}
...
firrtl.module @MuxShorten(
  ...
  firrtl.strictconnect %foo, %11 : firrtl.uint<5>
  firrtl.strictconnect %foo2, %3 : firrtl.uint<5>
...
firrtl.module @ForceableRegResetToNode(in %clock: !firrtl.clock, in %dummy : !firrtl.uint<1>, out %foo: !firrtl.uint<1>, out %ref : !firrtl.rwprobe<uint<1>>) {
  ...
  firrtl.strictconnect %reg, %dummy: firrtl.uint<1>
  firrtl.strictconnect %foo, %reg: firrtl.uint<1>
}
...
firrtl.module @issue1118(out %z0: !firrtl.uint, out %z1: !firrtl.sint) {
  ...
  // CHECK: firrtl.strictconnect %z0, %0 : firrtl.uint
  // CHECK: firrtl.strictconnect %z1, %1 : firrtl.sint
  ...
  firrtl.strictconnect %z0, %0 : firrtl.uint
  firrtl.strictconnect %z1, %1 : firrtl.sint
}
...
firrtl.module @issue1142(in %cond: !firrtl.uint<1>, out %z: !firrtl.uint) {
  ...
  firrtl.strictconnect %z, %0 : firrtl.uint
  firrtl.strictconnect %z, %1 : firrtl.uint
  firrtl.strictconnect %z, %3 : firrtl.uint
  firrtl.strictconnect %z, %4 : firrtl.uint
}
...
firrtl.module @PadMuxOperands(
  ...
  // CHECK: firrtl.strictconnect %z, %ui17 : firrtl.uint
  // CHECK: firrtl.strictconnect %z, %6 : firrtl.uint
  // CHECK: firrtl.strictconnect %z, %7 : firrtl.uint
  // CHECK: firrtl.strictconnect %z, %ui17 : firrtl.uint
  ...
  firrtl.strictconnect %z, %0 : firrtl.uint
  firrtl.strictconnect %z, %1 : firrtl.uint
  firrtl.strictconnect %z, %2 : firrtl.uint
  firrtl.strictconnect %z, %3 : firrtl.uint
  firrtl.strictconnect %z, %4 : firrtl.uint
  firrtl.strictconnect %z, %5 : firrtl.uint
  firrtl.strictconnect %z, %6 : firrtl.uint
  firrtl.strictconnect %z, %7 : firrtl.uint
}
...
firrtl.module @BitCast(out %o:!firrtl.bundle<valid: uint<1>, ready: uint<1>, data: uint<1>> ) {
  ...
  firrtl.strictconnect %o, %c : firrtl.bundle<valid: uint<1>, ready: uint<1>, data: uint<1>>, !firrtl.bundle<valid: uint<1>, ready: uint<1>
...
firrtl.module @Issue3043(out %a: !firrtl.vector<uint<5>, 3>) {
  ...
  firrtl.strictconnect %a, %_b : firrtl.vector<uint<5>, 3>, !firrtl.vector<uint<5>
}
