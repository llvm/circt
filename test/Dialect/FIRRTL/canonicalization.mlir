...
firrtl.module @reg_cst_prop1(in %clock: !firrtl.clock, out %out_b: !firrtl.uint<8>) {
  ...
  %_tmp_a = firrtl.reg useless_name %clock {name = "_tmp_a"} : !firrtl.uint<8>
  %tmp_b = firrtl.reg useless_name %clock {name = "_tmp_b"} : !firrtl.uint<8>
...
firrtl.module @reg_cst_prop2(in %clock: !firrtl.clock, out %out_b: !firrtl.uint<8>) {
  %_tmp_b = firrtl.reg useless_name %clock {name = "_tmp_b"} : !firrtl.uint<8>
  firrtl.connect %out_b, %_tmp_b : !firrtl.uint<8>, !firrtl.uint<8>
...
firrtl.module @wire_cst_prop1(out %out_b: !firrtl.uint<9>) {
  %_tmp_a = firrtl.wire useless_name : !firrtl.uint<8>
  %c5_ui8 = firrtl.constant 5 : !firrtl.uint<8>
  firrtl.connect %_tmp_a, %c5_ui8 : !firrtl.uint<8>, !firrtl.uint<8>
...
firrtl.module @wire_port_prop1(in %in_a: !firrtl.uint<9>, out %out_b: !firrtl.uint<9>) {
  %_tmp = firrtl.wire useless_name : !firrtl.uint<9>
...
firrtl.module @add_cst_prop1(out %out_b: !firrtl.uint<9>) {
  ...
  %_tmp_a = firrtl.wire useless_name : !firrtl.uint<7>
  %c5_ui8 = firrtl.constant 5 : !firrtl.uint<8>
...
firrtl.module @add_cst_prop2(out %out_b: !firrtl.sint<9>) {
  ...
  %_tmp_a = firrtl.wire useless_name : !firrtl.sint<7>
...
firrtl.module @add_cst_prop3(out %out_b: !firrtl.sint<4>) {
  ...
  %_tmp_a = firrtl.wire useless_name : !firrtl.sint<2>
...
firrtl.module @mul_cst_prop4(out %out_b: !firrtl.uint<15>) {
  ...
  %mul = firrtl.mul %_tmp_a, %invalid_ui4 : (!firrtl.uint<7>, !firrtl.uint<8>) -> !firrtl.uint<15>
  firrtl.connect %out_b, %mul : !firrtl.uint<15>, !firrtl.uint<15>
  %mul2 = firrtl.mul %invalid_ui4, %_tmp_a : (!firrtl.uint<8>, !firrtl.uint<7>) -> !firrtl.uint<15>
...
firrtl.module @namedrop(in %clock: !firrtl.clock, in %reset: !firrtl.uint<1>, in %in: !firrtl.uint<1>, out %out: !firrtl.uint<1>) {
  // CHECK-NOT: _T_
  %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
  %_T_0 = firrtl.node useless_name %in : !firrtl.uint<1>
  %_T_1 = firrtl.wire useless_name : !firrtl.uint<1>
  %_T_2 = firrtl.reg useless_name %clock : !firrtl.uint<1>
  %_T_3 = firrtl.regreset useless_name %clock, %reset, %c1_ui1 : !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>
  %a = firrtl.mem useless_name Undefined  {depth = 8 : i64, name = "_T_5", portNames = ["a"], readLatency = 0 : i32, writeLatency = 1 : i32} : !firrtl.bundle<addr: uint<3>, en: uint<1>, clk: clock, data flip: uint<1>>
...
firrtl.module @Issue2197(in %clock: !firrtl.clock, out %x: !firrtl.uint<2>) {
  ...
  %invalid_ui1 = firrtl.invalidvalue : !firrtl.uint<1>
  %_reg = firrtl.reg useless_name %clock : !firrtl.uint<2>
