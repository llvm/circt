...
firrtl.module @subfield(out %out : !firrtl.uint<8>) {
  ...
  %1 = firrtl.subfield %0[0] : !firrtl.bundle<a: uint<8>>
  firrtl.strictconnect %out, %1 : !firrtl.uint<8>
}
...
firrtl.module @subfield_agg(out %out : !firrtl.vector<uint<8>, 1>) {
  ...
  %1 = firrtl.subfield %0[0] : !firrtl.bundle<a: vector<uint<8>, 1>>
...
firrtl.module @MergeBundle(out %o:!firrtl.bundle<valid: uint<1>, ready: uint<1>>, in %i:!firrtl.uint<1> ) {
  ...
  %a0 = firrtl.subfield %a[0] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
  %a1 = firrtl.subfield %a[1] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
...
firrtl.module @MergeAgg(out %o: !firrtl.vector<bundle<valid: uint<1>, ready: uint<1>>, 3> ) {
  ...
  %a00 = firrtl.subfield %a0[0] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
  %a01 = firrtl.subfield %a0[1] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
  %a10 = firrtl.subfield %a1[0] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
  %a11 = firrtl.subfield %a1[1] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
  %a20 = firrtl.subfield %a2[0] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
  %a21 = firrtl.subfield %a2[1] : !firrtl.bundle<valid: uint<1>, ready: uint<1>>
...
firrtl.module @CrashAllUnusedPorts() {
  ...
  %26 = firrtl.subfield %foo[1] : !firrtl.bundle<addr: uint<2>, en: uint<1>, clk: clock, data: uint<2>, mask: uint<1>>
