...
firrtl.module @Verification(in %clock: !firrtl.clock, in %p: !firrtl.uint<1>, out %o : !firrtl.uint<1>) {
  ...
  // CHECK-NOT: firrtl.int.assume.edged_predicate
  firrtl.int.assume.edged_predicate %p, %c0, "assume_edged0" : !firrtl.uint<1>, !firrtl.uint<1>
  ...
  // CHECK-NOT: firrtl.int.assume.edged_predicate
  firrtl.int.assume.edged_predicate %c1, %p, "assume_edged1" : !firrtl.uint<1>, !firrtl.uint<1>
  // CHECK-NOT: firrtl.cover
