...
firrtl.module private @is1436_FOO() {
  ...
  firrtl.module private @SendRefTypeBundles1(in %source: !firrtl.bundle<valid: uint<1>, ready: uint<1>, data: uint<64>>, out %sink: !firrtl.ref<bundle<valid: uint<1>, ready: uint<1>, data: uint<64>>>) {
    ...
    firrtl.ref.assign %sink, %0 : !firrtl.ref<bundle<valid: uint<1>, ready: uint<1>, data: uint<64>>>
    // CHECK:  firrtl.ref.assign %sink_valid, %0 : !firrtl.ref<uint<1>>
    // CHECK:  firrtl.ref.assign %sink_ready, %1 : !firrtl.ref<uint<1>>
    // CHECK:  firrtl.ref.assign %sink_data, %2 : !firrtl.ref<uint<64>>
  }
  firrtl.module private @SendRefTypeVectors1(in %a: !firrtl.vector<uint<1>, 2>, out %b: !firrtl.ref<vector<uint<1>, 2>>) {
    ...
    firrtl.ref.assign %b, %0 : !firrtl.ref<vector<uint<1>, 2>>
    // CHECK:  firrtl.ref.assign %b_0, %0 : !firrtl.ref<uint<1>>
    // CHECK:  firrtl.ref.assign %b_1, %1 : !firrtl.ref<uint<1>>
  }
