...
// matching fieldIDs.  Any other arg attributes should be copied.
    ...
    firrtl.module @PortBundle(in %a: !firrtl.bundle<a: uint<1>, b flip: uint<1>> {firrtl.hello}) attributes {portAnnotations = [[{circt.fieldID = 1, a}]]} {}
    ...
    firrtl.extmodule @PortVector(in %a: !firrtl.vector<uint<1>, 2> {firrtl.world}) attributes {portAnnotations = [[{circt.fieldID = 1, b}]]}
