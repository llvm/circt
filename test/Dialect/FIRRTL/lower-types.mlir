...
// Test the update of NLA when a new symbol is added after lowering of bundle fields.
  ...
  // CHECK: firrtl.nla @lowernla_2 [#hw.innerNameRef<@testNLAbundle::@testBundle_Bar>, #hw.innerNameRef<@testBundle_Bar::@dd_qux>]
  ...
  // CHECK:   %d_qux = firrtl.wire sym @dd_qux  {annotations = [{circt.nonlocal = @lowernla_2, five}]} : !firrtl.uint<1>
  }
