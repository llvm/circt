...
firrtl.circuit "TopLevel" {
  ...
  firrtl.module private @Simple(in %source: !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>,
    ...
    %0 = firrtl.subfield %source[0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
    %1 = firrtl.subfield %source[1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
    %2 = firrtl.subfield %source[2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
    %3 = firrtl.subfield %sink[0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
    %4 = firrtl.subfield %sink[1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
    %5 = firrtl.subfield %sink[2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
    firrtl.when %0 {
  ...
  firrtl.module private @Recursive(in %arg: !firrtl.bundle<foo: bundle<bar: bundle<baz: uint<1>>, qux: sint<64>>>,
    ...
    %0 = firrtl.subfield %arg[0] : !firrtl.bundle<foo: bundle<bar: bundle<baz: uint<1>>, qux: sint<64>>>
    %1 = firrtl.subfield %0[0] : !firrtl.bundle<bar: bundle<baz: uint<1>>, qux: sint<64>>
    %2 = firrtl.subfield %1[0] : !firrtl.bundle<baz: uint<1>>
    %3 = firrtl.subfield %0[1] : !firrtl.bundle<bar: bundle<baz: uint<1>>, qux: sint<64>>
...
//     memory.w.data <= wData
  ...
  firrtl.module private @Mem2(in %clock: !firrtl.clock, in %rAddr: !firrtl.uint<4>, in %rEn: !firrtl.uint<1>, out %rData: !firrtl.bundle<a: uint<8>, b: uint<8>>, in %wAddr: !firrtl.uint<4>, in %wEn: !firrtl.uint<1>, in %wMask: !firrtl.bundle<a: uint<1>, b: uint<1>>, in %wData: !firrtl.bundle<a: uint<8>, b: uint<8>>) {
    ...
    %0 = firrtl.subfield %memory_r[2] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: bundle<a: uint<8>, b: uint<8>>>
    firrtl.connect %0, %clock : !firrtl.clock, !firrtl.clock
    %1 = firrtl.subfield %memory_r[1] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: bundle<a: uint<8>, b: uint<8>>>
    firrtl.connect %1, %rEn : !firrtl.uint<1>, !firrtl.uint<1>
    %2 = firrtl.subfield %memory_r[0] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: bundle<a: uint<8>, b: uint<8>>>
    firrtl.connect %2, %rAddr : !firrtl.uint<4>, !firrtl.uint<4>
    %3 = firrtl.subfield %memory_r[3] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: bundle<a: uint<8>, b: uint<8>>>
    firrtl.connect %rData, %3 : !firrtl.bundle<a: uint<8>, b: uint<8>>, !firrtl.bundle<a: uint<8>, b: uint<8>>
    %4 = firrtl.subfield %memory_w[2] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: bundle<a: uint<8>, b: uint<8>>, mask: bundle<a: uint<1>, b: uint<1>>>
    firrtl.connect %4, %clock : !firrtl.clock, !firrtl.clock
    %5 = firrtl.subfield %memory_w[1] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: bundle<a: uint<8>, b: uint<8>>, mask: bundle<a: uint<1>, b: uint<1>>>
    firrtl.connect %5, %wEn : !firrtl.uint<1>, !firrtl.uint<1>
    %6 = firrtl.subfield %memory_w[0] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: bundle<a: uint<8>, b: uint<8>>, mask: bundle<a: uint<1>, b: uint<1>>>
    firrtl.connect %6, %wAddr : !firrtl.uint<4>, !firrtl.uint<4>
    %7 = firrtl.subfield %memory_w[4] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: bundle<a: uint<8>, b: uint<8>>, mask: bundle<a: uint<1>, b: uint<1>>>
    firrtl.connect %7, %wMask : !firrtl.bundle<a: uint<1>, b: uint<1>>, !firrtl.bundle<a: uint<1>, b: uint<1>>
    %8 = firrtl.subfield %memory_w[3] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: bundle<a: uint<8>, b: uint<8>>, mask: bundle<a: uint<1>, b: uint<1>>>
...
//AGGREGATE-NEXT:  %0 = firrtl.subfield %invalid[0] : !firrtl.bundle<inp_d: uint<14>>
//AGGREGATE-NEXT:  %1 = firrtl.subfield %U0_inp_a[0] : !firrtl.bundle<inp_d: uint<14>>
...
// This test is just checking that the following doesn't error.
    ...
    firrtl.module private @Issue661(in %clock: !firrtl.clock) {
      ...
      : !firrtl.bundle<addr: uint<5>, en: uint<1>, clk: clock, data: uint<5>, mask: uint<1>>,
        !firrtl.bundle<addr: uint<5>, en: uint<1>, clk: clock, data: uint<5>, mask: uint<1>>
      %127 = firrtl.subfield %head_MPORT_6[2] : !firrtl.bundle<addr: uint<5>, en: uint<1>, clk: clock, data: uint<5>, mask: uint<1>>
    }
...
// Check that a non-bundled mux ops are untouched.
    ...
    firrtl.module private @NodeBundle(in %a: !firrtl.bundle<a: uint<1>>, out %b: !firrtl.uint<1>) {
      ...
      %n_a = firrtl.subfield %n[0] : !firrtl.bundle<a: uint<1>>
    ...
    firrtl.module private @RegBundle(in %a: !firrtl.bundle<a: uint<1>>, in %clk: !firrtl.clock, out %b: !firrtl.bundle<a: uint<1>>) {
      ...
      %0 = firrtl.subfield %x[0] : !firrtl.bundle<a: uint<1>>
      %1 = firrtl.subfield %a[0] : !firrtl.bundle<a: uint<1>>
      firrtl.connect %0, %1 : !firrtl.uint<1>, !firrtl.uint<1>
      %2 = firrtl.subfield %b[0] : !firrtl.bundle<a: uint<1>>
      %3 = firrtl.subfield %x[0] : !firrtl.bundle<a: uint<1>>
...
// CHECK-LABEL firrtl.module private @WireSemantics
  firrtl.module private @WireSemantics() {
    ...
    %0 = firrtl.subfield %a[0] : !firrtl.bundle<a: bundle<a: uint<1>>>
    %1 = firrtl.subfield %ax[0] : !firrtl.bundle<a: bundle<a: uint<1>>>
    firrtl.connect %0, %1 : !firrtl.bundle<a: uint<1>>, !firrtl.bundle<a: uint<1>>
    // a.a <= ax.a
    // CHECK: firrtl.strictconnect %a_a_a, %ax_a_a : !firrtl.uint<1>
    %2 = firrtl.subfield %a[0] : !firrtl.bundle<a: bundle<a: uint<1>>>
    %3 = firrtl.subfield %2[0] : !firrtl.bundle<a: uint<1>>
    %4 = firrtl.subfield %ax[0] : !firrtl.bundle<a: bundle<a: uint<1>>>
    %5 = firrtl.subfield %4[0] : !firrtl.bundle<a: uint<1>>
    ...
    %6 = firrtl.subfield %b[0] : !firrtl.bundle<a: bundle<a flip: uint<1>>>
    %7 = firrtl.subfield %bx[0] : !firrtl.bundle<a: bundle<a flip: uint<1>>>
    firrtl.connect %6, %7 : !firrtl.bundle<a flip: uint<1>>, !firrtl.bundle<a flip: uint<1>>
    // b.a <= bx.a
    // CHECK: firrtl.strictconnect %bx_a_a, %b_a_a
    %8 = firrtl.subfield %b[0] : !firrtl.bundle<a: bundle<a flip: uint<1>>>
    %9 = firrtl.subfield %8[0] : !firrtl.bundle<a flip: uint<1>>
    %10 = firrtl.subfield %bx[0] : !firrtl.bundle<a: bundle<a flip: uint<1>>>
    %11 = firrtl.subfield %10[0] : !firrtl.bundle<a flip: uint<1>>
    ...
    %12 = firrtl.subfield %c[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
    %13 = firrtl.subfield %cx[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
    firrtl.connect %12, %13 : !firrtl.bundle<a: uint<1>>, !firrtl.bundle<a: uint<1>>
    // c.a <= cx.a
    // CHECK: firrtl.strictconnect %c_a_a, %cx_a_a
    %14 = firrtl.subfield %c[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
    %15 = firrtl.subfield %14[0] : !firrtl.bundle<a: uint<1>>
    %16 = firrtl.subfield %cx[0] : !firrtl.bundle<a flip: bundle<a: uint<1>>>
    %17 = firrtl.subfield %16[0] : !firrtl.bundle<a: uint<1>>
    ...
    %18 = firrtl.subfield %d[0] : !firrtl.bundle<a flip: bundle<a flip: uint<1>>>
    %19 = firrtl.subfield %dx[0] : !firrtl.bundle<a flip: bundle<a flip: uint<1>>>
    firrtl.connect %18, %19 : !firrtl.bundle<a flip: uint<1>>, !firrtl.bundle<a flip: uint<1>>
    // d.a <= dx.a
    // CHECK: firrtl.strictconnect %dx_a_a, %d_a_a
    %20 = firrtl.subfield %d[0] : !firrtl.bundle<a flip: bundle<a flip: uint<1>>>
    %21 = firrtl.subfield %20[0] : !firrtl.bundle<a flip: uint<1>>
    %22 = firrtl.subfield %dx[0] : !firrtl.bundle<a flip: bundle<a flip: uint<1>>>
    %23 = firrtl.subfield %22[0] : !firrtl.bundle<a flip: uint<1>>
...
// Test that a vector of bundles with a write works.
 // CHECK-LABEL: firrtl.module private @aofs
    firrtl.module private @aofs(in %a: !firrtl.uint<1>, in %sel: !firrtl.uint<2>, out %b: !firrtl.vector<bundle<wo: uint<1>>, 4>) {
      ...
      %5 = firrtl.subfield %4[0] : !firrtl.bundle<wo: uint<1>>
      ...
      %7 = firrtl.subfield %6[0] : !firrtl.bundle<wo: uint<1>>
      ...
      %9 = firrtl.subfield %8[0] : !firrtl.bundle<wo: uint<1>>
...
//     b[sel].wo <= a.wo
  firrtl.module private @writeVectorOfBundle1D(in %a: !firrtl.bundle<wo: uint<1>, valid: uint<2>>, in %def: !firrtl.vector<bundle<wo: uint<1>, valid: uint<2>>, 2>, in %sel: !firrtl.uint<2>, out %b: !firrtl.vector<bundle<wo: uint<1>, valid: uint<2>>, 2>) {
    ...
    %1 = firrtl.subfield %0[0] : !firrtl.bundle<wo: uint<1>, valid: uint<2>>
    %2 = firrtl.subfield %a[0] : !firrtl.bundle<wo: uint<1>, valid: uint<2>>
...
// Handle zero-length vector subaccess
  ...
  firrtl.module private @zvec(in %i: !firrtl.vector<bundle<a: uint<8>, b: uint<4>>, 0>, in %sel: !firrtl.uint<1>, out %foo: !firrtl.vector<uint<1>, 0>, out %o: !firrtl.uint<8>) {
    ...
    %2 = firrtl.subfield %1[0] : !firrtl.bundle<a: uint<8>, b: uint<4>>
...
firrtl.module private @is1436_FOO() {
  ...
  %0 = firrtl.subfield %thing_io[0] : !firrtl.bundle<llWakeup flip: vector<uint<1>, 1>>
  ...
  %o1 = firrtl.subfield %e[1] : !firrtl.bundle<addr: uint<2>, data : vector<uint<1>, 2>>
