...
// WRAPPER-NEXT:     %0 = firrtl.subfield %ReadMemory_read0("data") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<8>>) -> !firrtl.sint<8>
// WRAPPER-NEXT:     %1 = firrtl.subfield %ReadMemory_read0("addr") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<8>>) -> !firrtl.uint<4>
// WRAPPER-NEXT:     firrtl.connect %1, %c0_ui1 : !firrtl.uint<4>, !firrtl.uint<1>
// WRAPPER-NEXT:     %2 = firrtl.subfield %ReadMemory_read0("en") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<8>>) -> !firrtl.uint<1>
// WRAPPER-NEXT:     firrtl.connect %2, %c1_ui1 : !firrtl.uint<1>, !firrtl.uint<1>
// WRAPPER-NEXT:     %3 = firrtl.subfield %ReadMemory_read0("clk") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<8>>) -> !firrtl.clock
// WRAPPER-NEXT:   }
// WRAPPER-NEXT: }
...
firrtl.circuit "MemSimple" {
  firrtl.module @MemSimple(in %clock1: !firrtl.clock, in %clock2: !firrtl.clock, in %inpred: !firrtl.uint<1>, in %indata: !firrtl.sint<42>, out %result: !firrtl.sint<42>) {
    ...
    %1 = firrtl.subfield %_M_read("addr") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.uint<4>
    firrtl.connect %1, %c0_ui1 : !firrtl.uint<4>, !firrtl.uint<1>
    %2 = firrtl.subfield %_M_read("en") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.uint<1>
    firrtl.connect %2, %c1_ui1 : !firrtl.uint<1>, !firrtl.uint<1>
    %3 = firrtl.subfield %_M_read("clk") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.clock
    firrtl.connect %3, %clock1 : !firrtl.clock, !firrtl.clock
    %4 = firrtl.subfield %_M_write("addr") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.uint<4>
    ...
    %7 = firrtl.subfield %_M_write("en") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.uint<1>
    ...
    %9 = firrtl.subfield %_M_write("clk") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.clock
    ...
    %12 = firrtl.subfield %_M_write("data") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.sint<42>
    ...
    %15 = firrtl.subfield %_M_write("mask") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.uint<1>
...
// WRAPPER-NEXT:     %0 = firrtl.subfield %_M_read("data") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.sint<42>
// WRAPPER-NEXT:     firrtl.connect %result, %0 : !firrtl.sint<42>, !firrtl.sint<42>
// WRAPPER-NEXT:     %1 = firrtl.subfield %_M_read("addr") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.uint<4>
// WRAPPER-NEXT:     firrtl.connect %1, %c0_ui1 : !firrtl.uint<4>, !firrtl.uint<1>
// WRAPPER-NEXT:     %2 = firrtl.subfield %_M_read("en") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.uint<1>
// WRAPPER-NEXT:     firrtl.connect %2, %c1_ui1 : !firrtl.uint<1>, !firrtl.uint<1>
// WRAPPER-NEXT:     %3 = firrtl.subfield %_M_read("clk") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: sint<42>>) -> !firrtl.clock
// WRAPPER-NEXT:     firrtl.connect %3, %clock1 : !firrtl.clock, !firrtl.clock
// WRAPPER-NEXT:     %4 = firrtl.subfield %_M_write("addr") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.uint<4>
...
// WRAPPER-NEXT:     %6 = firrtl.subfield %_M_write("en") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.uint<1>
...
// WRAPPER-NEXT:     %8 = firrtl.subfield %_M_write("clk") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.clock
...
// WRAPPER-NEXT:     %10 = firrtl.subfield %_M_write("data") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.sint<42>
...
// WRAPPER-NEXT:     %12 = firrtl.subfield %_M_write("mask") : (!firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: sint<42>, mask: uint<1>>) -> !firrtl.uint<1>
