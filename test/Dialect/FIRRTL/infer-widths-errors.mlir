...
// This test is disabled as input probes are now illegal.
// Similar scenario is now possible with instance_choice.

// firrtl.circuit "Issue5002" {
//   // expected-error-DISABLED @below {{uninferred width: port "ref" cannot satisfy all width requirements}}
...
//     // expected-note-DISABLED @below {{width is constrained to be at most 1 here:}}
//     // expected-note-DISABLED @below {{width is constrained to be at least 2 here:}}
