...
firrtl.circuit "ExtractBlackBoxesSimple2" attributes {annotations = [{class = "firrtl.transforms.BlackBoxTargetDirAnno", targetDir = "BlackBoxes"}]} {
  // CHECK: hw.globalRef @nla_1{{.*}} [@ExtractBlackBoxesSimple2::@bb, @MyBlackBox]
  // CHECK-NOT: hw.globalRef @nla_2
  // CHECK-NOT: hw.globalRef @nla_3
  hw.globalRef @nla_1 [@BBWrapper::@bb, @MyBlackBox]
  hw.globalRef @nla_2 [@DUTModule::@mod, @BBWrapper::@bb]
  hw.globalRef @nla_3 [@ExtractBlackBoxesSimple2::@dut, @DUTModule::@mod, @BBWrapper::@bb]
...
firrtl.circuit "ExtractBlackBoxesIntoDUTSubmodule"  {
  // CHECK-LABEL: hw.globalRef @nla_1 [
  ...
  // CHECK-LABEL: hw.globalRef @nla_2 [
  // CHECK-SAME:    @ExtractBlackBoxesIntoDUTSubmodule::@tb
  // CHECK-SAME:    @TestHarness::@dut
  // CHECK-SAME:    @DUTModule::@BlackBoxes
