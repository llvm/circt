...
firrtl.module @DbgsMemPort(in %clock: !firrtl.clock, in %addr : !firrtl.uint<1>, out %_a: !firrtl.ref<vector<uint<1>, 2>>, in %cond : !firrtl.uint<1>) {
  ...
  firrtl.ref.define %_a, %port0_data : !firrtl.ref<vector<uint<1>, 2>>, !firrtl.ref<vector<uint<1>, 2>>
  ...
  // CHECK:    firrtl.ref.define %_a, %[[ram_port0]] : !firrtl.ref<vector<uint<1>, 2>>, !firrtl.ref<vector<uint<1>, 2>>
}
