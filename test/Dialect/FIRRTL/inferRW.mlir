...
// CHECK-LABEL: firrtl.module @TLRAM
    firrtl.module @TLRAM(in %clock: !firrtl.clock, in %reset: !firrtl.asyncreset, in %index: !firrtl.uint<4>, in %index2: !firrtl.uint<4>, in %data_0: !firrtl.uint<8>, in %wen: !firrtl.uint<1>, in %_T_29: !firrtl.uint<1>, out %auto_0: !firrtl.uint<8>, out %dbg_0: !firrtl.ref<vector<uint<8>, 16>>) {
      ...
      %0 = firrtl.subfield %mem_0_MPORT[0] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: uint<8>>
      firrtl.connect %0, %index2 : !firrtl.uint<4>, !firrtl.uint<4>
      %1 = firrtl.subfield %mem_0_MPORT[1] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: uint<8>>
      firrtl.connect %1, %mem_MPORT_en : !firrtl.uint<1>, !firrtl.uint<1>
      %2 = firrtl.subfield %mem_0_MPORT[2] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: uint<8>>
      firrtl.connect %2, %clock : !firrtl.clock, !firrtl.clock
      %3 = firrtl.subfield %mem_0_MPORT[3] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: uint<8>>
      firrtl.connect %mem_MPORT_data_0, %3 : !firrtl.uint<8>, !firrtl.uint<8>
      %4 = firrtl.subfield %mem_0_MPORT_1[0] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<1>>
      firrtl.connect %4, %index : !firrtl.uint<4>, !firrtl.uint<4>
      %5 = firrtl.subfield %mem_0_MPORT_1[1] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<1>>
      firrtl.connect %5, %wen : !firrtl.uint<1>, !firrtl.uint<1>
      %6 = firrtl.subfield %mem_0_MPORT_1[2] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<1>>
      firrtl.connect %6, %clock : !firrtl.clock, !firrtl.clock
      %7 = firrtl.subfield %mem_0_MPORT_1[3] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<1>>
      firrtl.connect %7, %data_0 : !firrtl.uint<8>, !firrtl.uint<8>
      %8 = firrtl.subfield %mem_0_MPORT_1[4] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<1>>
...
// CHECK:    %mem_rw = firrtl.mem Undefined  {depth = 2048 : i64, name = "mem", portNames = ["rw"], readLatency = 1 : i32, writeLatency = 1 : i32} : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, rdata flip: uint<32>, wmode: uint<1>, wdata: uint<32>, wmask: uint<1>>
    %0 = firrtl.subfield %mem__T_14[0] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %1 = firrtl.subfield %mem__T_14[1] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %2 = firrtl.subfield %mem__T_14[2] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %3 = firrtl.subfield %mem__T_14[3] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %4 = firrtl.subfield %mem__T_14[4] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %5 = firrtl.subfield %mem__T_22[0] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data flip: uint<32>>
    %6 = firrtl.subfield %mem__T_22[1] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data flip: uint<32>>
    %7 = firrtl.subfield %mem__T_22[2] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data flip: uint<32>>
    %8 = firrtl.subfield %mem__T_22[3] : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, data flip: uint<32>>
...
// CHECK-LABEL: firrtl.module @memTest5t
  firrtl.module @memTest5t(in %clk1: !firrtl.clock, in %clk2: !firrtl.clock, in %reset: !firrtl.uint<1>, in %io_en: !firrtl.uint<1>, in %io_wen: !firrtl.uint<1>, in %io_waddr: !firrtl.uint<8>, in %io_wdata: !firrtl.uint<32>, in %io_raddr: !firrtl.uint<8>, out %io_rdata: !firrtl.uint<32>) {
    ...
    %0 = firrtl.subfield %mem_T_3[0] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<32>>
    %1 = firrtl.subfield %mem_T_3[1] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<32>>
    %2 = firrtl.subfield %mem_T_3[2] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<32>>
    %3 = firrtl.subfield %mem_T_3[3] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<32>>
    %4 = firrtl.subfield %mem_T_5[0] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %5 = firrtl.subfield %mem_T_5[1] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %6 = firrtl.subfield %mem_T_5[2] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %7 = firrtl.subfield %mem_T_5[3] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %8 = firrtl.subfield %mem_T_5[4] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<32>, mask: uint<1>>
    %9 = firrtl.not %io_wen : (!firrtl.uint<1>) -> !firrtl.uint<1>
...
// CHECK:    %mem_rw = firrtl.mem Undefined  {depth = 2048 : i64, name = "mem", portNames = ["rw"], readLatency = 1 : i32, writeLatency = 1 : i32} : !firrtl.bundle<addr: uint<11>, en: uint<1>, clk: clock, rdata flip: uint<32>, wmode: uint<1>, wdata: uint<32>, wmask: uint<1>>
    ...
    firrtl.module @constMask(in %clock: !firrtl.clock, in %reset: !firrtl.asyncreset, in %index: !firrtl.uint<4>, in %index2: !firrtl.uint<4>, in %data_0: !firrtl.uint<8>, in %wen: !firrtl.uint<1>, in %_T_29: !firrtl.uint<1>, out %auto_0: !firrtl.uint<8>) {
      ...
      // CHECK: %[[v6:.+]] = firrtl.subfield %mem_0_rw[6] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, rdata flip: uint<8>, wmode: uint<1>, wdata: uint<8>, wmask: uint<1>>
      ...
      %3 = firrtl.subfield %mem_0_MPORT[3] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data flip: uint<8>>
      firrtl.connect %mem_MPORT_data_0, %3 : !firrtl.uint<8>, !firrtl.uint<8>
      %4 = firrtl.subfield %mem_0_MPORT_1[0] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<2>>
      firrtl.connect %4, %index : !firrtl.uint<4>, !firrtl.uint<4>
      %5 = firrtl.subfield %mem_0_MPORT_1[1] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<2>>
      firrtl.connect %5, %wen : !firrtl.uint<1>, !firrtl.uint<1>
      %6 = firrtl.subfield %mem_0_MPORT_1[2] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<2>>
      firrtl.connect %6, %clock : !firrtl.clock, !firrtl.clock
      %7 = firrtl.subfield %mem_0_MPORT_1[3] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<2>>
      firrtl.connect %7, %data_0 : !firrtl.uint<8>, !firrtl.uint<8>
      %8 = firrtl.subfield %mem_0_MPORT_1[4] : !firrtl.bundle<addr: uint<4>, en: uint<1>, clk: clock, data: uint<8>, mask: uint<2>>
