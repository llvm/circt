...
hw.globalRef @NLA1 []
hw.globalRef @NLA2 [@LowerToBind::@s1]
...
firrtl.circuit "NLATop" {
 ...
 // expected-error @+1 {{the instance path can only contain inner sym reference, only the leaf can refer to a module symbol}}
  hw.globalRef @nla [@NLATop::@test, @Aardvark, @Zebra]
...
firrtl.circuit "NLATop1" {
  ...
  hw.globalRef @nla [@NLATop1::@test, @Zebra::@test,@Aardvark::@test]
  hw.globalRef @nla_1 [@NLATop1::@test,@Aardvark::@test_1, @Zebra]
...
firrtl.circuit "fallBackName" {
  ...
  hw.globalRef @nla [@fallBackName::@test, @Aardvark::@test, @Zebra::@bundle]
  hw.globalRef @nla_1 [@fallBackName::@test,@Aardvark::@test_1, @Zebra]
...
firrtl.circuit "Foo"   {
  ...
  hw.globalRef @nla_1 [@Foo::@bar, @Bar::@b]
