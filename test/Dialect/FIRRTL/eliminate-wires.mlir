// RUN: circt-opt -pass-pipeline='builtin.module(firrtl.circuit(firrtl.module(firrtl-eliminate-wires)))' --allow-unregistered-dialect %s | FileCheck --check-prefixes=CHECK %s
