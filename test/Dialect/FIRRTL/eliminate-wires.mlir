...
firrtl.circuit "TopLevel" {
  ...
  firrtl.module private @Foo() {
    ...
    %b_write = firrtl.wrapSink %b : !firrtl.uint<3>
    firrtl.strictconnect %b_write, %invalid_ui3 : !firrtl.uint<3>
    %a_write = firrtl.wrapSink %a : !firrtl.uint<3>
