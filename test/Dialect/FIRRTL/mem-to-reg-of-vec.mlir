...
firrtl.circuit  "GCTModule" attributes {annotations = [
  ...
  firrtl.module public @GCTModule() attributes {annotations = [
    ...
    %rf_read, %rf_write = firrtl.mem Undefined {
      ...
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 1, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 1 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 1, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 2, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 2 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 2, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 3, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 3 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 3, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 4, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 4 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 4, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 5, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 5 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 5, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 6, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 6 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 6, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 7, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 7 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 7, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 8, {class = "sifive.enterprise.grandcentral.ReferenceDataTapKey", id = 0 : i64, portID = 8 : i64, type = "source"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 8, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 1, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 2, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 3, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 4, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      ...
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 6, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 7, {class = "firrtl.transforms.DontTouchAnnotation"}>,
      // CHECK-SAME:      #firrtl.subAnno<fieldID = 8, {class = "firrtl.transforms.DontTouchAnnotation"}>]} : !firrtl.vector<uint<8>, 8>
  }
}
