...
firrtl.circuit "Mem" {
  ...
  firrtl.module private @GCTModule() attributes {annotations = [{class = "sifive.enterprise.firrtl.MarkDUTAnnotation"}]}{
  ...
  firrtl.module private @WriteMask() attributes {annotations = [{class = "sifive.enterprise.firrtl.MarkDUTAnnotation"}]}{
  ...
  firrtl.module private @MemTap() attributes {annotations = [{class = "sifive.enterprise.firrtl.MarkDUTAnnotation"}]}{
