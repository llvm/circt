...
firrtl.circuit "NonLocalTrackers" attributes {annotations = [{
  ...
  hw.globalRef @glbl_0 [#hw.innerNameRef<@NonLocalTrackers::@b>, #hw.innerNameRef<@B::@a>, #hw.innerNameRef<@A::@A>]
  firrtl.module @A() attributes {annotations = [{circt.nonlocal = @glbl_0, class = "freechips.rocketchip.objectmodel.OMIRTracker", id = 0}]} {}
  firrtl.module @B() {
    firrtl.instance a {annotations = [{circt.nonlocal = @glbl_0, class = "circt.nonlocal"}]} @A()
  }
  firrtl.module @NonLocalTrackers() {
    firrtl.instance b {annotations = [{circt.nonlocal = @glbl_0, class = "circt.nonlocal"}]} @B()
  }
}
