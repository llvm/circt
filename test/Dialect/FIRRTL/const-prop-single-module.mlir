...
firrtl.module @Top01(in %x: !firrtl.uint<5>, out %y: !firrtl.uint<1>) {
  ...
  %0 = firrtl.geq %x, %c0_ui : (!firrtl.uint<5>, !firrtl.const.uint) -> !firrtl.uint<1>
...
firrtl.module @Top02(in %x: !firrtl.uint<5>, out %y: !firrtl.uint<1>) {
  %c0_ui = firrtl.constant 0 : !firrtl.const.uint
  %0 = firrtl.lt %x, %c0_ui : (!firrtl.uint<5>, !firrtl.const.uint) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top03(in %x: !firrtl.uint<5>, out %y: !firrtl.uint<1>) {
  %c0_ui = firrtl.constant 0 : !firrtl.const.uint
  %0 = firrtl.leq %c0_ui, %x : (!firrtl.const.uint, !firrtl.uint<5>) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top04(in %x: !firrtl.uint<5>, out %y: !firrtl.uint<1>) {
  %c0_ui = firrtl.constant 0 : !firrtl.const.uint
  %0 = firrtl.gt %c0_ui, %x : (!firrtl.const.uint, !firrtl.uint<5>) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top05(out %y: !firrtl.uint<1>) {
  ...
  %0 = firrtl.lt %c1_ui, %c3_ui : (!firrtl.const.uint, !firrtl.const.uint) -> !firrtl.const.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.const.uint<1>
}
...
firrtl.module @Top06(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  ...
  %0 = firrtl.lt %x, %c8_ui : (!firrtl.uint<3>, !firrtl.const.uint) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top07(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  ...
  %0 = firrtl.leq %x, %c7_ui : (!firrtl.uint<3>, !firrtl.const.uint) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top08(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  %c8_ui = firrtl.constant 8 : !firrtl.const.uint
  %0 = firrtl.gt %c8_ui, %x : (!firrtl.const.uint, !firrtl.uint<3>) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top09(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  %c7_ui = firrtl.constant 7 : !firrtl.const.uint
  %0 = firrtl.geq %c7_ui, %x : (!firrtl.const.uint, !firrtl.uint<3>) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top10(out %y: !firrtl.uint<1>) {
  ...
  %0 = firrtl.eq %c10_ui, %c10_ui : (!firrtl.const.uint, !firrtl.const.uint) -> !firrtl.const.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.const.uint<1>
}
...
firrtl.module @Top12(out %y: !firrtl.uint<1>) {
  %c10_ui = firrtl.constant 10 : !firrtl.const.uint
  %0 = firrtl.neq %c10_ui, %c10_ui : (!firrtl.const.uint, !firrtl.const.uint) -> !firrtl.const.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.const.uint<1>
}
...
firrtl.module @Top13(out %y: !firrtl.uint<1>) {
  %c1_ui = firrtl.constant 1 : !firrtl.const.uint
  %c3_ui = firrtl.constant 3 : !firrtl.const.uint
  %0 = firrtl.geq %c1_ui, %c3_ui : (!firrtl.const.uint, !firrtl.const.uint) -> !firrtl.const.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.const.uint<1>
}
...
firrtl.module @Top14(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  %c8_ui = firrtl.constant 8 : !firrtl.const.uint
  %0 = firrtl.geq %x, %c8_ui : (!firrtl.uint<3>, !firrtl.const.uint) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top15(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  %c7_ui = firrtl.constant 7 : !firrtl.const.uint
  %0 = firrtl.gt %x, %c7_ui : (!firrtl.uint<3>, !firrtl.const.uint) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top16(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  %c8_ui = firrtl.constant 8 : !firrtl.const.uint
  %0 = firrtl.leq %c8_ui, %x : (!firrtl.const.uint, !firrtl.uint<3>) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
...
firrtl.module @Top17(in %x: !firrtl.uint<3>, out %y: !firrtl.uint<1>) {
  %c7_ui = firrtl.constant 7 : !firrtl.const.uint
  %0 = firrtl.lt %c7_ui, %x : (!firrtl.const.uint, !firrtl.uint<3>) -> !firrtl.uint<1>
  firrtl.connect %y, %0 : !firrtl.uint<1>, !firrtl.uint<1>
}
