...
firrtl.circuit "Foo" {
  ...
  firrtl.module @Foo(
    ...
    // CHECK: %regResetName = firrtl.regreset sym @regResetSym %clock, %reset, %value {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<42>, !firrtl.uint<42>
    %regResetName = firrtl.regreset sym @regResetSym %clock, %reset, %value {resetType = 1 : i32} : !firrtl.clock, !firrtl.asyncreset, !firrtl.uint<42>, !firrtl.uint<42>
