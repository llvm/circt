...
func @combinational_condition() {
  ...
  staticlogic.pipeline.while #staticlogic.II<1> iter_args(%arg0 = %c0_i32) : (i32) -> () {
...
func @single_condition() {
  ...
  staticlogic.pipeline.while #staticlogic.II<1> iter_args(%arg0 = %false) : (i1) -> () {
...
func @invalid_iter_args() {
  %false = arith.constant 0 : i1
  staticlogic.pipeline.while #staticlogic.II<1> iter_args(%arg0 = %false) : (i1) -> (i1) {
    staticlogic.pipeline.register %arg0 : i1
  } do {
    staticlogic.pipeline.stage {
      staticlogic.pipeline.register
