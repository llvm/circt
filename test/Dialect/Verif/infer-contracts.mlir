...
// CHECK-NEXT:     %c0_i42 = hw.constant 0 : i42
// CHECK-NEXT:     [[TMP2:%.+]] = comb.icmp uge %a, %c0_i42 : i1
// CHECK-NEXT:     [[REQ:%.+]] = comb.and bin [[TMP1]], [[TMP2]] : i1
// CHECK-NEXT:     verif.require [[REQ]] : i1
// CHECK-NEXT:     [[TMP3:%.+]] = comb.mul %a, %c2_i42 : i42
// CHECK-NEXT:     [[TMP4:%.+]] = comb.icmp eq [[CONT]], [[TMP3]] : i42
// CHECK-NEXT:     [[TMP5:%.+]] = comb.add %a, %a : i42
// CHECK-NEXT:     [[TMP6:%.+]] = comb.icmp eq [[CONT]], [[TMP5]] : i42
// CHECK-NEXT:     [[ENS:%.+]] = comb.and bin [[TMP4]], [[TMP6]] : i1
// CHECK-NEXT:     verif.ensure [[ENS]] : i1
// CHECK-NEXT:   }
// CHECK-NEXT:   hw.output [[CONT]] : i42
// CHECK-NEXT: }
