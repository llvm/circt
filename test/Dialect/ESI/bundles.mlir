...
// CHECK-LABEL: hw.module @Receiver(input %foo : !esi.bundle<[!esi.channel<i8> to "data", !esi.channel<none> from "ack"]>, output %data : !esi.channel<i8>) {
...
// CHECK-LABEL:  hw.module @Sender(output %foo : !esi.bundle<[!esi.channel<i8> to "data", !esi.channel<none> from "ack"]>, output %ack : !esi.channel<none>) {
...
hw.module @Sender(output %foo: !bundleType, output %ack: !esi.channel<none>) {
...
// CHECK-LABEL:  hw.module.extern @ResettableBundleModule(input %foo : !esi.bundle<[!esi.channel<i8> to "data", !esi.channel<none> from "ack"] reset >)
hw.module.extern @ResettableBundleModule(input %foo: !esi.bundle<[
  !esi.channel<i8> to "data",
