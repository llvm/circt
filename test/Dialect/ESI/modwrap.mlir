...
// CHECK:          %pearl.foo_ready, %pearl.rawOut = hw.instance "pearl" @InputChannel(%clk, %rawOutput, %valid) : (i1, i23, i1) -> (i1, i99)
...
// CHECK:          %chanOutput, %ready = esi.wrap.vr %pearl.bar, %pearl.bar_valid : i42
// CHECK:          %pearl.bar, %pearl.bar_valid, %pearl.foo_ready, %pearl.rawOut = hw.instance "pearl" @Mixed(%clk, %rawOutput, %valid, %ready) : (i1, i23, i1, i1) -> (i42, i1, i1, i99)
