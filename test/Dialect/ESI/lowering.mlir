...
hw.module.extern @Sender(%clk: !seq.clock) -> (x: !esi.channel<i4>, y: i8) attributes {esi.bundle}
hw.module.extern @ArrSender() -> (x: !esi.channel<!hw.array<4xi64>>) attributes {esi.bundle}
hw.module.extern @Reciever(%a: !esi.channel<i4>, %clk: !seq.clock) attributes {esi.bundle}
hw.module.extern @i0SenderReceiver(%in: !esi.channel<i0>) -> (out: !esi.channel<i0>)

// CHECK-LABEL: hw.module.extern @Sender(%clk: !seq.clock) -> (x: !esi.channel<i4>, y: i8)
// CHECK-LABEL: hw.module.extern @Reciever(%a: !esi.channel<i4>, %clk: !seq.clock)
...
// IFACE-NEXT:    sv.interface.modport @sink  (input @ready, output @valid, output @data)
// IFACE-NEXT:    sv.interface.modport @source  (input @valid, input @data, output @ready)
// IFACE-LABEL: hw.module.extern @Sender(%clk: !seq.clock, %x: !sv.modport<@IValidReady_i4::@sink>) -> (y: i8)
// IFACE-LABEL: hw.module.extern @ArrSender(%x: !sv.modport<@IValidReady_ArrayOf4xi64::@sink>)
// IFACE-LABEL: hw.module.extern @Reciever(%a: !sv.modport<@IValidReady_i4::@source>, %clk: !seq.clock)
...
hw.module @test(%clk: !seq.clock, %rst:i1) {
  ...
  // IFACE-LABEL: hw.module @test(%clk: !seq.clock, %rst: i1) {
...
hw.module @add11(%clk: !seq.clock, %ints: !esi.channel<i32>) -> (mutatedInts: !esi.channel<i32>, c4: i4) {
...
// HW-LABEL: hw.module @add11(%clk: !seq.clock, %ints: i32, %ints_valid: i1, %mutatedInts_ready: i1) -> (ints_ready: i1, mutatedInts: i32, mutatedInts_valid: i1, c4: i4) {
...
hw.module @test2(%clk: !seq.clock, %rst:i1) {
...
// HW-LABEL: hw.module @test2(%clk: !seq.clock, %rst: i1) {
...
hw.module @twoChannelArgs(%clk: !seq.clock, %ints: !esi.channel<i32>, %foo: !esi.channel<i7>) -> () {
  %rdy = hw.constant 1 : i1
  %i, %i_valid = esi.unwrap.vr %ints, %rdy : i32
  %i2, %i2_valid = esi.unwrap.vr %foo, %rdy : i7
}
// HW-LABEL: hw.module @twoChannelArgs(%clk: !seq.clock, %ints: i32, %ints_valid: i1, %foo: i7, %foo_valid: i1) -> (ints_ready: i1, foo_ready: i1)
...
// HW-LABEL: hw.module @i0Typed(%a: i0, %a_valid: i1, %clk: !seq.clock, %rst: i1, %x_ready: i1) -> (a_ready: i1, x: i0, x_valid: i1) {
