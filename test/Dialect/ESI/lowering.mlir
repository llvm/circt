...
// HW-LABEL: rtl.module @add11(%clk: i1, %ints: i32, %ints_valid: i1, %mutatedInts_ready: i1) -> (%mutatedInts: i32, %mutatedInts_valid: i1, %c4: i4, %ints_ready: i1) {
// HW:   %{{.+}} = rtl.constant 11 : i32
// HW:   [[RES0:%.+]] = comb.add %{{.+}}, %ints : i32
// HW:   %{{.+}} = rtl.constant 0 : i4
// HW:   rtl.output [[RES0]], %ints_valid, %{{.+}}, %mutatedInts_ready : i32, i1, i4, i1
...
// HW-LABEL: rtl.module @test2(%clk: i1, %rstn: i1) {
// HW:   %adder.mutatedInts, %adder.mutatedInts_valid, %adder.c4, %adder.ints_ready = rtl.instance "adder" @add11(%clk, %adder.mutatedInts, %adder.mutatedInts_valid, %adder.ints_ready)
// HW:   [[ZERO:%.+]] = rtl.bitcast %c0_i4 : (i4) -> i4
...
// HW:   rtl.instance "nullRcvr" @Reciever([[ZM]], %clk) : (!sv.modport<@IValidReady_i4::@source>, i1) -> ()
// HW:   %c0_i32 = rtl.constant 0 : i32
// HW:   [[ZA:%.+]] = rtl.bitcast %c0_i32 : (i32) -> !rtl.array<4xi8>
// HW:   %nullInternRcvr.in_ready = rtl.instance "nullInternRcvr" @InternRcvr([[ZA]], %false_0) : (!rtl.array<4xi8>, i1) -> i1
...
// HW-LABEL: rtl.module @twoChannelArgs(%clk: i1, %ints: i32, %ints_valid: i1, %foo: i7, %foo_valid: i1) -> (%ints_ready: i1, %foo_ready: i1)
// HW:   %true = rtl.constant true
// HW:   rtl.output %true, %true : i1, i1
