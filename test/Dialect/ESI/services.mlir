...
// CONN-NEXT:     esi.manifest.req #esi.appid<"manifest">, <@mmio::@manifest> std "esi.service.std.mmio", toClient, !esi.bundle<[!esi.channel<i32> from "offset", !esi.channel<i32> to "data"]>
