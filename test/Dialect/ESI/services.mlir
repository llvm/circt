...
// CHECK-LABEL: hw.module @Top(input %clk : !seq.clock, input %rst : i1) {
// CHECK:         esi.service.instance impl as "cosim"(%clk, %rst) : (!seq.clock, i1) -> ()
// CHECK:         hw.instance "m1" @Loopback(clk: %clk: !seq.clock) -> ()

// CONN-LABEL: hw.module @Top(input %clk : !seq.clock, input %rst : i1) {
...
// CHECK-LABEL: hw.module @Loopback(input %clk : !seq.clock) {
...
// CONN-LABEL: hw.module @Loopback(input %clk : !seq.clock, input %loopback_tohw : !esi.channel<i8>, output %loopback_fromhw : !esi.channel<i8>) {
// CONN:         hw.output %loopback_tohw : !esi.channel<i8>
hw.module @Loopback (input %clk: !seq.clock) {
...
// CONN-LABEL: hw.module @Top2(input %clk : !seq.clock, output %chksum : i8) {
...
hw.module @Top2 (input %clk: !seq.clock, output %chksum: i8) {
  %c = esi.service.instance svc @HostComms impl as  "topComms2" (%clk) : (!seq.clock) -> (i8)
  hw.instance "r1" @Rec(clk: %clk: !seq.clock) -> ()
  hw.output %c : i8
}

// CONN-LABEL: hw.module @Rec(input %clk : !seq.clock, input %m1.loopback_tohw : !esi.channel<i8>, input %c1.consumingFromChan : !esi.channel<i8>, output %m1.loopback_fromhw : !esi.channel<i8>, output %p1.producedMsgChan : !esi.channel<i8>, output %p2.producedMsgChan : !esi.channel<i8>) {
...
hw.module @Rec(input %clk: !seq.clock) {
  hw.instance "m1" @Loopback (clk: %clk: !seq.clock) -> ()
...
// CONN-LABEL: hw.module @Consumer(input %clk : !seq.clock, input %consumingFromChan : !esi.channel<i8>, output %rawData : i8) {
// CONN:         %true = hw.constant true
// CONN:         %rawOutput, %valid = esi.unwrap.vr %consumingFromChan, %true : i8
// CONN:         hw.output %rawOutput : i8
hw.module @Consumer(input %clk: !seq.clock, output %rawData: i8) {
...
// CONN-LABEL: hw.module @Producer(input %clk : !seq.clock, output %producedMsgChan : !esi.channel<i8>) {
// CONN:         %c0_i8 = hw.constant 0 : i8
// CONN:         %true = hw.constant true
// CONN:         %chanOutput, %ready = esi.wrap.vr %c0_i8, %true : i8
// CONN:         hw.output %chanOutput : !esi.channel<i8>
hw.module @Producer(input %clk: !seq.clock) {
...
// CONN-LABEL: hw.module @InOutLoopback(input %clk : !seq.clock, input %loopback_inout : !esi.channel<i16>, output %loopback_inout : !esi.channel<i8>) {
...
// CONN:          hw.output %chanOutput : !esi.channel<i8>
hw.module @InOutLoopback (input %clk: !seq.clock) {
...
// CHECK-LABEL: hw.module @MemoryAccess1(input %clk : !seq.clock, input %rst : i1, input %write : !esi.channel<!hw.struct<address: i5, data: i64>>, input %readAddress : !esi.channel<i5>, output %readData : !esi.channel<i64>, output %writeDone : !esi.channel<i0>) {
...
// CONN-LABEL: hw.module @MemoryAccess1(input %clk : !seq.clock, input %rst : i1, input %write : !esi.channel<!hw.struct<address: i5, data: i64>>, input %readAddress : !esi.channel<i5>, output %readData : !esi.channel<i64>, output %writeDone : !esi.channel<i0>) {
...
hw.module @MemoryAccess1(input %clk : !seq.clock, input %rst : i1, input %write : !esi.channel<!write>, input %readAddress : !esi.channel<i5>, output %readData : !esi.channel<i64>, output %writeDone : !esi.channel<i0>) {
...
// CONN-LABEL: hw.module @MemoryAccess2Read(input %clk : !seq.clock, input %rst : i1, input %write : !esi.channel<!hw.struct<address: i5, data: i64>>, input %readAddress : !esi.channel<i5>, input %readAddress2 : !esi.channel<i5>, output %readData : !esi.channel<i64>, output %readData2 : !esi.channel<i64>, output %writeDone : !esi.channel<i0>) {
// CONN:         %MemA = sv.reg : !hw.inout<uarray<20xi64>>
...
hw.module @MemoryAccess2Read(input %clk: !seq.clock, input %rst: i1, input %write: !esi.channel<!write>, input %readAddress: !esi.channel<i5>, input %readAddress2: !esi.channel<i5>, output %readData: !esi.channel<i64>, output %readData2: !esi.channel<i64>, output %writeDone: !esi.channel<i0>) {
  esi.service.instance svc @MemA impl as "sv_mem" (%clk, %rst) : (!seq.clock, i1) -> ()
  %done = esi.service.req.inout %write -> <@MemA::@write> ([]) : !esi.channel<!write> -> !esi.channel<i0>
  %readData = esi.service.req.inout %readAddress -> <@MemA::@read> ([]) : !esi.channel<i5> -> !esi.channel<i64>
