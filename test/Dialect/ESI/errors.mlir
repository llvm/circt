...
hw.module @test(input %m : !sv.modport<@IData::@Noexist>) {
...
hw.module @Loopback (input %clk: i1) {
...
hw.module @MemoryAccess1(input %clk: i1, input %rst: i1, input %write: !esi.channel<!write>) {
...
esi.mem.ram @MemA i64 x 20
hw.module @MemoryAccess1(input %clk: i1, input %rst: i1, input %addr: !esi.channel<i5>) {
  // expected-error @+1 {{'esi.service.instance' op failed to generate server}}
  esi.service.instance svc @MemA impl as "sv_mem" (%clk, %rst) : (i1, i1) -> ()
...
hw.module @Loopback (input %clk: i1, input %s: !esi.channel<i16>) {
...
hw.module @Loopback (input %clk: i1, input %s: !esi.channel<i8>) {
