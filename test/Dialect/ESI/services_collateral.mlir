...
hw.module @SendStruct (input %clk: !seq.clock) {
...
hw.module @LoopbackCosimTop (input %clk: !seq.clock, input %rst: i1) {
...
hw.module @LoopbackCosimTopWrapper (input %clk: !seq.clock, input %rst: i1) {
  hw.instance "top" @LoopbackCosimTop(clk: %clk: !seq.clock, rst: %rst: i1) -> ()
}

hw.module @LoopbackCosimBSP (input %clk: !seq.clock, input %rst: i1) {
