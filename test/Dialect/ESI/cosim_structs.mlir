...
hw.module.extern @Compressor(in %in : !esi.channel<i1>, out x : !pktChan)
...
// COSIM-DAG: hw.module @encode{{.+}}(in %clk : !seq.clock, in %valid : i1, in %unencodedInput : !hw.struct<encrypted: i1, compressionLevel: ui4, blob: !hw.array<32xi8>>, out encoded : !hw.array<448xi1>)
