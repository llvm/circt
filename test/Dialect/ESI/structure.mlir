...
hw.module.extern @Foo (input %clk: i1, input %in0 : !esi.channel<i1>, output %out: !esi.channel<i1>, output %a: i3)
...
// PHY-LABEL:    hw.module @top<FOO: i8, STR: none>(input %clk : i1, output %a : i3) attributes {esi.portFlattenStructs}
