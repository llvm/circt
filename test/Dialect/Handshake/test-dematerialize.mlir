...
// CHECK:           %[[VAL_14:.*]], %[[VAL_15:.*]] = cf.cond_br %[[VAL_13]], %[[VAL_3]] : none
// CHECK:           %[[VAL_16:.*]], %[[VAL_17:.*]] = cf.cond_br %[[VAL_13]], %[[VAL_7]] : i32
// CHECK:           %[[VAL_18:.*]], %[[VAL_19:.*]] = cf.cond_br %[[VAL_13]], %[[VAL_10]] : i32
// CHECK:           %[[VAL_20:.*]] = arith.cmpi sgt, %[[VAL_18]], %[[VAL_16]] : i32
// CHECK:           %[[VAL_6]], %[[VAL_5]] = cf.cond_br %[[VAL_20]], %[[VAL_14]] : none
// CHECK:           %[[VAL_21:.*]], %[[VAL_11]] = cf.cond_br %[[VAL_20]], %[[VAL_18]] : i32
// CHECK:           %[[VAL_9]], %[[VAL_22:.*]] = cf.cond_br %[[VAL_20]], %[[VAL_16]] : i32
...
handshake.func @gcd(%arg0: i32, %arg1: i32, %arg2: none, ...) -> (i32, none) {
  ...
  %6:3 = fork [3] %5 : i1
  %trueResult, %falseResult = cf.cond_br %6#2, %result : none
  %trueResult_0, %falseResult_1 = cf.cond_br %6#1, %2#0 : i32
  sink %falseResult_1 : i32
  %trueResult_2, %falseResult_3 = cf.cond_br %6#0, %4#0 : i32
  %7:2 = fork [2] %trueResult_2 : i32
  %8:2 = fork [2] %trueResult_0 : i32
  %9 = arith.cmpi sgt, %7#1, %8#1 : i32
  %10:3 = fork [3] %9 : i1
  %trueResult_4, %falseResult_5 = cf.cond_br %10#2, %trueResult : none
  %trueResult_6, %falseResult_7 = cf.cond_br %10#1, %7#0 : i32
  %trueResult_8, %falseResult_9 = cf.cond_br %10#0, %8#0 : i32
