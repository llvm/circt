...
// CHECK-LABEL:   ibis.container @AccessSibling "AccessSibling" {
...
// CHECK-LABEL:   ibis.container @Parent "Parent" {
...
ibis.design @D {
// CHECK-LABEL:   ibis.container @C1 "C1" {
...
// CHECK-LABEL:   ibis.container @C2 "C2" {
...
// CHECK-LABEL:   ibis.container @P1 "P1" {
...
// CHECK:         }
ibis.container @P1 "P1" {
  %this = ibis.this <@D::@P1>
  %c1 = ibis.container.instance @c1, <@D::@C1>
}

// CHECK-LABEL:   ibis.container @P2 "P2" {
...
ibis.design @D {
// CHECK-LABEL:   ibis.container @AccessParent "AccessParent" {
...
// CHECK:         }
ibis.container @AccessParent "AccessParent" {
