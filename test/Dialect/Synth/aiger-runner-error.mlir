...
// RUN: circt-opt %s --pass-pipeline='builtin.module(hw.module(synth-aiger-runner{solver-path="cp" solver-args="<inputFile>" solver-args="<outputFile>"}))' --verify-diagnostics
