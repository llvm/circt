...
// CHECK-NEXT: Found 2 unique endPoints
...
// CHECK-NEXT: == History End (closer to startPoint) ==
// CHECK-NEXT: ==============================================
