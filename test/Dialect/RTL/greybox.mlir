...
//CHECK-LABEL: rtl.module @local(%arg0: i1, %arg1: i1) -> (%r: i3) {
//CHECK-NEXT:    %foo.r = rtl.instance "foo" @remote(%arg0, %arg1) : (i1, i1) -> i3
...
rtl.module @local(%arg0: i1, %arg1: i1) -> (%r : i3) {
    %tr = rtl.instance "foo" @remote(%arg0, %arg1) {parameters = {DEFAULT = 0 : i64}} : (i1, i1) -> (i3)
    rtl.output %tr : i3
}
