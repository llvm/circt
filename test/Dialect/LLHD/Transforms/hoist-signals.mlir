...
hw.module @SimpleDrives(in %u: i42, in %v: i42, in %w: i42) {
  ...
  // CHECK: [[RES:%.+]]:4 = llhd.process -> i42, i42, !llhd.time, i1 {
  %2 = llhd.process -> i42 {
  ...
  ^bb1:
    ...
    // CHECK-NEXT: llhd.wait yield (%w, %u, [[DEL]], %true : i42, i42, !llhd.time, i1), ^bb2
  ...
  ^bb3:
    ...
    // CHECK-NEXT: llhd.halt %w, %v, [[EPS]], %false : i42, i42, !llhd.time, i1
    llhd.halt %w : i42
  }
  // CHECK-NEXT: }
  // CHECK-NEXT: llhd.drv %a, %u after [[DEL]] :
  // CHECK-NEXT: llhd.drv %b, [[RES]]#1 after [[DEL]] :
  // CHECK-NEXT: llhd.drv %c, %u after [[RES]]#2 :
  // CHECK-NEXT: llhd.drv %d, %u after [[DEL]] if [[RES]]#3 :
