...
calyx.program "main" {
  ...
  calyx.component @main(%clk: i1 {clk}, %go: i1 {go}, %reset: i1 {reset}) -> (%done: i1 {done}) {
    ...
    // CHECK-NEXT: %mu.left, %mu.right, %mu.write_en, %mu.clk, %mu.reset, %mu.out, %mu.done = calyx.std_mult_pipe @mu : i32, i32, i1, i1, i1, i32, i1
    // CHECK-NEXT: %du.left, %du.right, %du.write_en, %du.clk, %du.reset, %du.out_quotient, %du.out_remainder, %du.done = calyx.std_div_pipe @du : i32, i32, i1, i1, i1, i32, i32, i1
    ...
    %mu.lhs, %mu.rhs, %mu.write_en, %mu.clk, %mu.reset, %mu.out, %mu.done = calyx.std_mult_pipe @mu : i32, i32, i1, i1, i1, i32, i1
    %du.left, %du.right, %du.write_en, %du.clk, %du.reset, %du.out_quotient, %du.out_remainder, %du.done = calyx.std_div_pipe @du : i32, i32, i1, i1, i1, i32, i32, i1
