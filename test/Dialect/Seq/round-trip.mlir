...
hw.module @d1(%clk : i1) -> () {
// CHECK: %myMemory = seq.hlmem @myMemory %clk : <4xi32>
...
hw.module @d2(%clk : i1) -> () {
// CHECK: %myMemory = seq.hlmem @myMemory %clk : <4x8xi32>
  %myMemory = seq.hlmem @myMemory %clk : <4x8xi32>
  ...
  // CHECK: %myMemory_rdata = seq.read %myMemory[%c0_i2, %c0_i3] rden %true {latency = 0 : i64} : !seq.hlmem<4x8xi32>
  %myMemory_rdata = seq.read %myMemory[%c0_i2, %c0_i3] rden %c1_i1 { latency = 0} : !seq.hlmem<4x8xi32>
