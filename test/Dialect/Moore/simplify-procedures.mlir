...
moore.module @Foo() {
  ...
  moore.procedure always_comb {
    ...
    moore.blocking_assign %a, %0 : !moore.ref<i32>, i32

    // CHECK: [[TMP:%.+]] = moore.read [[LOCAL_A]]
    // CHECK: moore.blocking_assign %x, [[TMP]]
    %1 = moore.read %a : !moore.ref<i32> -> i32
    moore.blocking_assign %x, %1 : !moore.ref<i32>, i32
    ...
    // CHECK: [[TMP:%.+]] = moore.read [[LOCAL_A]]
    // CHECK: moore.blocking_assign %a, [[TMP]]
    %2 = moore.read %a : !moore.ref<i32> -> i32
    %3 = moore.constant 1 : i32
    %4 = moore.add %2, %3 : i32
    moore.blocking_assign %a, %4 : !moore.ref<i32>, i32
  ...
  moore.procedure always_comb {
    ...
    moore.blocking_assign %y, %0 : !moore.ref<i32>, i32
