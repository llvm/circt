...
hir.func @readA at %t(
  ...
  %Aw : !hir.memref<16x(bank 16)xi32> ports [#bram_w]){
    ...
    %cLB_i5 = hw.constant 0:i5 
    %cStep_i5 = hw.constant 1:i5 
    %cUB_i5 = hw.constant 4:i5
    %c2_i5 = hw.constant 2:i5 
    %c4_i5 = hw.constant 4:i5 

  //Write to block ram A.
  hir.for %i : i5 = %cLB_i5  to %cUB_i5  step %cStep_i5 iter_time(%ti = %t + 1){
...
hir.func @readB at %t(
  ...
  hir.for %j : i5 = %cLB_i5 to %cUB_i5 step %cStep_i5 iter_time(%tj = %t + 1){
    %tk_end =hir.for %k : i5 = %cLB_i5 to %cUB_i5 step %cStep_i5 iter_time(%tk = %tj + 1){
