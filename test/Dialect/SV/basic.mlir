...
// CHECK-LABEL: hw.module @test1(input %arg0 : i1, input %arg1 : i1, input %arg8 : i8) {
hw.module @test1(input %arg0: i1, input %arg1: i1, input %arg8: i8) {
...
hw.module.extern @ExternDestMod(input %a: i1, input %b: i2)
hw.module @InternalDestMod(input %a: i1, input %b: i2) {}
//CHECK-LABEL: hw.module @AB(input %a : i1, input %b : i2) {
...
hw.module @AB(input %a: i1, input %b: i2) {
...
hw.module @nested_wire(input %a: i1) {
  // CHECK: sv.ifdef "foo"
  sv.ifdef "foo" {
    // CHECK: sv.wire
