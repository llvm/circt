...
//CHECK-NEXT:   hw.instance "whazzzup" @ExternDestMod(a: %a: i1, b: %b: i2) -> () {oldParameters = {CFG = #sv.verbatim.parameter<"\22FOO\22">}}
//CHECK-NEXT:   hw.output
//CHECK-NEXT: }
hw.module @AB(%a: i1, %b: i2) -> () {
  ...
  hw.instance "whazzzup" @ExternDestMod(a: %a: i1, b: %b: i2) -> () {oldParameters = {CFG = #sv.verbatim.parameter<"\"FOO\"">}}
  hw.output
}
