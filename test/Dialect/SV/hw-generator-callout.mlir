...
// CHECK:   hw.module.extern @FIRRTLMem_1_1_1_42_12_0_1_0(%ro_clock_0: i1, %ro_en_0: i1, %ro_addr_0: i4, %rw_clock_0: i1, %rw_en_0: i1, %rw_addr_0: i4, %rw_wmode_0: i1, %rw_wmask_0: i1, %rw_wdata_0: i42, %wo_clock_0: i1, %wo_en_0: i1, %wo_addr_0: i4, %wo_mask_0: i1, %wo_data_0: i42) -> (%ro_data_0: i42, %rw_rdata_0: i42) attributes {filenames = "file1.v,file2.v,file3.v,file4.v --moduleName FIRRTLMem_1_1_1_42_12_0_1_0 --hierarchichalName Top.A.MemSimple.FIRRTLMem_1_1_1_42_12_0_1_0 --depth 12 --numReadPorts 1 --numWritePorts 1 --numReadWritePorts 1 --readLatency 0 --writeLatency 1 --width 42 --readUnderWrite 0 --baseAddress 2147516416 --dataBits 8 --eccBits 0 --eccIndices 32,33,34,35,36,37,38 --eccScheme none"}
  ...
  {depth = 12 : i64, numReadPorts = 1 : ui32, numReadWritePorts = 1 : ui32, numWritePorts = 1 : ui32, readLatency = 0 :
  ...
  hw.module @MemSimple(%clock1: i1, %clock2: i1, %inpred: i1, %indata: i42) -> (%result: i42, %result2: i42) {
    ...
    %_M.ro_data_0, %_M.rw_rdata_0 = hw.instance "_M" @FIRRTLMem_1_1_1_42_12_0_1_0(%clock1, %true, %c0_i4, %clock1, %true, %c0_i4_0, %true, %true, %0, %clock2, %inpred, %c0_i4_1, %true, %indata) : (i1, i1, i4, i1, i1, i4, i1, i1, i42, i1, i1, i4, i1, i42) -> (i42, i42)
