...
hw.module @assert_canonicalization(input %clock: i1) {
...
// CHECK-LABEL: hw.module @svAttrPreventsCanonicalization(input %arg0 : i1) {
hw.module @svAttrPreventsCanonicalization(input %arg0: i1) {
...
hw.module @case_stmt(input %arg: i3) {
  %fd = hw.constant 0x80000002 : i32
  sv.initial {
    // CHECK: sv.case %arg
