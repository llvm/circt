...
// -----
hw.module @Bpassign(input %arg0: i1) {
...
// -----
hw.module @Passign(input %arg0: i1) {
  %reg = sv.reg : !hw.inout<i1>
...
// -----
hw.module @ForcePassign(input %arg0: i1) {
  %reg = sv.reg : !hw.inout<i1>
...
// -----
hw.module @ReleasePassign(input %arg0: i1) {
  %reg = sv.reg : !hw.inout<i1>
...
// -----
hw.module @Always(input %arg0: i1) {
  sv.initial {
...
// -----
hw.module @AlwaysFF(input %arg0: i1) {
  sv.initial {
...
hw.module @NoMessage(input %clock: i1, input %value : i4) {
