...
hw.module @parameters<p1: i42 = 17, wire: i1>(%p1: i8) {
  ...
  // CHECK: hw.instance "inst2" @module_with_bool<bparam: i1 = #hw.param.expr.or<#hw.param.verbatim<"wire">, true>>()
  hw.instance "inst2" @module_with_bool<bparam: i1 = #hw.param.expr.or<#hw.param.verbatim<"wire">, true>>() -> ()
}
