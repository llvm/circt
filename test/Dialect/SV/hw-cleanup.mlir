...
//CHECK-LABEL: hw.module @alwaysff_basic(input %arg0 : i1, input %arg1 : i1) {
...
//SEPARATE-LABEL: hw.module @alwaysff_basic(input %arg0 : i1, input %arg1 : i1) {
...
hw.module @alwaysff_basic(input %arg0: i1, input %arg1: i1) {
...
// CHECK-LABEL: hw.module @alwaysff_basic_reset(input %arg0 : i1, input %arg1 : i1) {
// CHECK-NEXT:   [[FD:%.*]] = hw.constant -2147483646 : i32
// CHECK-NEXT:   sv.alwaysff(posedge %arg0)  {
// CHECK-NEXT:     sv.fwrite [[FD]], "A1"
// CHECK-NEXT:     sv.fwrite [[FD]], "A2"
...
hw.module @alwaysff_basic_reset(input %arg0: i1, input %arg1: i1) {
  %fd = hw.constant 0x80000002 : i32
...
// CHECK-LABEL: hw.module @alwaysff_different_reset(input %arg0 : i1, input %arg1 : i1) {
// CHECK-NEXT:   [[FD:%.*]] = hw.constant -2147483646 : i32
// CHECK-NEXT:   sv.alwaysff(posedge %arg0)  {
// CHECK-NEXT:     sv.fwrite [[FD]], "A1"
// CHECK-NEXT:     sv.fwrite [[FD]], "A2"
...
hw.module @alwaysff_different_reset(input %arg0: i1, input %arg1: i1) {
  %fd = hw.constant 0x80000002 : i32
...
//CHECK-LABEL: hw.module @alwaysff_ifdef(input %arg0 : i1) {
//CHECK-NEXT:  [[FD:%.*]] = hw.constant -2147483646 : i32
...
hw.module @alwaysff_ifdef(input %arg0: i1) {
  %fd = hw.constant 0x80000002 : i32
...
// CHECK-LABEL: hw.module @ifdef_merge(input %arg0 : i1) {
// CHECK-NEXT:    [[FD:%.*]] = hw.constant -2147483646 : i32
// CHECK-NEXT:    sv.ifdef "FOO"  {
// CHECK-NEXT:      sv.alwaysff(posedge %arg0)  {
// CHECK-NEXT:        sv.fwrite [[FD]], "A1"
...
// CHECK-NEXT:      }
// CHECK-NEXT:    }
hw.module @ifdef_merge(input %arg0: i1) {
  %fd = hw.constant 0x80000002 : i32
...
// CHECK-LABEL: hw.module @ifdef_proc_merge(input %arg0 : i1) {
// CHECK-NEXT:    [[FD:%.*]] = hw.constant -2147483646 : i32
// CHECK-NEXT:    sv.alwaysff(posedge %arg0)  {
...
// CHECK-NEXT:      }
// CHECK-NEXT:    }
hw.module @ifdef_proc_merge(input %arg0: i1) {
  %fd = hw.constant 0x80000002 : i32
...
// CHECK-LABEL: hw.module @if_merge(input %arg0 : i1, input %arg1 : i1) {
// CHECK-NEXT:    [[FD:%.*]] = hw.constant -2147483646 : i32
// CHECK-NEXT:    sv.alwaysff(posedge %arg0)  {
// CHECK-NEXT:      %true = hw.constant true
...
// CHECK-NEXT:      }
// CHECK-NEXT:    }
hw.module @if_merge(input %arg0: i1, input %arg1: i1) {
  %fd = hw.constant 0x80000002 : i32
...
// CHECK-LABEL: hw.module @initial_merge(input %arg0 : i1) {
// CHECK-NEXT:    [[FD:%.*]] = hw.constant -2147483646 : i32
// CHECK-NEXT:    sv.initial {
// CHECK-NEXT:      sv.fwrite [[FD]], "A1"
// CHECK-NEXT:      sv.fwrite [[FD]], "B1"
// CHECK-NEXT:    }
hw.module @initial_merge(input %arg0: i1) {
  %fd = hw.constant 0x80000002 : i32
...
//CHECK-LABEL: hw.module @always_basic(input %arg0 : i1, input %arg1 : i1) {
//CHECK-NEXT:   [[FD:%.*]] = hw.constant -2147483646 : i32
//CHECK-NEXT:   sv.initial {
//CHECK-NEXT:     sv.fwrite [[FD]], "Middle\0A"
//CHECK-NEXT:   }
...
//SEPARATE-LABEL: hw.module @always_basic(input %arg0 : i1, input %arg1 : i1) {
//SEPARATE-NEXT:   [[FD:%.*]] = hw.constant -2147483646 : i32
...
hw.module @always_basic(input %arg0: i1, input %arg1: i1) {
  %fd = hw.constant 0x80000002 : i32
