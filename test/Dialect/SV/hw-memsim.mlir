...
hw.module @complex(%clock: i1, %reset: i1, %r0en: i1, %mode: i1, %data0: i16) -> (data1: i16, data2: i16) {
  ...
  %tmp41.ro_data_0, %tmp41.rw_rdata_0 = hw.instance "tmp41"
   @FIRRTLMem_1_1_1_16_10_2_4_0_0(ro_addr_0: %c0_i4: i4, ro_en_0: %r0en: i1,
     ...
     wo_clock_0: %clock: i1, wo_data_0: %data0: i16, wo_mask_0: %true: i1) -> (ro_data_0: i16, rw_rdata_0: i16) {firrtl.dutMemory = #hw.output_file<"seq_mems.json", excludeFromFileList>, firrtl.memConfigFile = #hw.output_file<"memory.conf", excludeFromFileList>, firrtl.seq_mem_verif_data = {baseAddress = 2187483648 : i64, dataBits = 8 : i64, eccBits = 0 : i64, eccIndices = [], eccScheme = "none"}}
  ...
  hw.instance "memory"
    @FIRRTLMemOneAlways(wo_addr_0: %w0_addr: i4, wo_en_0: %w0_en: i1,
      ...
      wo_addr_1: %w1_addr: i4, wo_en_1: %w1_en: i1, wo_clock_1: %clock: i1,
       wo_data_1: %w1_data: i8,wo_mask_1: %w1_mask: i1) -> (){firrtl.testbenchMemory = #hw.output_file<"tb_seq_mems.json", excludeFromFileList>, firrtl.memConfigFile = #hw.output_file<"memory.conf", excludeFromFileList>, firrtl.seq_mem_verif_data = {baseAddress = 2147433648 : i64, dataBits = 8 : i64, eccBits = 0 : i64, eccIndices = [], eccScheme = "none"}}
  hw.output
}
...
hw.module @WriteOrderedDifferentClock(%clock: i1, %clock2: i1, %w0_addr: i4, %w0_en: i1, %w0_data: i8, %w0_mask: i1, %w1_addr: i4, %w1_en: i1, %w1_data: i8, %w1_mask: i1) {
  hw.instance "memory"
    @FIRRTLMemTwoAlways(wo_addr_0: %w0_addr: i4, wo_en_0: %w0_en: i1,
      ...
      wo_data_1: %w1_data: i8, wo_mask_1: %w1_mask: i1) -> () {firrtl.dutMemory = #hw.output_file<"seq_mems.json", excludeFromFileList>, firrtl.memConfigFile = #hw.output_file<"memory.conf", excludeFromFileList>, firrtl.seq_mem_verif_data = {baseAddress = 2127483648 : i64, dataBits = 8 : i64, eccBits = 0 : i64, eccIndices = [], eccScheme = "none"}}
  hw.output
}
...
//CHECK-NOT:      sv.alwaysff
  ...
  // CHECK{LITERAL}: sv.verbatim "[{\22module_name\22:\22{{0}}\22,\22depth\22:10,\22width\22:16,\22mask\22:\22true\22,\22read\22:\22true\22,\22write\22:\22true\22,\22readwrite\22:\22true\22,\22mask_granularity\22:1,\22extra_ports\22:[],\22hierarchy\22:[\22complex.tmp41\22],\22verification_only_data\22:{\22complex.tmp41\22:{\22baseAddress\22:2187483648,\22dataBits\22:8,\22eccBits\22:0,\22eccIndices\22:[],\22eccScheme\22:\22none\22}}},{\22module_name\22:\22{{1}}\22,\22depth\22:16,\22width\22:8,\22mask\22:\22true\22,\22read\22:\22false\22,\22write\22:\22true\22,\22readwrite\22:\22false\22,\22mask_granularity\22:1,\22extra_ports\22:[],\22hierarchy\22:[\22WriteOrderedDifferentClock.memory\22],\22verification_only_data\22:{\22WriteOrderedDifferentClock.memory\22:{\22baseAddress\22:2127483648,\22dataBits\22:8,\22eccBits\22:0,\22eccIndices\22:[],\22eccScheme\22:\22none\22}}}]" {output_file = #hw.output_file<"seq_mems.json", excludeFromFileList>, symbols = [@FIRRTLMem_1_1_1_16_10_2_4_0_0, @FIRRTLMemTwoAlways]}
  // CHECK{LITERAL}: sv.verbatim "[{\22module_name\22:\22{{0}}\22,\22depth\22:16,\22width\22:8,\22mask\22:\22true\22,\22read\22:\22false\22,\22write\22:\22true\22,\22readwrite\22:\22false\22,\22mask_granularity\22:1,\22extra_ports\22:[],\22hierarchy\22:[\22WriteOrderedSameClock.memory\22],\22verification_only_data\22:{\22WriteOrderedSameClock.memory\22:{\22baseAddress\22:2147433648,\22dataBits\22:8,\22eccBits\22:0,\22eccIndices\22:[],\22eccScheme\22:\22none\22}}}]" {output_file = #hw.output_file<"tb_seq_mems.json", excludeFromFileList>, symbols = [@FIRRTLMemOneAlways]}
  // CHECK{LITERAL}: sv.verbatim "name {{0}} depth 10 width 10 ports mrw mask_gran 1 \0Aname {{1}} depth 16 width 16 ports mwrite mask_gran 1 \0Aname {{2}} depth 16 width 16 ports mwrite mask_gran 1 \0A" {output_file = #hw.output_file<"memory.conf", excludeFromFileList>, symbols = [@FIRRTLMem_1_1_1_16_10_2_4_0_0, @FIRRTLMemTwoAlways, @FIRRTLMemOneAlways]}
