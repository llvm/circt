...
hw.module @WriteOrderedSameClock(%clock: i1, %w0_addr: i4, %w0_en: i1, %w0_data: i8, %w0_mask: i1, %w1_addr: i4, %w1_en: i1, %w1_data: i8, %w1_mask: i1) {
  hw.instance "memory"
    @FIRRTLMemOneAlways(wo_clock_0: %clock: i1, wo_en_0: %w0_en: i1,
      ...
      wo_mask_1: %w1_mask: i1, wo_data_1: %w1_data: i8) -> (){firrtl.testbenchMemory = #hw.output_file<"tb_seq_mems.json", excludeFromFileList>, firrtl.memConfigFile = #hw.output_file<"memory.conf", excludeFromFileList>, firrtl.seq_mem_verif_data = {baseAddress = 2147433648 : i64, dataBits = 8 : i64, eccBits = 0 : i64, eccIndices = [], eccScheme = "none"}}
  hw.output
}
...
hw.module @WriteOrderedDifferentClock(%clock: i1, %clock2: i1, %w0_addr: i4, %w0_en: i1, %w0_data: i8, %w0_mask: i1, %w1_addr: i4, %w1_en: i1, %w1_data: i8, %w1_mask: i1) {
  hw.instance "memory"
    @FIRRTLMemTwoAlways(wo_clock_0: %clock: i1, wo_en_0: %w0_en: i1,
      ...
      wo_mask_1: %w1_mask: i1, wo_data_1: %w1_data: i8) -> () {firrtl.dutMemory = #hw.output_file<"seq_mems.json", excludeFromFileList>, firrtl.memConfigFile = #hw.output_file<"memory.conf", excludeFromFileList>, firrtl.seq_mem_verif_data = {baseAddress = 2127483648 : i64, dataBits = 8 : i64, eccBits = 0 : i64, eccIndices = [], eccScheme = "none"}}
  hw.output
}
