...
module {
  ...
  hw.module.extern @Rcvr (input %m: !sv.modport<@handshake_example::@dataflow_in>)
  // CHECK-LABEL: hw.module.extern @Rcvr(input %m : !sv.modport<@handshake_example::@dataflow_in>)
