// RUN:  circt-opt -rtl-generator-callout='schema-name=Schema_Name generator-executable=echo generator-executable-arguments=file1.v,file2.v,file3.v,file4.v;-n generator-executable-output-filename=litTestout' %s | FileCheck %s
...
module attributes {firrtl.mainModule = "top_mod"}  {
  ...
  rtl.module @top_mod(%clock: i1, %reset: i1, %r0en: i1) -> (%data: i16) {
    ...
    %tmp42.rd_data_0 = rtl.instance "tmp42" @sampleModuleName1(%clock, %r0en, %c0_i4, %clock, %r0en, %c0_i4, %false, %c0_i16) : (i1, i1, i4, i1, i1, i4, i1, i16) -> i16
