...
// CHECK-NOT: foo_cover
// CHECK: sv.bind "__ETC_issue1246_assert" @issue1246_assert #hw.innerNameRef<@issue1246::@__ETC_issue1246_assert> 
// CHECK: sv.bind "__ETC_issue1246_assume" @issue1246_assume #hw.innerNameRef<@issue1246::@__ETC_issue1246_assume> {output_file = #hw.output_file<"file4", excludeFromFileList>} 
// CHECK: sv.bind "__ETC_issue1246_cover" @issue1246_cover #hw.innerNameRef<@issue1246::@__ETC_issue1246_cover> 
