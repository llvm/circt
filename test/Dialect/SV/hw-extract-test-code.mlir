...
module attributes {firrtl.extract.assert =  #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>, firrtl.extract.assume.bindfile = #hw.output_file<"file4", excludeFromFileList>} {
  hw.module.extern @foo_cover(input %a : i1) attributes {"firrtl.extract.cover.extra"}
  hw.module.extern @foo_assume(input %a : i1) attributes {"firrtl.extract.assume.extra"}
  hw.module.extern @foo_assert(input %a : i1) attributes {"firrtl.extract.assert.extra"}
  hw.module @issue1246(input %clock: i1) {
...
module attributes {firrtl.extract.assert =  #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>} {
  hw.module @AlreadyExtracted(input %clock: i1) {
    sv.always posedge %clock  {
      sv.assert %clock, immediate
    }
  }
  hw.module @Top(input %clock: i1) {
...
module attributes {firrtl.extract.assert =  #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>} {
  hw.module @ModuleInTestHarness(input %clock: i1) attributes {"firrtl.extract.do_not_extract"} {
    sv.always posedge %clock  {
      sv.assert %clock, immediate
    }
  }
...
module attributes {firrtl.extract.assert =  #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>} {
  hw.module @InstanceName(input %clock: i1, input %cond: i1, input %cond2: i1) {
    sv.always posedge %clock  {
...
module attributes {firrtl.extract.assert =  #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>} {
  hw.module @MultiRead(input %clock: i1, input %cond: i1) {
...
module attributes {firrtl.extract.assert =  #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>} {
  ...
  hw.module @Dummy(input %in1: i1, input %in2: i1) {}
  hw.module @InstResult(input %clock: i1) {
...
module {
  ...
  hw.module private @InputOnly(input %clock: i1, input %cond: i1) {
    sv.always posedge %clock  {
      sv.cover %cond, immediate
      sv.assert %cond, immediate
    }
  ...
  hw.module private @InputOnlySym(input %clock: i1, input %cond: i1) {
    sv.always posedge %clock  {
      sv.cover %cond, immediate
    }
  }

  hw.module private @InputOnlyCycle(input %clock: i1, input %cond: i1) {
  ...
  hw.module private @InputOnlyBind(input %clock: i1, input %cond: i1) {
...
module {
  ...
  hw.module @CycleExtracted(input %clock: i1, input %in: i1) {
    %foo.b = hw.instance "foo" @Foo(a: %in: i1) -> (b: i1)
  ...
  hw.module private @ShouldBeInlined(input %clock: i1, input %in: i1) {
    %foo.b = hw.instance "foo" @Foo(a: %in: i1) -> (b: i1)
    sv.always posedge %clock {
      sv.cover %foo.b, immediate
    }
  ...
  hw.module private @ShouldBeInlined2(input %clock: i1, input %in: i1) {
  ...
  hw.module @ChildShouldInline(input %clock: i1, input %in: i1) {
    hw.instance "child" @ShouldBeInlined(clock: %clock: i1, in: %in: i1) -> ()
  }

  hw.module @ChildShouldInline2(input %clock: i1, input %in: i1) {
    hw.instance "child" @ShouldBeInlined2(clock: %clock: i1, in: %in: i1) -> ()
  }

  hw.module @MultiResultExtracted(input %clock: i1, input %in: i1) {
  ...
  hw.module @SymNotExtracted(input %clock: i1, input %in: i1) {
  ...
  hw.module @NoExtraInput(input %clock: i1, input %in: i1) {
    %0 = comb.or %in, %in : i1
...
module {
  ...
  hw.module private @ShouldNotBeInlined(input %clock: i1, input %a: i1) {
  ...
  hw.module private @Assert(input %clock: i1, input %a: i1) {
    sv.always posedge %clock {
      sv.if %a {
        sv.assert %a, immediate message "foo"
      }
  ...
  // CHECK-NOT: @InputOnly
  hw.module private @InputOnly(input %clock: i1, input %a: i1) {
  ...
  // CHECK-NOT: doNotPrint
  hw.module @Top(input %clock: i1, input %a: i1, input %b: i1) {
