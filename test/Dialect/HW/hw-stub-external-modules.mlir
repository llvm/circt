...
// CHECK-LABEL: hw.module @local(inout %arg0 : i1, input %arg1 : i1, output r : i3, output s : i3) {
...
// CHECK-NEXT:  }
// CHECK-LABEL: hw.module @remote(inout %arg0 : i1, input %arg1 : i1, output r : i3) {
// CHECK-NEXT: %x_i3 = sv.constantX : i3
// CHECK-NEXT:   hw.output %x_i3 : i3
// CHECK-NEXT: }
// CHECK-LABEL: hw.module @remoteWithParams<a: i4>(inout %arg0 : i1, input %arg1 : i1, output r : i3) {
// CHECK-NEXT: %x_i3 = sv.constantX : i3
// CHECK-NEXT:   hw.output %x_i3 : i3
// CHECK-NEXT: }

hw.module.extern @remote(inout %arg0: i1, input %arg1: i1, output r : i3)

hw.module.extern @remoteWithParams<a: i4>(inout %arg0: i1, input %arg1: i1, output r : i3)


hw.module @local(inout %arg0: i1, input %arg1: i1, output r: i3, output s: i3) {
