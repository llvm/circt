...
hw.module @extract_noop(input %arg0 : i3, output %foo "": i3) {
...
hw.module @div_cstfold(input %arg0 : i7, output %result : i7, a: i7, b: i7, c: i7) {
...
// CHECK-LABEL: hw.module @mod_cstfold(input %arg0 : i7, output %result : i7, a: i7, b: i7, c: i7) {
// CHECK-NEXT:    %c0_i7 = hw.constant 0 : i7
// CHECK-NEXT:    %c1_i7 = hw.constant 1 : i7
// CHECK-NEXT:    hw.output %c0_i7, %c0_i7, %c1_i7, %c0_i7 : i7, i7, i7, i7
hw.module @mod_cstfold(input %arg0 : i7, output %result : i7, a: i7, b: i7, c: i7) {
  %c1_i7 = hw.constant 1 : i7
  %c-3_i7 = hw.constant -3 : i7
  %c5_i7 = hw.constant 5 : i7
  %c10_i7 = hw.constant 10 : i7
