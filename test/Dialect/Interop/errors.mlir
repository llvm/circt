...
hw.module @entryBlockHasNumInputsPlusStatesArguments (input %arg0: i1) {
...
hw.module @entryBlockArgumentTypesMatch (input %arg0: i16, input %arg1: i1) {
...
hw.module @entryBlockArgumentTypesMatch (input %arg0: i2) {
  // expected-error @+1 {{region argument types must match state types}}
...
hw.module @entryBlockArgumentTypesMatch (input %arg0: i1) {
  // expected-error @+1 {{region argument types must match state types}}
  interop.procedural.dealloc cpp %arg0 : i1 {
  ^bb0(%barg0: i2):
  }
...
hw.module @returnNumOperandsMatchParentsResults (input %arg0: i32) {
...
hw.module @returnOperandsMustMatchParentsResultTypes (input %arg0: i32) {
  interop.procedural.init cpp %arg0 : i32 {
    %1 = hw.constant 0 : i8
