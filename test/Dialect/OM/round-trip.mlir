...
om.class @Thingy(%blue_1: i8, %blue_2: i32) {
  ...
  // CHECK: om.class.fields {field_names = ["widget", "gadget", "blue_1", "blue_2"]} %2, %5, %blue_1, %6 : !om.class.type<@Widget>, !om.class.type<@Gadget>, i8, i8
  om.class.fields {field_names = ["widget", "gadget", "blue_1", "blue_2"]} %2, %5, %blue_1, %6 : !om.class.type<@Widget>, !om.class.type<@Gadget>, i8, i8
}
...
om.class @NestedField1() {
  %0 = om.constant 1 : i1
  om.class.fields {field_names = "baz"} %0 : i1
}

om.class @NestedField2() {
  %0 = om.object @NestedField1() : () -> !om.class.type<@NestedField1>
  om.class.fields {field_names = "bar"} %0 : !om.class.type<@NestedField1>
}

om.class @NestedField3() {
  %0 = om.object @NestedField2() : () -> !om.class.type<@NestedField2>
  om.class.fields {field_names = "foo"} %0 : !om.class.type<@NestedField2>
}
...
om.class @ReferenceParameter(%arg0: !om.ref, %arg1: !om.sym_ref) {
  // CHECK: om.class.fields {field_names = ["myref", "sym"]} %arg0, %arg1 : !om.ref, !om.sym_ref
  om.class.fields {field_names = ["myref", "sym"]} %arg0, %arg1 : !om.ref, !om.sym_ref
}
...
om.class @ReferenceConstant() {
  ...
  // CHECK: om.class.fields {field_names = ["myref", "sym"]} %[[const1]], %[[const2]] : !om.ref, !om.sym_ref
  om.class.fields {field_names = ["myref", "sym"]} %0, %1 : !om.ref, !om.sym_ref
}
...
om.class @ListConstant() {
  ...
  // CHECK: om.class.fields {field_names = ["list_i64", "list_i32"]} %[[const1]], %[[const2]] : !om.list<i64>, !om.list<i32>
  om.class.fields {field_names = ["list_i64", "list_i32"]} %0, %1 : !om.list<i64>, !om.list<i32>
}
...
om.class @ListCreate() {
  ...
  // CHECK: om.class.fields {field_names = ["list_field"]} [[list]] : !om.list<!om.class.type<@Widget>>
  om.class.fields {field_names = ["list_field"]} %list : !om.list<!om.class.type<@Widget>>
}
...
om.class @IntegerConstant() {
  ...
  // CHECK: om.class.fields {field_names = ["int"]} %[[const1]] : !om.integer
  om.class.fields {field_names = ["int"]} %0 : !om.integer
}
...
om.class @StringConstant() {
  ...
  // CHECK: om.class.fields {field_names = ["string"]} %[[const1]] : !om.string
  om.class.fields {field_names = ["string"]} %0 : !om.string
}

// CHECK-LABEL: @LinkedList
om.class @LinkedList(%prev: !om.class.type<@LinkedList>) {
  om.class.fields {field_names = ["prev"]} %prev : !om.class.type<@LinkedList>
}
...
om.class @BoolConstant(%b0 : i1) {
  ...
  %2 = om.constant false
  // CHECK: om.class.fields {field_names = ["bool", "bool2", "bool3"]} %b0, %[[const1]], %[[const2]] : i1, i1, i1
  om.class.fields {field_names = ["bool", "bool2", "bool3"]} %b0, %1, %2 : i1, i1, i1
}

// CHECK-LABEL: @Map
// CHECK-SAME: !om.map<!om.string, !om.string>
om.class @Map(%map: !om.map<!om.string, !om.string>) {
  om.class.fields {field_names = ["field"]} %map : !om.map<!om.string, !om.string>
}
...
om.class @Tuple(%int: i1, %str: !om.string) {
  ...
  // CHECK-NEXT: om.class.fields {field_names = ["tuple", "val"]} %[[tuple]], %[[tuple_get]] : tuple<i1, !om.string>, !om.string
  om.class.fields {field_names = ["tuple", "val"]} %tuple, %val : tuple<i1, !om.string>, !om.string
}
...
om.class @MapConstant() {
  ...
  // CHECK: om.class.fields {field_names = ["map_i64"]} %[[const1]] : !om.map<!om.string, i64>
  om.class.fields {field_names = ["map_i64"]} %0 : !om.map<!om.string, i64>
}
...
om.class @MapCreate(%e1: tuple<!om.string, !om.class.type<@Empty>>, %e2: tuple<!om.string, !om.class.type<@Empty>>) {
  ...
  // CHECK-NEXT: om.class.fields {field_names = ["map_field"]} %[[map]] : !om.map<!om.string, !om.class.type<@Empty>>
  om.class.fields {field_names = ["map_field"]} %map : !om.map<!om.string, !om.class.type<@Empty>>
}
...
om.class @Path(%basepath: !om.basepath) {
  ...
  %3 = om.path_empty
  // CHECK: om.class.fields {field_names = ["path_empty"]} %[[v3]] : !om.path
  om.class.fields {field_names = ["path_empty"]} %3 : !om.path
}
...
om.class @Any(%in: !om.class.type<@Empty>) {
  ...
  // CHECK: om.class.fields {field_names = ["field"]} %[[CAST]] : !om.any
  om.class.fields {field_names = ["field"]} %0 : !om.any
}
