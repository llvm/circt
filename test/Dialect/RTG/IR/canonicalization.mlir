...
func.func @dummy3(%arg0: index) -> () {return}
func.func @dummy4(%arg0: !rtgtest.ireg) -> () {return}
...
rtg.test @testIndexToRegister() {
  ...
  // CHECK-NEXT: func.call @dummy4([[ZERO]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[RA]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[SP]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[GP]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[TP]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T0]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T1]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T2]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S0]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S1]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A0]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A1]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A2]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A3]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A4]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A5]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A6]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[A7]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S2]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S3]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S4]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S5]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S6]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S7]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S8]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S9]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S10]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[S11]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T3]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T4]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T5]]) : (!rtgtest.ireg) -> ()
  // CHECK-NEXT: func.call @dummy4([[T6]]) : (!rtgtest.ireg) -> ()
