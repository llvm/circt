...
rtg.test @embed_value() {
  ...
  rtgtest.lui %reg, %exp_val : !rtg.isa.immediate<32>
}
...
rtg.test @duplicate_validate_id_error() {
  ...
  rtgtest.lui %reg, %exp_val : !rtg.isa.immediate<32>
  rtgtest.lui %reg, %exp_val2 : !rtg.isa.immediate<32>
}
...
rtg.test @unmached_validate_stays() {
  ...
  // CHECK-TEST5-NEXT: rtgtest.lui [[REG]], [[VAL]] : !rtg.isa.immediate<32>
  %reg = rtg.constant #rtgtest.t0
  %imm = rtg.constant #rtg.isa.immediate<32, 0x1000>
...
rtg.test @embed_value() {
  ...
  rtgtest.lui %0, %6#0 : !rtg.isa.immediate<32>
  rtgtest.lui %0, %6#1 : !rtg.isa.immediate<32>
  rtgtest.lui %0, %6#2 : !rtg.isa.immediate<32>
}
...
rtg.test @embed_value() {
  ...
  // CHECK-TEST7-NEXT: rtgtest.lui [[REG]], [[IMM]] : !rtg.isa.immediate<32>
  %reg = rtg.constant #rtgtest.t0
  %imm = rtg.constant #rtg.isa.immediate<32, 0x1000>
  %exp_val = rtg.validate %reg, %imm, "id1" : !rtgtest.ireg -> !rtg.isa.immediate<32>
  rtgtest.lui %reg, %exp_val : !rtg.isa.immediate<32>
