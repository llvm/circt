...
//--- test1.mlir
// RUN: ! (circt-opt %t/test1.mlir --rtg-embed-validation-values=filename=%S/validation-values-0.txt 2>&1) | FileCheck %s --check-prefix=CHECK-TEST1
...
//--- test2.mlir
// RUN: ! (circt-opt %t/test2.mlir --rtg-embed-validation-values=filename=%S/validation-values-1.txt 2>&1) | FileCheck %s --check-prefix=CHECK-TEST2
...
//--- test3.mlir
// RUN: ! (circt-opt %t/test3.mlir --rtg-embed-validation-values=filename=%S/validation-values-2.txt 2>&1) | FileCheck %s --check-prefix=CHECK-TEST3
