...
// CHECK: func.call @dummy2([[V0]]) :
rtg.test @targetTest(%num_cpus: index) {
  func.call @dummy2(%num_cpus) : (index) -> ()
}

// CHECK-NOT: @unmatchedTest
rtg.test @unmatchedTest(%num_cpus: !rtg.sequence) {
...
rtg.test @contexts(%cpu0: !rtgtest.cpu, %cpu1: !rtgtest.cpu) {
...
rtg.test @invalidRandomization(%cpu: !rtgtest.cpu) {
...
rtg.test @contextSwitchNotAvailable(%cpu: !rtgtest.cpu) {
