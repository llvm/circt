...
rtg.test @basic() {
  ...
  // CHECK-NEXT: rtgtest.lui [[REG]], [[IMM0]] : !rtg.isa.immediate<32>
  ...
  rtgtest.lui %1, %3 : !rtg.isa.immediate<32>
  ...
  // CHECK-NEXT: rtg.label global [[LBL]]
  // CHECK-NEXT: rtgtest.lui [[REG]], [[IMM0]] : !rtg.isa.immediate<32>
  // CHECK-NEXT: rtgtest.lui [[REG]], [[IMM1]] : !rtg.isa.immediate<32>
  // CHECK-NEXT: rtgtest.lui [[REG]], [[IMM2]] : !rtg.isa.immediate<32>
  ...
  rtgtest.lui %1, %8#0 : !rtg.isa.immediate<32>
  rtgtest.lui %1, %8#1 : !rtg.isa.immediate<32>
  rtgtest.lui %1, %8#2 : !rtg.isa.immediate<32>
}
