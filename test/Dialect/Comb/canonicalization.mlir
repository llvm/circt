...
hw.module @notSext(in %a : i3, out negsext : i8) {
  // CHECK-NEXT: %c-1_i8 = hw.constant -1 : i8
  // CHECK-NEXT: %0 = comb.extract %a from 2 : (i3) -> i1
  // CHECK-NEXT: %1 = comb.replicate %0 : (i1) -> i5
  // CHECK-NEXT: %2 = comb.concat %1, %a : i5, i3
  // CHECK-NEXT: %3 = comb.xor %2, %c-1_i8 : i8
  // CHECK-NEXT: hw.output %3 : i8
  %c-1_i8 = hw.constant -1 : i8
  // sext(a)
