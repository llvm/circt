...
hw.module @opsInNestedRegionsAreAlsoCounted(input %arg0: i4, input %arg1: i4, output %out0: i4, out1: i4) {
...
hw.module @TopLevel(input %clk: !seq.clock, input %arg0: i32, input %arg1: i32, output %out0: i32, out1: i32, out2: i32, out3: i32) {
