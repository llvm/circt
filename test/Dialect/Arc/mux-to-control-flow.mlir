...
arc.define @test1(%arg0: i41, %arg1: i1, %arg2: i1, %arg3: i1, %arg4: i1, %arg5: i1, %arg6: i1, %arg7: i1, %arg8: i1, %arg9: i1, %arg10: i1, %arg11: i1, %arg12: i1, %arg13: i1, %arg14: i1) -> i1 {
  ...
  // CHECK: [[ELSE:%.+]] = comb.mux %arg8, %arg5
  %8 = comb.mux %arg8, %arg5, %7 : i1
  %9 = comb.and %4, %8 : i1
  %10 = comb.xor %2, %true : i1
  %11 = comb.and %10, %8 : i1
  %12 = comb.mux %arg9, %9, %11 : i1
  ...
  %19 = comb.mux %arg11, %17, %18 : i1
  %20 = comb.mux %arg12, %12, %19 : i1
  %21 = comb.mux %arg13, %20, %8 : i1
  %22 = comb.and %arg14, %21 : i1
  arc.output %22 : i1
  // CHECK: [[IF:%.+]] = scf.if %arg13 -> (i1) {
  // CHECK: [[THEN:%.+]] = comb.mux %arg12
