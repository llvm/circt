...
hw.module @memoryOps(%clk: i1, %en: i1, %mask: i32) {
  ...
  // CHECK-NEXT: arc.memory_write_port [[MEM]], @identity1(%c0_i32, %c0_i32, %en) clock %clk enable : <4 x i32>, i32, i32, i32, i1
  arc.memory_write_port %mem, @identity1(%c0_i32, %c0_i32, %en) clock %clk enable : <4 x i32>, i32, i32, i32, i1
  // CHECK-NEXT: arc.memory_write_port [[MEM]], @identity2(%c0_i32, %c0_i32, %en, %mask) clock %clk enable mask : <4 x i32>, i32, i32, i32, i1, i32
  arc.memory_write_port %mem, @identity2(%c0_i32, %c0_i32, %en, %mask) clock %clk enable mask : <4 x i32>, i32, i32, i32, i1, i32
  // CHECK-NEXT: arc.memory_write_port [[MEM]], @identity3(%c0_i32, %c0_i32, %mask) clock %clk mask : <4 x i32>, i32, i32, i32, i32
  arc.memory_write_port %mem, @identity3(%c0_i32, %c0_i32, %mask) clock %clk mask : <4 x i32>, i32, i32, i32, i32

  // CHECK-NEXT: %{{.+}} = arc.memory_read_port [[MEM]][%c0_i32] clock %clk : <4 x i32>, i32
  %1 = arc.memory_read_port %mem[%c0_i32] clock %clk : <4 x i32>, i32
  // CHECK-NEXT: arc.memory_write_port [[MEM]], @identity(%c0_i32, %c0_i32) clock %clk : <4 x i32>, i32, i32, i32
  arc.memory_write_port %mem, @identity(%c0_i32, %c0_i32) clock %clk : <4 x i32>, i32, i32, i32
  ...
  ^bb0(%arg0: i1):
    ...
    // CHECK-NEXT: arc.memory_write_port [[MEM2]], @identity1(%c1_i32, %c1_i32, %arg0) enable : <4 x i32>, i32, i32, i32, i1
    arc.memory_write_port %mem2, @identity1(%c1_i32, %c1_i32, %arg0) enable : <4 x i32>, i32, i32, i32, i1

    // CHECK-NEXT: %{{.+}} = arc.memory_read_port [[MEM2]][%c1_i32] : <4 x i32>, i32
    %3 = arc.memory_read_port %mem2[%c1_i32] : <4 x i32>, i32
    // CHECK-NEXT: arc.memory_write_port [[MEM2]], @identity(%c1_i32, %c1_i32) : <4 x i32>, i32, i32, i32
    arc.memory_write_port %mem2, @identity(%c1_i32, %c1_i32) : <4 x i32>, i32, i32, i32
  }
