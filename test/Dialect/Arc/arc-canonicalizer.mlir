...
hw.module @passthoughChecks(input %clock: !seq.clock, input %in0: i1, input %in1: i1, output %out0: i1, output %out1: i1, output %out2: i1, output %out3: i1, output %out4: i1, output %out5: i1, output %out6: i1, output %out7: i1, output %out8: i1, output %out9: i1) {
...
hw.module @memoryWritePortCanonicalizations(input %clk: !seq.clock, input %addr: i1, input %data: i32) {
...
hw.module @icmpEqCanonicalizer(input %arg0: i1, input %arg1: i1, input %arg2: i1, input %arg3: i1, input %arg4: i4, input %arg5: i4, input %arg6: i4, input %arg7: i4, output %out0: i1, output %out1: i1, output %out2: i1, output %out3: i1) {
...
hw.module @icmpNeCanonicalizer(input %arg0: i1, input %arg1: i1, input %arg2: i1, input %arg3: i1, input %arg4: i4, input %arg5: i4, input %arg6: i4, input %arg7: i4, output %out0: i1, output %out1: i1, output %out2: i1, output %out3: i1) {
...
// CHECK: @test1
hw.module @test1 (input %arg0: i1, input %arg1: i1, input %arg2: i1, input %clock: !seq.clock, output %out0: i1, output %out1: i1) {
...
hw.module @SinkSameConstants(input %x: i4, output %out0: i4, output %out1: i4, output %out2: i4) {
  // CHECK-NOT: hw.constant
...
hw.module @DontSinkDifferentConstants(input %x: i4, output %out0: i4, output %out1: i4) {
...
hw.module @DontSinkDifferentConstants1(input %x: i4, output %out0: i4, output %out1: i4, output %out2: i4) {
  // CHECK-NEXT: %c2_i4 = hw.constant 2 : i4
