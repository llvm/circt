...
hw.module @Simple(input %x: i4, input %y: i4, input %clock: !seq.clock) {
...
hw.module @Mismatch(input %x: i4, input %y: i4) {
...
hw.module @OutlineConst(input %x: i4, input %y: i4) {
...
hw.module @OutlineNonUniformConsts(input %x: i4) {
  // CHECK-DAG: %c3_i4 = hw.constant 3 : i4
  // CHECK-DAG: %c7_i4 = hw.constant 7 : i4
...
hw.module @SplitArguments(input %x: i4, input %y: i4) {
...
hw.module @WeirdSplitArguments(input %x: i4, input %y: i4) {
...
hw.module @VariadicDiffsDontDedup(input %x: i4, input %y: i4, input %z: i4) {
...
hw.module @DedupWithRegions(input %x: i4, input %y: i1) {
...
hw.module @DiffAttrsBlockDedup(input %x: i4) {
...
hw.module @DiffTypesBlockDedup(input %x: i4) {
...
hw.module @StateAndCall(input %x: i4, input %y: i4) {
...
hw.module @OutlineRegression(input %a: i1, input %b: i3) {
