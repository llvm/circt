// RUN: circt-opt %s --arc-insert-runtime | FileCheck %s --check-prefixes=CHECK,NOARGS
// RUN: circt-opt %s --arc-insert-runtime='extra-args="debug;bar"' | FileCheck %s --check-prefixes=CHECK,RTARGS


// CHECK-LABEL: arc.runtime.model @arcRuntimeModel_counter "counter" numStateBytes 4
