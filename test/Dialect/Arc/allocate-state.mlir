...
^bb0(%arg0: !arc.storage):
  ...
  arc.passthrough {
    ...
    arc.alloc %arg0 : (!arc.storage) -> !arc.memory<4 x i1, i1>
    arc.alloc %arg0 : (!arc.storage) -> !arc.memory<4 x i8, i1>
    arc.alloc %arg0 : (!arc.storage) -> !arc.memory<4 x i16, i1>
    arc.alloc %arg0 : (!arc.storage) -> !arc.memory<4 x i32, i1>
    arc.alloc %arg0 : (!arc.storage) -> !arc.memory<4 x i64, i1>
    arc.alloc %arg0 : (!arc.storage) -> !arc.memory<4 x i9001, i1>
