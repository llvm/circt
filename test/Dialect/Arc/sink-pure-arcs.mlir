...
hw.module @test(%clk: i1, %arg0: i4, %arg1: i4, %arg2: i4) -> (out0: i4, out1: i4) {
  %c = hw.constant 0 : i4
  %0 = arc.state @SimpleA(%arg0, %arg1) lat 0 : (i4, i4) -> i4
  %1 = arc.state @SimpleA(%arg0, %arg1) lat 0 : (i4, i4) -> i4
  %4 = arc.state @SimpleA(%0, %1) lat 0 : (i4, i4) -> i4
  %3 = arc.state @SimpleA(%4, %1) clock %clk lat 1 : (i4, i4) -> i4
  %2 = arc.state @SimpleB(%4, %1) clock %clk lat 1 : (i4, i4) -> i4
  hw.output %2, %3 : i4, i4
}
