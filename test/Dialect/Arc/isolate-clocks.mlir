...
hw.module @basics(input %clk0: !seq.clock, input %clk1: !seq.clock, input %clk2: !seq.clock, input %c0: i1, input %c1: i1, input %in: i32, output out0: i32, output out1: i32) {
...
hw.module @preexistingClockDomain(input %clk0: !seq.clock, input %clk1: !seq.clock, input %in: i32, output out0: i32, output out1: i32) {
