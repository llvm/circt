...
module {
  ...
  // CHECK-NEXT:   assign r18 = a < b;
  // CHECK-NEXT:   assign r19 = a <= b;
  // CHECK-NEXT:   assign r20 = a < b;
  // CHECK-NEXT:   assign r21 = a <= b;
