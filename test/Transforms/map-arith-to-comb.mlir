...
// CHECK-SAME:          input %[[VAL_0:.*]] : i32, input %[[VAL_1:.*]] : i32, input %[[VAL_2:.*]] : i1) {
...
hw.module @foo(input %arg0 : i32, input %arg1 : i32, input %arg2 : i1) {
...
hw.module @invalidVector(input %arg0 : vector<4xi32>) {
