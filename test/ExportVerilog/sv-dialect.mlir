...
// CHECK-LABEL: if_multi_line_expr
rtl.module @if_multi_line_expr(%clock: i1, %reset: i1, %really_long_port: i11) {
    ...
    // CHECK-NEXT:   wire [24:0] _tmp = {{..}}14{really_long_port[10]}}, really_long_port};
