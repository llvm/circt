...
rtl.module @Precedence(%a: i4, %b: i4, %c: i4) -> (%out1: i1, %out: i10) {
  ...
  // CHECK: assign _2Eout2Eoutput = {4'h0, _T_1 + _T_2};
  // CHECK: wire [4:0] _T_3 = {1'h0, a} + _T;   
  // CHECK: assign _2Eout2Eoutput = {4'h0, {1'h0, _T_3} - {2'h0, c}};
  // CHECK: assign _2Eout2Eoutput = {4'h0, _T_1 - _T_2};
  // CHECK: wire [7:0] _T_4 = {4'h0, b};
  // CHECK: wire [8:0] _T_5 = {5'h0, a};
  // CHECK: assign _2Eout2Eoutput = {1'h0, _T_5 + {1'h0, _T_4 * {4'h0, c}}};
  // CHECK: wire [8:0] _T_6 = {5'h0, c}; 
  // CHECK: assign _2Eout2Eoutput = {1'h0, {1'h0, {4'h0, a} * _T_4} + _T_6};
  // CHECK: assign _2Eout2Eoutput = {1'h0, {4'h0, _T_3} * _T_6};
  // CHECK: assign _2Eout2Eoutput = {1'h0, _T_5 * {4'h0, _T_0}};
  // CHECK: assign _2Eout2Eoutput = {5'h0, _T_3} * {5'h0, _T_0};
  // CHECK: assign _2Eout12Eoutput = ^_T_0;
  // CHECK: assign _2Eout12Eoutput = b < c | b > c;
  // CHECK: wire _T_7 = _2Eout12Eoutput; 
  // CHECK: assign _2Eout2Eoutput = {6'h0, (b ^ c) & {3'h0, _T_7}};
  // CHECK: wire [9:0] _T_8 = _2Eout2Eoutput;
  // CHECK: assign _2Eout2Eoutput = {2'h0, _T_8[9:2]};
  // CHECK: assign _2Eout12Eoutput = _T_8 < {6'h0, a};
