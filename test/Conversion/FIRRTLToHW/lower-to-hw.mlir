...
"sifive.enterprise.firrtl.ExtractAssertionsAnnotation", directory = "dir3",  filename = "./dir3/filename3" }]}
{
  ...
  // same clock.
  //
  // CHECK-NEXT:  hw.module.generated @aa_0_2_0_8
  ...
  //
  // CHECK:  hw.module.generated @ab_node_0_2_0_8_16_1_1_1_01_ab,
  // CHECK-SAME: @FIRRTLMem(%W0_addr: i4, %W0_en: i1, %W0_clk: i1, %W0_data: i8, %W0_mask: i1, %W1_addr: i4, %W1_en: i1, %W1_clk: i1, %W1_data: i8, %W1_mask: i1)
  // CHECK-SAME: attributes {depth = 16 : i64, maskGran = 8 : ui32, numReadPorts = 0 : ui32,
  // CHECK-SAME: numReadWritePorts = 0 : ui32, numWritePorts = 2 : ui32,
  // CHECK-SAME: readLatency = 1 : ui32, readUnderWrite = 0 : ui32,
  ...
  // CHECK-SAME: writeLatency = 1 : ui32, writeUnderWrite = 1 : i32}
  //
  // CHECK-NEXT:  hw.module.generated @mem0_1_0_0_32_1_0_1_0_11,
  ...
  // CHECK-SAME: writeLatency = 1 : ui32, writeUnderWrite = 1 : i32}
  // CHECK-NEXT:  hw.module.generated @_M_1_0_0_42_12_0_1_0_01,
  ...
  // CHECK-SAME: writeLatency = 1 : ui32, writeUnderWrite = 1 : i32}
  // CHECK: hw.module.generated @_M_mask_1_1_1_40_1022_1_1_4_01_a,
  ...
  // CHECK-NEXT:  hw.module.generated @_M_1_1_1_42_12_0_1_1_01_a,
...
//    stop(clock2, reset, 0)
 ...
 //   count <= mux(reset, UInt<2>("h0"), _GEN_0)
  ...
  // CHECK: %_M.R0_data, %_M.RW0_rdata = hw.instance "_M" @_M_1_1_1_42_12_0_1_1_01_a(R0_addr: %c0_i4: i4, R0_en: %true: i1, R0_clk: %clock1: i1, RW0_addr: %c0_i4_0: i4, RW0_en: %true: i1, RW0_clk: %clock1: i1, RW0_wmode: %true: i1, RW0_wdata: %0: i42, RW0_wmask: %true: i1, W0_addr: %c0_i4_1: i4, W0_en: %inpred: i1, W0_clk: %clock2: i1, W0_data: %indata: i42, W0_mask: %true: i1) -> (R0_data: i42, RW0_rdata: i42)
  ...
  firrtl.module @MemSimple_mask(in %clock1: !firrtl.clock, in %clock2: !firrtl.clock,
    ...
    // CHECK: %_M_mask.R0_data, %_M_mask.RW0_rdata = hw.instance "_M_mask" @_M_mask_1_1_1_40_1022_1_1_4_01_a(R0_addr: %c0_i10: i10, R0_en: %true: i1, R0_clk: %clock1: i1, RW0_addr: %c0_i10: i10, RW0_en: %true: i1, RW0_clk: %clock1: i1, RW0_wmode: %true: i1, RW0_wdata: %0: i40, RW0_wmask: %c0_i4: i4, W0_addr: %c0_i10: i10, W0_en: %inpred: i1, W0_clk: %clock2: i1, W0_data: %indata: i40, W0_mask: %c0_i4: i4) -> (R0_data: i40, RW0_rdata: i40)
  ...
  firrtl.module @IncompleteRead(in %clock1: !firrtl.clock) {
    ...
    // CHECK:  %_M.R0_data = hw.instance "_M" @_M_1_0_0_42_12_0_1_0_01(R0_addr: %c0_i4: i4, R0_en: %true: i1, R0_clk: %clock1: i1) -> (R0_data: i42)
  ...
  firrtl.module @MemDepth1(in %clock: !firrtl.clock, in %en: !firrtl.uint<1>,
    ...
    // CHECK: %mem0.R0_data = hw.instance "mem0" @mem0_1_0_0_32_1_0_1_0_11(R0_addr: %addr: i1, R0_en: %en: i1, R0_clk: %clock: i1) -> (R0_data: i32)
  ...
  firrtl.module @MemoryWritePortBehavior(in %clock1: !firrtl.clock, in %clock2: !firrtl.clock) {
    ...
    //
    // CHECK: hw.instance "aa" @aa_0_2_0_8
    ...
    //
    // CHECK: hw.instance "ab" @ab_0_2_0_8_16_1_1_1_01_ab
    ...
    // "aa" memory.
    //
    // CHECK: hw.instance "ab_node" @ab_node_0_2_0_8_16_1_1_1_01_ab
