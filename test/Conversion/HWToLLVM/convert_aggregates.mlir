...
// CHECK: %[[AARG1:.*]] = builtin.unrealized_conversion_cast %arg1 : !hw.array<2xi32> to !llvm.array<2 x i32>
...
// CHECK: %[[AARG2:.*]] = builtin.unrealized_conversion_cast %arg2 : !hw.struct<foo: i32, bar: i32> to !llvm.struct<(i32, i32)>
...
// CHECK: llvm.store %[[AARG2]], %[[A3]] : !llvm.ptr<struct<(i32, i32)>>
...
func.func @convertArray(%arg0 : i1, %arg1: !hw.array<2xi32>) {
  ...
  // CHECK: %[[BARG1:.*]] = builtin.unrealized_conversion_cast %arg1 : !hw.array<2xi32> to !llvm.array<2 x i32>
  // CHECK-NEXT: llvm.store %[[BARG1]], %[[ALLOCA]] : !llvm.ptr<array<2 x i32>>
