...
// CHECK:   hw.module @handshake_sync_in_ui32_out_ui32(input %[[VAL_0:.*]] : !esi.channel<i0>, input %[[VAL_1:.*]] : !esi.channel<i32>, input %[[CLOCK:.*]] : !seq.clock, input %[[VAL_3:.*]] : i1, output %out0 : !esi.channel<i0>, output %out1 : !esi.channel<i32>) {
