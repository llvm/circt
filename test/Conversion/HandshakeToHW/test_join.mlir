...
// CHECK:   hw.module @handshake_join_2ins_1outs_ctrl(input %[[VAL_0:.*]] : !esi.channel<i0>, input %[[VAL_1:.*]] : !esi.channel<i0>, output out0 : !esi.channel<i0>) {
...
// CHECK:   hw.module @handshake_join_in_ui32_ui1_3ins_1outs_ctrl(input %[[VAL_0:.*]] : !esi.channel<i32>, input %[[VAL_1:.*]] : !esi.channel<i1>, input %[[VAL_2:.*]] : !esi.channel<i0>, output out0 : !esi.channel<i0>) {
