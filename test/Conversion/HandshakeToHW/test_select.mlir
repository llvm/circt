...
// CHECK:   hw.module @arith_select_in_ui1_ui32_ui32_out_ui32(input %[[VAL_0:.*]] : !esi.channel<i1>, input %[[VAL_1:.*]] : !esi.channel<i32>, input %[[VAL_2:.*]] : !esi.channel<i32>, output out0 : !esi.channel<i32>) {
