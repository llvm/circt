...
// CHECK:   hw.module @handshake_cond_br_in_ui1_ui64_out_ui64_ui64(input %[[VAL_0:.*]] : !esi.channel<i1>, input %[[VAL_1:.*]] : !esi.channel<i64>, output %outTrue : !esi.channel<i64>, output %outFalse : !esi.channel<i64>) {
...
// CHECK:   hw.module @handshake_cond_br_in_ui1_2ins_2outs_ctrl(input %[[VAL_0:.*]] : !esi.channel<i1>, input %[[VAL_1:.*]] : !esi.channel<i0>, output %outTrue : !esi.channel<i0>, output %outFalse : !esi.channel<i0>) {
// CHECK:           %[[VAL_2:.*]], %[[VAL_3:.*]] = esi.unwrap.vr %[[VAL_0]], %[[VAL_4:.*]] : i1
