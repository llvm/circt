...
// CHECK:   hw.module @handshake_constant_c42_out_ui64(input %[[VAL_0:.*]] : !esi.channel<i0>, output %out0 : !esi.channel<i64>) {
...
// CHECK:   hw.module @handshake_constant_c42_out_ui32(input %[[VAL_0:.*]] : !esi.channel<i0>, output %out0 : !esi.channel<i32>) {
// CHECK:           %[[VAL_1:.*]], %[[VAL_2:.*]] = esi.unwrap.vr %[[VAL_0]], %[[VAL_3:.*]] : i0
