...
// CHECK-SAME:      input %[[VAL_1:.*]] : !esi.channel<i32>,
// CHECK-SAME:      output out0 : !esi.channel<!hw.struct<field0: i64, field1: i32>>) {
...
// CHECK-SAME:       input %[[VAL_0:.*]] : !esi.channel<!hw.struct<field0: i64, field1: i32>>,
// CHECK-SAME:       input %[[CLOCK:.*]] : !seq.clock,
// CHECK-SAME:       input %[[VAL_2:.*]] : i1,
// CHECK-SAME:      output out0 : !esi.channel<i64>, 
// CHECK-SAME:      output out1 : !esi.channel<i32>) {
