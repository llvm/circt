...
// CHECK:   hw.module @handshake_mux_in_ui64_ui64_ui64_out_ui64(input %[[VAL_0:.*]] : !esi.channel<i64>, input %[[VAL_1:.*]] : !esi.channel<i64>, input %[[VAL_2:.*]] : !esi.channel<i64>, output out0 : !esi.channel<i64>) {
...
// CHECK:   hw.module @handshake_mux_in_ui64_ui64_ui64_ui64_out_ui64(input %[[VAL_0:.*]] : !esi.channel<i64>, input %[[VAL_1:.*]] : !esi.channel<i64>, input %[[VAL_2:.*]] : !esi.channel<i64>, input %[[VAL_3:.*]] : !esi.channel<i64>, output out0 : !esi.channel<i64>) {
