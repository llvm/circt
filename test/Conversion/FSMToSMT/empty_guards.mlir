...
// CHECK-NEXT:      [[F_S2:%.+]] = smt.declare_fun "F_s2" : !smt.func<(!smt.bv<1>) !smt.bool>
...
// CHECK-NEXT:        [[APP2:%.+]] = smt.apply_func [[F_S2]]([[CAST1]]) : !smt.func<(!smt.bv<1>) !smt.bool>
...
// CHECK-NEXT:        [[SFALSE1:%.+]] = smt.constant false
// CHECK-NEXT:        [[AND1:%.+]] = smt.and [[EQ1]], [[SFALSE1]]
// CHECK-NEXT:        [[AND1_0:%.+]] = smt.and [[APP1]], [[AND1]]
// CHECK-NEXT:        [[IMP1:%.+]] = smt.implies [[AND1_0]], [[APP2]]
...
// CHECK-NEXT:        [[APP4:%.+]] = smt.apply_func [[F_S1]]([[CAST4]]) : !smt.func<(!smt.bv<1>) !smt.bool>
