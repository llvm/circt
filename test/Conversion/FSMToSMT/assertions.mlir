...
// CHECK-NEXT:       %10 = smt.apply_func %F_S0(%9, %c0_bv32) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
...
// CHECK-NEXT:       %7 = smt.apply_func %F_S0(%arg2, %arg3) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
...
// CHECK-NEXT:       %13 = smt.apply_func %F_S1(%12, %arg3) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
// CHECK-NEXT:       %14 = builtin.unrealized_conversion_cast %arg0 : !smt.bv<8> to i8
// CHECK-NEXT:       %15 = builtin.unrealized_conversion_cast %arg3 : !smt.bv<32> to i32
// CHECK-NEXT:       %16 = comb.icmp ult %14, %c50_i8 : i8
// CHECK-NEXT:       %17 = comb.icmp ugt %14, %c0_i8 : i8
// CHECK-NEXT:       %18 = builtin.unrealized_conversion_cast %17 : i1 to !smt.bv<1>
// CHECK-NEXT:       %19 = builtin.unrealized_conversion_cast %18 : !smt.bv<1> to !smt.bv<1>
// CHECK-NEXT:       %c-1_bv1 = smt.bv.constant #smt.bv<-1> : !smt.bv<1>
// CHECK-NEXT:       %20 = smt.eq %19, %c-1_bv1 : !smt.bv<1>
// CHECK-NEXT:       %21 = smt.and %7, %20
// CHECK-NEXT:       %22 = smt.implies %21, %13
// CHECK-NEXT:       smt.yield %22 : !smt.bool
// CHECK-NEXT:     }
// CHECK-NEXT:     smt.assert %1
// CHECK-NEXT:     %2 = smt.forall {
// CHECK-NEXT:     ^bb0(%arg0: !smt.bv<8>, %arg1: !smt.bv<8>, %arg2: !smt.bv<8>, %arg3: !smt.bv<32>):
// CHECK-NEXT:       %7 = smt.apply_func %F_S1(%arg2, %arg3) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
// CHECK-NEXT:       %8 = builtin.unrealized_conversion_cast %arg0 : !smt.bv<8> to i8
// CHECK-NEXT:       %9 = builtin.unrealized_conversion_cast %arg3 : !smt.bv<32> to i32
...
// CHECK-NEXT:       %16 = smt.apply_func %F_S0(%15, %12) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
// CHECK-NEXT:       %17 = smt.implies %7, %16
// CHECK-NEXT:       smt.yield %17 : !smt.bool
// CHECK-NEXT:     }
...
// CHECK-NEXT:       %12 = smt.apply_func %F_S0(%arg1, %arg2) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
...
// CHECK-NEXT:       %13 = smt.apply_func %F_S0(%arg1, %arg2) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
...
// CHECK-NEXT:       %14 = smt.apply_func %F_S0(%arg1, %arg2) : !smt.func<(!smt.bv<8>, !smt.bv<32>) !smt.bool>
