...
// TIME:     ^bb0([[ARG0_1:%.+]]: !smt.bv<8>, [[ARG1_1:%.+]]: !smt.bv<8>):
...
// TIME:       [[FUN2:%.+]] = smt.apply_func [[F_B]]([[CAST1]], [[ADD0]]) : !smt.func<(!smt.bv<8>, !smt.bv<8>) !smt.
// TIME: bool>
...
// TIME:     ^bb0([[ARG0_2:%.+]]: !smt.bv<8>, [[ARG1_2:%.+]]: !smt.bv<8>):
// TIME:       [[FUN3:%.+]] = smt.apply_func [[F_B]]([[ARG0_2]], [[ARG1_2]]) : !smt.func<(!smt.bv<8>, !smt.bv<8>) !smt.bool>
