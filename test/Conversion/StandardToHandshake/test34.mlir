...
// CHECK:           %[[VAL_44:.*]] = join %[[VAL_43]]#1, %[[VAL_6]]#1, %[[VAL_7]]#1, %[[VAL_1]]#4 : none
// CHECK:           sink %[[VAL_41]] : index
// CHECK:           %[[VAL_45:.*]] = constant %[[VAL_43]]#0 {value = 1 : index} : index
// CHECK:           %[[VAL_46:.*]]:2 = fork [2] %[[VAL_45]] : index
// CHECK:           %[[VAL_47:.*]] = arith.addi %[[VAL_38]], %[[VAL_46]]#0 : index
// CHECK:           %[[VAL_48:.*]]:3 = fork [3] %[[VAL_47]] : index
// CHECK:           %[[VAL_49:.*]], %[[VAL_4]] = load {{\[}}%[[VAL_48]]#2] %[[VAL_1]]#0, %[[VAL_42]]#2 : index, f32
// CHECK:           %[[VAL_50:.*]]:2 = fork [2] %[[VAL_49]] : f32
// CHECK:           %[[VAL_51:.*]] = arith.addf %[[VAL_50]]#0, %[[VAL_50]]#1 : f32
// CHECK:           %[[VAL_52:.*]] = join %[[VAL_42]]#1, %[[VAL_6]]#0 : none
// CHECK:           %[[VAL_2]], %[[VAL_3]] = store {{\[}}%[[VAL_48]]#1] %[[VAL_51]], %[[VAL_52]] : index, f32
