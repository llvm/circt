...
// CHECK:           %[[VAL_38:.*]], %[[VAL_39:.*]] = cond_br %[[VAL_35]]#1, %[[VAL_10]]#7 : none
// CHECK:           %[[VAL_40:.*]], %[[VAL_41:.*]] = control_merge %[[VAL_38]] : none
// CHECK:           sink %[[VAL_41]] : index
// CHECK:           %[[VAL_42:.*]] = br %[[VAL_40]] : none
// CHECK:           %[[VAL_43:.*]], %[[VAL_44:.*]] = control_merge %[[VAL_39]] : none
// CHECK:           sink %[[VAL_44]] : index
// CHECK:           %[[VAL_45:.*]] = br %[[VAL_43]] : none
// CHECK:           %[[VAL_46:.*]] = mux %[[VAL_37]]#1 {{\[}}%[[VAL_45]], %[[VAL_42]]] : i1, none
// CHECK:           %[[VAL_47:.*]] = arith.index_cast %[[VAL_37]]#0 : i1 to index
