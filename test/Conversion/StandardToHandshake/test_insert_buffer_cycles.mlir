...
// CHECK:           %[[VAL_4:.*]] = buffer [2] %[[VAL_3]] {FIFO} : index
// CHECK:           %[[VAL_5:.*]] = buffer [2] %[[VAL_2]] {FIFO} : none
...
// CHECK:           %[[VAL_15:.*]] = buffer [2] %[[VAL_12]] {sequential} : index
// CHECK:           %[[VAL_16:.*]]:2 = fork [2] %[[VAL_15]] : index
// CHECK:           %[[VAL_17:.*]], %[[VAL_18:.*]] = control_merge %[[VAL_19:.*]], %[[VAL_9]] : none
// CHECK:           %[[VAL_20:.*]] = buffer [2] %[[VAL_18]] {sequential} : index
// CHECK:           %[[VAL_21:.*]] = buffer [2] %[[VAL_17]] {sequential} : none
// CHECK:           %[[VAL_13]]:2 = fork [2] %[[VAL_20]] : index
// CHECK:           %[[VAL_22:.*]] = mux %[[VAL_16]]#0 {{\[}}%[[VAL_23:.*]], %[[VAL_10]]] : index, index
// CHECK:           %[[VAL_24:.*]] = buffer [2] %[[VAL_22]] {sequential} : index
...
// CHECK:           %[[VAL_35:.*]] = buffer [2] %[[VAL_34]] {FIFO} : index
// CHECK:           %[[VAL_36:.*]] = merge %[[VAL_28]] : index
// CHECK:           %[[VAL_37:.*]] = buffer [2] %[[VAL_36]] {FIFO} : index
// CHECK:           %[[VAL_38:.*]], %[[VAL_39:.*]] = control_merge %[[VAL_30]] : none
// CHECK:           %[[VAL_40:.*]] = buffer [2] %[[VAL_39]] {FIFO} : index
// CHECK:           %[[VAL_41:.*]] = buffer [2] %[[VAL_38]] {FIFO} : none
...
// CHECK:           %[[VAL_47:.*]] = buffer [2] %[[VAL_46]] {FIFO} : index
// CHECK:           %[[VAL_48:.*]] = buffer [2] %[[VAL_45]] {FIFO} : none
