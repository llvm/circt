...
// CHECK:   %0 = firrtl.subfield %[[ARG0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<1>>
// CHECK:   %1 = firrtl.subfield %[[ARG0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<1>>
// CHECK:   %2 = firrtl.subfield %[[ARG0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<1>>
// CHECK:   %3 = firrtl.subfield %[[ARG1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %4 = firrtl.subfield %[[ARG1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %5 = firrtl.subfield %[[ARG1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %6 = firrtl.subfield %[[ARG2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %7 = firrtl.subfield %[[ARG2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %8 = firrtl.subfield %[[ARG2]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %9 = firrtl.subfield %[[ARG3]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %10 = firrtl.subfield %[[ARG3]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %11 = firrtl.subfield %[[ARG3]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
