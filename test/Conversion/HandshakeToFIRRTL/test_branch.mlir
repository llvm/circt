...
handshake.func @test_branch(%arg0: index, %arg1: none, ...) -> (index, none) {
  ...
  // CHECK: %0 = firrtl.instance @handshake_branch_1ins_1outs {name = ""} : !firrtl.bundle<arg0: bundle<valid: flip<uint<1>>, ready: uint<1>, data: flip<uint<64>>>, arg1: bundle<valid: uint<1>, ready: flip<uint<1>>, data: uint<64>>>
