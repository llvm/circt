...
// CHECK:   %[[IN_VALID:.+]] = firrtl.subfield %[[arg0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[IN_READY:.+]] = firrtl.subfield %[[arg0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[OUT_VALID:.+]] = firrtl.subfield %[[arg1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[OUT_READY:.+]] = firrtl.subfield %[[arg1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
...
// CHECK:   %[[IN_DATA:.+]] = firrtl.subfield %[[arg0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[OUT_DATA:.+]] = firrtl.subfield %[[arg1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
