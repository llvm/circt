...
// CHECK:             firrtl.strictconnect %[[VAL_20]], %[[VAL_12]] : !firrtl.uint<32>
// CHECK:             firrtl.strictconnect %[[VAL_23]], %[[VAL_15]] : !firrtl.uint<512>
...
// CHECK:             firrtl.strictconnect %[[VAL_24]], %[[VAL_27]] : !firrtl.uint<1>
// CHECK:             %[[VAL_28:.*]] = firrtl.and %[[VAL_25]], %[[VAL_27]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_9]], %[[VAL_28]] : !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_11]], %[[VAL_28]] : !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_14]], %[[VAL_28]] : !firrtl.uint<1>
...
// CHECK:             firrtl.strictconnect %[[VAL_33]], %[[VAL_35]] : !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_25]], %[[VAL_33]] : !firrtl.uint<1>
...
// CHECK:             firrtl.strictconnect %[[VAL_40]], %[[VAL_41]] : !firrtl.uint<1>
// CHECK:             %[[VAL_42:.*]] = firrtl.and %[[VAL_40]], %[[VAL_24]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_16]], %[[VAL_42]] : !firrtl.uint<1>
...
// CHECK:             firrtl.strictconnect %[[VAL_48]], %[[VAL_49]] : !firrtl.uint<1>
// CHECK:             %[[VAL_50:.*]] = firrtl.and %[[VAL_48]], %[[VAL_24]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_18]], %[[VAL_50]] : !firrtl.uint<1>
...
// CHECK:             firrtl.strictconnect %[[VAL_70]], %[[VAL_62]] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             firrtl.strictconnect %[[VAL_71]], %[[VAL_63]] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.strictconnect %[[VAL_72]], %[[VAL_64]] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<512>>
// CHECK:             firrtl.strictconnect %[[VAL_76]], %[[VAL_68]] : !firrtl.clock, !firrtl.clock
// CHECK:             firrtl.strictconnect %[[VAL_77]], %[[VAL_69]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_65]], %[[VAL_73]] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             firrtl.strictconnect %[[VAL_66]], %[[VAL_74]] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.strictconnect %[[VAL_67]], %[[VAL_75]] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<512>>
// CHECK:           }
// CHECK:         }
