...
// CHECK:             %[[VAL_5:.*]] = firrtl.subfield %[[VAL_0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_6:.*]] = firrtl.subfield %[[VAL_0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_7:.*]] = firrtl.subfield %[[VAL_0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_8:.*]] = firrtl.subfield %[[VAL_1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_9:.*]] = firrtl.subfield %[[VAL_1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_10:.*]] = firrtl.subfield %[[VAL_1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_11:.*]] = firrtl.subfield %[[VAL_2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             %[[VAL_12:.*]] = firrtl.subfield %[[VAL_2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             %[[VAL_13:.*]] = firrtl.subfield %[[VAL_3]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_14:.*]] = firrtl.subfield %[[VAL_3]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_15:.*]] = firrtl.subfield %[[VAL_3]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_16:.*]] = firrtl.subfield %[[VAL_4]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_17:.*]] = firrtl.subfield %[[VAL_4]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_18:.*]] = firrtl.subfield %[[VAL_4]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
