...
handshake.func @test_join(%arg0: none, %arg1: none, %arg2: none, ...) -> (none, none) {
  ...
  // CHECK: %0 = firrtl.instance @handshake_join_2ins_1outs_ctrl {name = ""} : !firrtl.bundle<arg0: bundle<valid: flip<uint<1>>, ready: uint<1>>, arg1: bundle<valid: flip<uint<1>>, ready: uint<1>>, arg2: bundle<valid: uint<1>, ready: flip<uint<1>>>>
