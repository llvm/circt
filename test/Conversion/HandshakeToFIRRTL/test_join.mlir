...
handshake.func @test_join(%arg0: none, %arg1: none, %arg2: none, ...) -> (none, none) {
  ...
  // CHECK: %inst_arg0, %inst_arg1, %inst_arg2 = firrtl.instance @handshake_join_2ins_1outs_ctrl {name = "", portNames = ["arg0", "arg1", "arg2"]} : !firrtl.bundle<valid: flip<uint<1>>, ready: uint<1>>, !firrtl.bundle<valid: flip<uint<1>>, ready: uint<1>>, !firrtl.bundle<valid: uint<1>, ready: flip<uint<1>>>
