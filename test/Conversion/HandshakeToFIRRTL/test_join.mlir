...
handshake.func @test_join(%arg0: none, %arg1: none, %arg2: none, ...) -> (none, none) {
  ...
  // CHECK: %handshake_join_arg0, %handshake_join_arg1, %handshake_join_arg2 = firrtl.instance handshake_join @handshake_join_2ins_1outs_ctrl(in arg0: !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>, in arg1: !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>, out arg2: !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>)
