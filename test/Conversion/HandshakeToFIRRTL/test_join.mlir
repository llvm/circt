...
// CHECK:             firrtl.strictconnect %[[VAL_7]], %[[VAL_9]] : !firrtl.uint<1>
// CHECK:             %[[VAL_10:.*]] = firrtl.and %[[VAL_8]], %[[VAL_9]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_4]], %[[VAL_10]] : !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_6]], %[[VAL_10]] : !firrtl.uint<1>
// CHECK:           }
...
// CHECK:             firrtl.strictconnect %[[VAL_12]], %[[VAL_15]] : !firrtl.uint<1>
// CHECK:             %[[VAL_16:.*]] = firrtl.and %[[VAL_13]], %[[VAL_15]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_5]], %[[VAL_16]] : !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_8]], %[[VAL_16]] : !firrtl.uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_11]], %[[VAL_16]] : !firrtl.uint<1>
// CHECK:           }
