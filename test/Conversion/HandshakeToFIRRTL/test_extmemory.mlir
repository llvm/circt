...
// CHECK:             %[[VAL_13:.*]] = firrtl.subfield %[[VAL_1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_14:.*]] = firrtl.subfield %[[VAL_1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_15:.*]] = firrtl.subfield %[[VAL_1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_16:.*]] = firrtl.subfield %[[VAL_2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_17:.*]] = firrtl.subfield %[[VAL_2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_18:.*]] = firrtl.subfield %[[VAL_2]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_19:.*]] = firrtl.subfield %[[VAL_3]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_20:.*]] = firrtl.subfield %[[VAL_3]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_21:.*]] = firrtl.subfield %[[VAL_3]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             %[[VAL_22:.*]] = firrtl.subfield %[[VAL_4]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_23:.*]] = firrtl.subfield %[[VAL_4]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_24:.*]] = firrtl.subfield %[[VAL_4]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_25:.*]] = firrtl.subfield %[[VAL_5]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             %[[VAL_26:.*]] = firrtl.subfield %[[VAL_5]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             %[[VAL_27:.*]] = firrtl.subfield %[[VAL_6]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             %[[VAL_28:.*]] = firrtl.subfield %[[VAL_6]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             %[[VAL_29:.*]] = firrtl.subfield %[[VAL_7]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.connect %[[VAL_29]], %[[VAL_13]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_30:.*]] = firrtl.subfield %[[VAL_7]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.connect %[[VAL_14]], %[[VAL_30]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_31:.*]] = firrtl.subfield %[[VAL_7]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.connect %[[VAL_31]], %[[VAL_15]] : !firrtl.uint<32>, !firrtl.uint<32>
// CHECK:             %[[VAL_32:.*]] = firrtl.subfield %[[VAL_8]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             firrtl.connect %[[VAL_32]], %[[VAL_16]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_33:.*]] = firrtl.subfield %[[VAL_8]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             firrtl.connect %[[VAL_17]], %[[VAL_33]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_34:.*]] = firrtl.subfield %[[VAL_8]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             firrtl.connect %[[VAL_34]], %[[VAL_18]] : !firrtl.uint<64>, !firrtl.uint<64>
// CHECK:             %[[VAL_35:.*]] = firrtl.subfield %[[VAL_9]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             firrtl.connect %[[VAL_35]], %[[VAL_19]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_36:.*]] = firrtl.subfield %[[VAL_9]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             firrtl.connect %[[VAL_20]], %[[VAL_36]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_37:.*]] = firrtl.subfield %[[VAL_9]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:             firrtl.connect %[[VAL_37]], %[[VAL_21]] : !firrtl.uint<64>, !firrtl.uint<64>
// CHECK:             %[[VAL_38:.*]] = firrtl.subfield %[[VAL_10]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.connect %[[VAL_22]], %[[VAL_38]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_39:.*]] = firrtl.subfield %[[VAL_10]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.connect %[[VAL_39]], %[[VAL_23]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_40:.*]] = firrtl.subfield %[[VAL_10]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             firrtl.connect %[[VAL_24]], %[[VAL_40]] : !firrtl.uint<32>, !firrtl.uint<32>
// CHECK:             %[[VAL_41:.*]] = firrtl.subfield %[[VAL_11]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             firrtl.connect %[[VAL_25]], %[[VAL_41]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_42:.*]] = firrtl.subfield %[[VAL_11]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             firrtl.connect %[[VAL_42]], %[[VAL_26]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_43:.*]] = firrtl.subfield %[[VAL_12]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:             firrtl.connect %[[VAL_27]], %[[VAL_43]] : !firrtl.uint<1>, !firrtl.uint<1>
// CHECK:             %[[VAL_44:.*]] = firrtl.subfield %[[VAL_12]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
