...
// CHECK:   %[[ARG0_VALID:.+]] = firrtl.subfield %[[VAL_0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG0_READY:.+]] = firrtl.subfield %[[VAL_0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG0_DATA:.+]] = firrtl.subfield %[[VAL_0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG1_VALID:.+]] = firrtl.subfield %[[VAL_1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG1_READY:.+]] = firrtl.subfield %[[VAL_1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG1_DATA:.+]] = firrtl.subfield %[[VAL_1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG2_VALID:.+]] = firrtl.subfield %[[VAL_2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[ARG2_READY:.+]] = firrtl.subfield %[[VAL_2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
