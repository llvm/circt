...
// CHECK:             %[[VAL_2:.*]] = firrtl.subfield %[[VAL_0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_3:.*]] = firrtl.subfield %[[VAL_0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_4:.*]] = firrtl.subfield %[[VAL_0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:             %[[VAL_5:.*]] = firrtl.subfield %[[VAL_1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_6:.*]] = firrtl.subfield %[[VAL_1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK:             %[[VAL_7:.*]] = firrtl.subfield %[[VAL_1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
