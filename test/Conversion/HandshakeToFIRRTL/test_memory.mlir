...
// CHECK: firrtl.strictconnect %[[MEM_LOAD_CLK]], %clock
...
// CHECK-DAG: firrtl.strictconnect %[[LD_ADDR_READY]]
// CHECK-DAG: firrtl.strictconnect %[[LD_DATA_VALID]]
// CHECK-DAG: firrtl.{{.+}} %[[LD_DATA_READY]]
// CHECK-DAG: firrtl.strictconnect %[[LD_CONTROL_VALID]]
// CHECK-DAG: firrtl.{{.+}} %[[LD_CONTROL_READY]]

// Connect the store clock.
// CHECK: %[[MEM_STORE_CLK:.+]] = firrtl.subfield %[[MEM_STORE]][clk]
// CHECK: firrtl.strictconnect %[[MEM_STORE_CLK]], %clock
...
// CHECK: firrtl.strictconnect %[[MEM_STORE_ADDR]], %[[ST_ADDR_DATA_TAIL]]

// Connect the store data.
// CHECK: %[[MEM_STORE_DATA:.+]] = firrtl.subfield %[[MEM_STORE]][data]
// CHECK: firrtl.strictconnect %[[MEM_STORE_DATA]], %[[ST_DATA_DATA]]
...
// CHECK: firrtl.strictconnect %[[ST_CONTROL_VALID]], %[[WRITE_VALID_BUFFER]]
...
// CHECK: firrtl.strictconnect %[[STORE_COMPLETED]], %[[STORE_COMPLETED_GATE]]
