...
// CHECK-NEXT:   %0 = firrtl.subfield %[[ARG0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %1 = firrtl.subfield %[[ARG0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %2 = firrtl.subfield %[[ARG0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %3 = firrtl.subfield %[[ARG1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK-NEXT:   %4 = firrtl.subfield %[[ARG1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK-NEXT:   %5 = firrtl.subfield %[[ARG1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
...
// CHECK-NEXT:   %0 = firrtl.subfield %[[ARG0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK-NEXT:   %1 = firrtl.subfield %[[ARG0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK-NEXT:   %2 = firrtl.subfield %[[ARG0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<8>>
// CHECK-NEXT:   %3 = firrtl.subfield %[[ARG1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %4 = firrtl.subfield %[[ARG1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %5 = firrtl.subfield %[[ARG1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
...
// CHECK-NEXT:   %0 = firrtl.subfield %[[ARG0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<9>>
// CHECK-NEXT:   %1 = firrtl.subfield %[[ARG0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<9>>
// CHECK-NEXT:   %2 = firrtl.subfield %[[ARG0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<9>>
// CHECK-NEXT:   %3 = firrtl.subfield %[[ARG1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %4 = firrtl.subfield %[[ARG1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK-NEXT:   %5 = firrtl.subfield %[[ARG1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
