...
// CHECK:   firrtl.strictconnect %win, %[[ARB_RESULT]]
...
// CHECK:   %[[CONNECT_VALID1_EXT:.*]] = firrtl.pad %[[CONNECT_VALID1]], 64 : (!firrtl.uint<1>) -> !firrtl.uint<64> 
// CHECK:   firrtl.strictconnect %[[ARG3_DATA]], %[[CONNECT_VALID1_EXT]]

// Logic to assign won register.
// CHECK:   %[[WON_RESULT:.+]] = firrtl.mux(%fired, %[[NO_WINNER]], %win)
// CHECK:   firrtl.strictconnect %[[WON]], %[[WON_RESULT]]
...
// CHECK:   firrtl.strictconnect %[[ARG2_DATA]], %[[RESULT_DATA1]]
