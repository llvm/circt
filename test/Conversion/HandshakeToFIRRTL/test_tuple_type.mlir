...
// CHECK:    firrtl.strictconnect %[[VAL_2]], %[[VAL_0]] : firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>, !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>
// CHECK:    firrtl.strictconnect %[[VAL_3]], %[[VAL_1]] : firrtl.bundle<valid: uint<1>, ready flip: uint<1>>, !firrtl.bundle<valid: uint<1>
// CHECK:  }
// CHECK:}
