...
// CHECK:    firrtl.strictconnect %[[VAL_9]], %[[IN0_DATA]] : !firrtl.uint<64>
// CHECK:    firrtl.strictconnect %[[VAL_10]], %[[IN1_DATA]] : !firrtl.uint<32>
// CHECK:    %[[VAL_11:.*]] = firrtl.and %[[IN1_VALID]], %[[IN0_VALID]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:    firrtl.strictconnect %[[OUT_VALID]], %[[VAL_11]] : !firrtl.uint<1>
// CHECK:    %[[VAL_12:.*]] = firrtl.and %[[OUT_READY]], %[[VAL_11]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:    firrtl.strictconnect %[[IN0_READY]], %[[VAL_12]] : !firrtl.uint<1>
// CHECK:    firrtl.strictconnect %[[IN1_READY]], %[[VAL_12]] : !firrtl.uint<1>
// CHECK:  }
...
// CHECK:  firrtl.strictconnect %[[OUT0_DATA]], %[[VAL_9]] : !firrtl.uint<64>
// CHECK:  firrtl.strictconnect %[[OUT1_DATA]], %[[VAL_10]] : !firrtl.uint<32>
...
// CHECK:  firrtl.strictconnect %[[VAL_14]], %[[VAL_15]] : !firrtl.uint<1>
// CHECK:  firrtl.strictconnect %[[IN_READY]], %[[VAL_14]] : !firrtl.uint<1>
...
// CHECK:  firrtl.strictconnect %[[VAL_20]], %[[VAL_21]] : !firrtl.uint<1>
// CHECK:  %[[VAL_22:.*]] = firrtl.and %[[VAL_20]], %[[IN_VALID]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:  firrtl.strictconnect %[[OUT0_VALID]], %[[VAL_22]] : !firrtl.uint<1>
...
// CHECK:  firrtl.strictconnect %[[VAL_23]], %[[VAL_24]] : !firrtl.uint<1>
...
// CHECK:  firrtl.strictconnect %[[VAL_28]], %[[VAL_29]] : !firrtl.uint<1>
// CHECK:  %[[VAL_30:.*]] = firrtl.and %[[VAL_28]], %[[IN_VALID]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:  firrtl.strictconnect %[[OUT1_VALID]], %[[VAL_30]] : !firrtl.uint<1>
...
// CHECK:  firrtl.strictconnect %[[VAL_31]], %[[VAL_32]] : !firrtl.uint<1>
// CHECK:  %[[VAL_33:.*]] = firrtl.or %[[VAL_31]], %[[VAL_26]] : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
// CHECK:  firrtl.strictconnect %[[VAL_13]], %[[VAL_33]] : !firrtl.uint<1>
// CHECK:}
