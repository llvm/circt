...
// CHECK:    %[[IN0_VALID:.*]] = firrtl.subfield %[[IN0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:    %[[IN0_READY:.*]] = firrtl.subfield %[[IN0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:    %[[IN0_DATA:.*]] = firrtl.subfield %[[IN0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:    %[[IN1_VALID:.*]] = firrtl.subfield %[[IN1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:    %[[IN1_READY:.*]] = firrtl.subfield %[[IN1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:    %[[IN1_DATA:.*]] = firrtl.subfield %[[IN1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:    %[[OUT_VALID:.*]] = firrtl.subfield %[[OUT]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>
// CHECK:    %[[OUT_READY:.*]] = firrtl.subfield %[[OUT]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>
// CHECK:    %[[OUT_DATA:.*]] = firrtl.subfield %[[OUT]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>
// CHECK:    %[[VAL_9:.*]] = firrtl.subfield %[[OUT_DATA]][0] : !firrtl.bundle<field0: uint<64>, field1: uint<32>>
// CHECK:    %[[VAL_10:.*]] = firrtl.subfield %[[OUT_DATA]][1] : !firrtl.bundle<field0: uint<64>, field1: uint<32>>
...
// CHECK:  %[[IN_VALID:.*]] = firrtl.subfield %[[IN]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>
// CHECK:  %[[IN_READY:.*]] = firrtl.subfield %[[IN]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>
// CHECK:  %[[IN_DATA:.*]] = firrtl.subfield %[[IN]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: bundle<field0: uint<64>, field1: uint<32>>>
// CHECK:  %[[OUT0_VALID:.*]] = firrtl.subfield %[[OUT0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:  %[[OUT0_READY:.*]] = firrtl.subfield %[[OUT0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:  %[[OUT0_DATA:.*]] = firrtl.subfield %[[OUT0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:  %[[OUT1_VALID:.*]] = firrtl.subfield %[[OUT1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:  %[[OUT1_READY:.*]] = firrtl.subfield %[[OUT1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:  %[[OUT1_DATA:.*]] = firrtl.subfield %[[OUT1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:  %[[VAL_9:.*]] = firrtl.subfield %[[IN_DATA]][0] : !firrtl.bundle<field0: uint<64>, field1: uint<32>>
// CHECK:  %[[VAL_10:.*]] = firrtl.subfield %[[IN_DATA]][1] : !firrtl.bundle<field0: uint<64>, field1: uint<32>>
