...
// CHECK:      %[[VAL_3:.*]] = firrtl.subfield %[[VAL_0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_4:.*]] = firrtl.subfield %[[VAL_0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_5:.*]] = firrtl.subfield %[[VAL_0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_6:.*]] = firrtl.subfield %[[VAL_1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_7:.*]] = firrtl.subfield %[[VAL_1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_8:.*]] = firrtl.subfield %[[VAL_1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_9:.*]] = firrtl.subfield %[[VAL_2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<1>>
// CHECK:      %[[VAL_10:.*]] = firrtl.subfield %[[VAL_2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<1>>
// CHECK:      %[[VAL_11:.*]] = firrtl.subfield %[[VAL_2]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<1>>
...
// CHECK:      %[[VAL_7:.*]] = firrtl.subfield %[[VAL_1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_8:.*]] = firrtl.subfield %[[VAL_1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_9:.*]] = firrtl.subfield %[[VAL_2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_10:.*]] = firrtl.subfield %[[VAL_2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_11:.*]] = firrtl.subfield %[[VAL_2]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_12:.*]] = firrtl.asSInt %[[VAL_5]] : (!firrtl.uint<32>) -> !firrtl.sint<32>
// CHECK:      %[[VAL_13:.*]] = firrtl.asSInt %[[VAL_8]] : (!firrtl.uint<32>) -> !firrtl.sint<32>
...
// CHECK:      %[[VAL_3:.*]] = firrtl.subfield %[[VAL_0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<16>>
// CHECK:      %[[VAL_4:.*]] = firrtl.subfield %[[VAL_0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<16>>
// CHECK:      %[[VAL_5:.*]] = firrtl.subfield %[[VAL_0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<16>>
// CHECK:      %[[VAL_6:.*]] = firrtl.subfield %[[VAL_2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_7:.*]] = firrtl.subfield %[[VAL_2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
// CHECK:      %[[VAL_8:.*]] = firrtl.subfield %[[VAL_2]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<32>>
