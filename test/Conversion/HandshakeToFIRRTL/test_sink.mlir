...
// CHECK:             firrtl.strictconnect %[[VAL_8]], %[[VAL_3]] : firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>, !firrtl.bundle<valid: uint<1>, ready flip: uint<1>
// CHECK:             firrtl.strictconnect %[[VAL_5]], %[[VAL_4]] : firrtl.bundle<valid: uint<1>, ready flip: uint<1>>, !firrtl.bundle<valid: uint<1>
// CHECK:           }
// CHECK:         }
