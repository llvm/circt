...
handshake.func @test_sink(%arg0: index, %arg1: none, ...) -> (none) {
  ...
  // CHECK: %handshake_sink_arg0 = firrtl.instance handshake_sink @handshake_sink_in_ui64(in arg0: !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>)
  // CHECK: firrtl.connect %handshake_sink_arg0, %arg0 : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>, !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
