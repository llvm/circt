...
handshake.func @test_sink(%arg0: index, %arg2: none, ...) -> (none) {
  ...
  // CHECK: %0 = firrtl.instance @handshake_sink_1ins_0outs {name = "", portNames = ["arg0"]} : !firrtl.bundle<valid: flip<uint<1>>, ready: uint<1>, data: flip<uint<64>>>
  // CHECK: firrtl.connect %0, %arg0 : !firrtl.bundle<valid: flip<uint<1>>, ready: uint<1>, data: flip<uint<64>>>, !firrtl.bundle<valid: uint<1>, ready: flip<uint<1>>, data: uint<64>>
