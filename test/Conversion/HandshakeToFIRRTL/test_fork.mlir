...
// CHECK:   %[[ARG_VALID:.+]] = firrtl.subfield %[[ARG0]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[ARG_READY:.+]] = firrtl.subfield %[[ARG0]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[RES0_VALID:.+]] = firrtl.subfield %[[ARG1]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[RES0_READY:.+]] = firrtl.subfield %[[ARG1]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[RES1_VALID:.+]] = firrtl.subfield %[[ARG2]][0] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
// CHECK:   %[[RES1_READY:.+]] = firrtl.subfield %[[ARG2]][1] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>>
...
// CHECK:   %[[ARG_DATA:.+]] = firrtl.subfield %[[ARG0]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[RES0_DATA:.+]] = firrtl.subfield %[[ARG1]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
// CHECK:   %[[RES1_DATA:.+]] = firrtl.subfield %[[ARG2]][2] : !firrtl.bundle<valid: uint<1>, ready flip: uint<1>, data: uint<64>>
