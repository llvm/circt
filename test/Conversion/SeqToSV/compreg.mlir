...
// SV-LABEL: hw.module @basic(in %clk : i1, in %d : i8, out q : i8) {
// SV:         %[[REG:.*]] = sv.reg : !hw.inout<i8>
// SV:         %[[RD:.*]] = sv.read_inout %[[REG]] : !hw.inout<i8>
// SV:         sv.alwaysff(posedge %clk) {
// SV-NEXT:      sv.passign %[[REG]], %d : i8
// SV-NEXT:    }
// SV-NEXT:    hw.output %[[RD]] : i8
// SV-NEXT:  }
...
// SV-LABEL: hw.module @basicWithInit(in %clk : i1, in %d : i8, out q : i8) {
// SV:         sv.initial {
// SV:         }
// SV:         %[[CST:.*]] = hw.constant 19 : i8
// SV:         %[[REG:.*]] = sv.reg init %[[CST]] : !hw.inout<i8>
// SV:         %[[RD:.*]] = sv.read_inout %[[REG]] : !hw.inout<i8>
// SV:         sv.always posedge %clk {
// SV-NEXT:      sv.passign %[[REG]], %d : i8
// SV-NEXT:    }
// SV-NEXT:    hw.output %[[RD]] : i8
// SV-NEXT:  }
