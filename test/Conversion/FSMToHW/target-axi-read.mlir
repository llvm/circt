...
// CHECK: hw.module @axi_read_target(%in0: i1, %in1: i8, %in2: i1, %clk: i1, %rst_n: i1) -> (%out0: i1, %out1: i1, %out2: i1) {
fsm.machine @axi_read_target(%arvalid: i1, %arlen: i8, %rready: i1) -> (i1, i1, i1) attributes {stateType = i2} {
  // CHECK: %state = sv.reg  : !hw.inout<i2>
  // CHECK: %arready = sv.reg  : !hw.inout<i1>
  // CHECK: %rvalid = sv.reg  : !hw.inout<i1>
