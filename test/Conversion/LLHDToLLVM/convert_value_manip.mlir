...
// CHECK:           %[[VAL_18:.*]] = llvm.ptrtoint %[[VAL_8]] : !llvm<"i8*"> to !llvm.i64
...
// CHECK:           %[[VAL_22:.*]] = llvm.inttoptr %[[VAL_21]] : !llvm.i64 to !llvm<"i8*">
// CHECK:           %[[VAL_23:.*]] = llvm.urem %[[VAL_17]], %[[VAL_19]] : !llvm.i64
// CHECK:           %[[VAL_24:.*]] = llvm.mlir.undef : !llvm<"{ i8*, i64, i64, i64 }">
// CHECK:           %[[VAL_25:.*]] = llvm.insertvalue %[[VAL_22]], %[[VAL_24]][0 : i32] : !llvm<"{ i8*, i64, i64, i64 }">
// CHECK:           %[[VAL_26:.*]] = llvm.insertvalue %[[VAL_23]], %[[VAL_25]][1 : i32] : !llvm<"{ i8*, i64, i64, i64 }">
// CHECK:           %[[VAL_27:.*]] = llvm.insertvalue %[[VAL_14]], %[[VAL_26]][2 : i32] : !llvm<"{ i8*, i64, i64, i64 }">
// CHECK:           %[[VAL_28:.*]] = llvm.insertvalue %[[VAL_16]], %[[VAL_27]][3 : i32] : !llvm<"{ i8*, i64, i64, i64 }">
// CHECK:           %[[VAL_29:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_30:.*]] = llvm.alloca %[[VAL_29]] x !llvm<"{ i8*, i64, i64, i64 }"> {alignment = 4 : i64} : (!llvm.i32) -> !llvm<"{ i8*, i64, i64, i64 }*">
// CHECK:           llvm.store %[[VAL_28]], %[[VAL_30]] : !llvm<"{ i8*, i64, i64, i64 }*">
// CHECK:           llvm.return
// CHECK:         }
