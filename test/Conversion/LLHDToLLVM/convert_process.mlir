...
// CHECK-SAME:                                        %[[VAL_1:.*]]: !llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">,
...
// CHECK:           %[[VAL_9:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_7]], %[[VAL_8]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32) -> !llvm<"i32*">
...
// CHECK:           %[[VAL_17:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_14]], %[[VAL_15]], %[[VAL_16]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm<"i1*">
...
// CHECK:           %[[VAL_22:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_19]], %[[VAL_20]], %[[VAL_21]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm<"i32*">
...
// CHECK:           %[[VAL_27:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_24]], %[[VAL_25]], %[[VAL_26]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm<"[3 x i32]*">
...
// CHECK:           %[[VAL_31:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_28]], %[[VAL_29]], %[[VAL_30]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm<"[3 x i32]*">
// CHECK:           %[[VAL_32:.*]] = llvm.load %[[VAL_31]] : !llvm<"[3 x i32]*">
...
// CHECK:           %[[VAL_36:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_33]], %[[VAL_34]], %[[VAL_35]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm<"i32*">
// CHECK:           %[[VAL_37:.*]] = llvm.load %[[VAL_36]] : !llvm<"i32*">
...
// CHECK:           %[[VAL_41:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_38]], %[[VAL_39]], %[[VAL_40]]] : (!llvm<"{ i8*, i32, [2 x i1]*, { i1, i32, [3 x i32] } }*">, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm<"i1*">
// CHECK:           %[[VAL_42:.*]] = llvm.load %[[VAL_41]] : !llvm<"i1*">
// CHECK:           llvm.call @dummy_i1(%[[VAL_42]]) : (!llvm.i1) -> ()
// CHECK:           llvm.call @dummy_i32(%[[VAL_37]]) : (!llvm.i32) -> ()
// CHECK:           llvm.call @dummy_time(%[[VAL_32]]) : (!llvm<"[3 x i32]">) -> ()
// CHECK:           llvm.br ^bb3
// CHECK:         ^bb4:
// CHECK:           llvm.return
// CHECK:         }
