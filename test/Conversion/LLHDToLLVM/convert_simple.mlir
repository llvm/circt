...
// CHECK:           %[[VAL_18:.*]] = llvm.mlir.constant(dense<[1, 0, 0]> : vector<3xi32>) : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_19:.*]] = llvm.mlir.constant(1 : i64) : !llvm.i64
// CHECK:           %[[VAL_20:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_21:.*]] = llvm.alloca %[[VAL_20]] x !llvm.i1 {alignment = 4 : i64} : (!llvm.i32) -> !llvm<"i1*">
// CHECK:           llvm.store %[[VAL_17]], %[[VAL_21]] : !llvm<"i1*">
// CHECK:           %[[VAL_22:.*]] = llvm.bitcast %[[VAL_21]] : !llvm<"i1*"> to !llvm<"i8*">
// CHECK:           %[[VAL_23:.*]] = llvm.extractvalue %[[VAL_18]][0 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_24:.*]] = llvm.extractvalue %[[VAL_18]][1 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_25:.*]] = llvm.extractvalue %[[VAL_18]][2 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_26:.*]] = llvm.call @drive_signal(%[[VAL_0]], %[[VAL_4]], %[[VAL_22]], %[[VAL_19]], %[[VAL_23]], %[[VAL_24]], %[[VAL_25]]) : (!llvm<"i8*">, !llvm<"{ i8*, i64, i64, i64 }*">, !llvm<"i8*">, !llvm.i64, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm.void
// CHECK:           llvm.return
// CHECK:         }
llhd.entity @Foo () -> () {
  %0 = llhd.const 0 : i1
