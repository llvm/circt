...
// CHECK-LABEL:   llvm.func @driveSignal(!llvm.ptr, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr, i64, i64, i64, i64)
...
// CHECK:           llvm.call @driveSignal(%[[VAL_0]], %[[VAL_5]], %[[VAL_23]], %[[VAL_20]], %[[VAL_24]], %[[VAL_25]], %[[VAL_26]]) : (!llvm.ptr, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr, i64, i64, i64, i64) -> ()
// CHECK:           llvm.return
// CHECK:         }
