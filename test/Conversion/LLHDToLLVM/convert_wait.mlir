...
// CHECK-LABEL:   llvm.func @llhdSuspend(!llvm.ptr<i8>, !llvm.ptr<i8>, !llvm.i64, !llvm.i64, !llvm.i64)

// CHECK-LABEL:   llvm.func @convert_resume_timed(
// CHECK-SAME:                                    %[[VAL_0:.*]]: !llvm.ptr<i8>,
// CHECK-SAME:                                    %[[VAL_1:.*]]: !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<0 x i1>>, struct<()>)>>,
...
// CHECK:           %[[VAL_5:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_3]], %[[VAL_4]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<0 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_10:.*]] = llvm.icmp "eq" %[[VAL_6]], %[[VAL_9]] : !llvm.i32
...
// CHECK:           %[[VAL_13:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_3]], %[[VAL_4]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<0 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_16:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_14]], %[[VAL_15]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<0 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<0 x i1>>>
// CHECK:           %[[VAL_17:.*]] = llvm.load %[[VAL_16]] : !llvm.ptr<ptr<array<0 x i1>>>
// CHECK:           %[[VAL_18:.*]] = llvm.bitcast %[[VAL_1]] : !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<0 x i1>>, struct<()>)>> to !llvm.ptr<i8>
...
// CHECK:           %[[VAL_22:.*]] = llvm.call @llhdSuspend(%[[VAL_0]], %[[VAL_18]], %[[VAL_19]], %[[VAL_20]], %[[VAL_21]]) : (!llvm.ptr<i8>, !llvm.ptr<i8>, !llvm.i64, !llvm.i64, !llvm.i64) -> !llvm.void
// CHECK:           llvm.return
// CHECK:         ^bb4:
// CHECK:           %[[VAL_23:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK:           %[[VAL_24:.*]] = llvm.mlir.constant(2 : i32) : !llvm.i32
// CHECK:           %[[VAL_25:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_23]], %[[VAL_24]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<0 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<0 x i1>>>
...
// CHECK-SAME:                                              %[[VAL_0:.*]]: !llvm.ptr<i8>,
// CHECK-SAME:                                              %[[VAL_1:.*]]: !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<3 x i1>>, struct<()>)>>,
// CHECK-SAME:                                              %[[VAL_2:.*]]: !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>) {
// CHECK:           %[[VAL_3:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
...
// CHECK:           %[[VAL_11:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_9]], %[[VAL_10]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<3 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_18:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_9]], %[[VAL_10]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<3 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_21:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_19]], %[[VAL_20]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<3 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<3 x i1>>>
...
// CHECK:           %[[VAL_25:.*]] = llvm.getelementptr %[[VAL_22]]{{\[}}%[[VAL_19]], %[[VAL_24]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_23]], %[[VAL_25]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_26:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_27:.*]] = llvm.getelementptr %[[VAL_22]]{{\[}}%[[VAL_19]], %[[VAL_26]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_23]], %[[VAL_27]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_28:.*]] = llvm.mlir.constant(2 : i32) : !llvm.i32
// CHECK:           %[[VAL_29:.*]] = llvm.getelementptr %[[VAL_22]]{{\[}}%[[VAL_19]], %[[VAL_28]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_23]], %[[VAL_29]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_30:.*]] = llvm.getelementptr %[[VAL_4]]{{\[}}%[[VAL_19]], %[[VAL_20]]] : (!llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i64>
// CHECK:           %[[VAL_31:.*]] = llvm.load %[[VAL_30]] : !llvm.ptr<i64>
// CHECK:           %[[VAL_32:.*]] = llvm.mlir.constant(true) : !llvm.i1
// CHECK:           %[[VAL_33:.*]] = llvm.getelementptr %[[VAL_22]]{{\[}}%[[VAL_19]], %[[VAL_31]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i64) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_32]], %[[VAL_33]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_34:.*]] = llvm.getelementptr %[[VAL_8]]{{\[}}%[[VAL_19]], %[[VAL_20]]] : (!llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i64>
// CHECK:           %[[VAL_35:.*]] = llvm.load %[[VAL_34]] : !llvm.ptr<i64>
// CHECK:           %[[VAL_36:.*]] = llvm.mlir.constant(true) : !llvm.i1
// CHECK:           %[[VAL_37:.*]] = llvm.getelementptr %[[VAL_22]]{{\[}}%[[VAL_19]], %[[VAL_35]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i64) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_36]], %[[VAL_37]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_38:.*]] = llvm.bitcast %[[VAL_1]] : !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<3 x i1>>, struct<()>)>> to !llvm.ptr<i8>
// CHECK:           llvm.return
// CHECK:         ^bb4:
// CHECK:           %[[VAL_39:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK:           %[[VAL_40:.*]] = llvm.mlir.constant(2 : i32) : !llvm.i32
// CHECK:           %[[VAL_41:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_39]], %[[VAL_40]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<3 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<3 x i1>>>
// CHECK:           %[[VAL_42:.*]] = llvm.load %[[VAL_41]] : !llvm.ptr<ptr<array<3 x i1>>>
// CHECK:           %[[VAL_43:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK:           %[[VAL_44:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i1
// CHECK:           %[[VAL_45:.*]] = llvm.getelementptr %[[VAL_42]]{{\[}}%[[VAL_39]], %[[VAL_43]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_44]], %[[VAL_45]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_46:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_47:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i1
// CHECK:           %[[VAL_48:.*]] = llvm.getelementptr %[[VAL_42]]{{\[}}%[[VAL_39]], %[[VAL_46]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_47]], %[[VAL_48]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_49:.*]] = llvm.mlir.constant(2 : i32) : !llvm.i32
// CHECK:           %[[VAL_50:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i1
// CHECK:           %[[VAL_51:.*]] = llvm.getelementptr %[[VAL_42]]{{\[}}%[[VAL_39]], %[[VAL_49]]] : (!llvm.ptr<array<3 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
...
// CHECK:           %[[VAL_15:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_5]], %[[VAL_6]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<1 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_18:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_16]], %[[VAL_17]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<1 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<1 x i1>>>
// CHECK:           %[[VAL_19:.*]] = llvm.load %[[VAL_18]] : !llvm.ptr<ptr<array<1 x i1>>>
// CHECK:           %[[VAL_20:.*]] = llvm.getelementptr %[[VAL_4]]{{\[}}%[[VAL_16]], %[[VAL_17]]] : (!llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i64>
// CHECK:           %[[VAL_21:.*]] = llvm.load %[[VAL_20]] : !llvm.ptr<i64>
// CHECK:           %[[VAL_22:.*]] = llvm.mlir.constant(true) : !llvm.i1
// CHECK:           %[[VAL_23:.*]] = llvm.getelementptr %[[VAL_19]]{{\[}}%[[VAL_16]], %[[VAL_21]]] : (!llvm.ptr<array<1 x i1>>, !llvm.i32, !llvm.i64) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_22]], %[[VAL_23]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_24:.*]] = llvm.bitcast %[[VAL_1]] : !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<1 x i1>>, struct<()>)>> to !llvm.ptr<i8>
...
// CHECK:           %[[VAL_28:.*]] = llvm.call @llhdSuspend(%[[VAL_0]], %[[VAL_24]], %[[VAL_25]], %[[VAL_26]], %[[VAL_27]]) : (!llvm.ptr<i8>, !llvm.ptr<i8>, !llvm.i64, !llvm.i64, !llvm.i64) -> !llvm.void
// CHECK:           llvm.return
// CHECK:         ^bb4:
...
// CHECK-SAME:                                          %[[VAL_0:.*]]: !llvm.ptr<i8>,
// CHECK-SAME:                                          %[[VAL_1:.*]]: !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<2 x i1>>, struct<()>)>>,
// CHECK-SAME:                                          %[[VAL_2:.*]]: !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>) {
// CHECK:           %[[VAL_3:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK:           %[[VAL_4:.*]] = llvm.getelementptr %[[VAL_2]]{{\[}}%[[VAL_3]]] : (!llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.i32) -> !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>
// CHECK:           %[[VAL_5:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
...
// CHECK:           %[[VAL_9:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_7]], %[[VAL_8]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<2 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_14:.*]] = llvm.icmp "eq" %[[VAL_10]], %[[VAL_13]] : !llvm.i32
// CHECK:           llvm.cond_br %[[VAL_14]], ^bb3, ^bb5
// CHECK:         ^bb3:
// CHECK:           %[[VAL_15:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_16:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_7]], %[[VAL_8]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<2 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i32>
...
// CHECK:           %[[VAL_19:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_17]], %[[VAL_18]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<2 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<2 x i1>>>
// CHECK:           %[[VAL_20:.*]] = llvm.load %[[VAL_19]] : !llvm.ptr<ptr<array<2 x i1>>>
// CHECK:           %[[VAL_21:.*]] = llvm.getelementptr %[[VAL_6]]{{\[}}%[[VAL_17]], %[[VAL_18]]] : (!llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i64>
// CHECK:           %[[VAL_22:.*]] = llvm.load %[[VAL_21]] : !llvm.ptr<i64>
// CHECK:           %[[VAL_23:.*]] = llvm.mlir.constant(true) : !llvm.i1
// CHECK:           %[[VAL_24:.*]] = llvm.getelementptr %[[VAL_20]]{{\[}}%[[VAL_17]], %[[VAL_22]]] : (!llvm.ptr<array<2 x i1>>, !llvm.i32, !llvm.i64) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_23]], %[[VAL_24]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_25:.*]] = llvm.getelementptr %[[VAL_4]]{{\[}}%[[VAL_17]], %[[VAL_18]]] : (!llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i64>
// CHECK:           %[[VAL_26:.*]] = llvm.load %[[VAL_25]] : !llvm.ptr<i64>
// CHECK:           %[[VAL_27:.*]] = llvm.mlir.constant(true) : !llvm.i1
// CHECK:           %[[VAL_28:.*]] = llvm.getelementptr %[[VAL_20]]{{\[}}%[[VAL_17]], %[[VAL_26]]] : (!llvm.ptr<array<2 x i1>>, !llvm.i32, !llvm.i64) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_27]], %[[VAL_28]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_29:.*]] = llvm.bitcast %[[VAL_1]] : !llvm.ptr<struct<(ptr<i8>, i32, ptr<array<2 x i1>>, struct<()>)>> to !llvm.ptr<i8>
// CHECK:           llvm.return
// CHECK:         ^bb4:
// CHECK:           %[[VAL_30:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK:           %[[VAL_31:.*]] = llvm.mlir.constant(2 : i32) : !llvm.i32
// CHECK:           %[[VAL_32:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_30]], %[[VAL_31]]] : (!llvm.ptr<struct<(ptr<i8>, i32, ptr<array<2 x i1>>, struct<()>)>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<ptr<array<2 x i1>>>
// CHECK:           %[[VAL_33:.*]] = llvm.load %[[VAL_32]] : !llvm.ptr<ptr<array<2 x i1>>>
// CHECK:           %[[VAL_34:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK:           %[[VAL_35:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i1
// CHECK:           %[[VAL_36:.*]] = llvm.getelementptr %[[VAL_33]]{{\[}}%[[VAL_30]], %[[VAL_34]]] : (!llvm.ptr<array<2 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
// CHECK:           llvm.store %[[VAL_35]], %[[VAL_36]] : !llvm.ptr<i1>
// CHECK:           %[[VAL_37:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_38:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i1
// CHECK:           %[[VAL_39:.*]] = llvm.getelementptr %[[VAL_33]]{{\[}}%[[VAL_30]], %[[VAL_37]]] : (!llvm.ptr<array<2 x i1>>, !llvm.i32, !llvm.i32) -> !llvm.ptr<i1>
