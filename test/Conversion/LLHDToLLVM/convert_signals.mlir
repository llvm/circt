...
// CHECK:           llvm.call @driveSignal(%[[VAL_0]], %[[VAL_4]], %[[VAL_17]], %[[VAL_14]], %[[VAL_18]], %[[VAL_19]], %[[VAL_20]]) : (!llvm.ptr, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr, i64, i64, i64, i64) -> ()
...
// CHECK:           llvm.call @driveSignal(%[[VAL_0]], %[[VAL_6]], %[[VAL_29]], %[[VAL_26]], %[[VAL_30]], %[[VAL_31]], %[[VAL_32]]) : (!llvm.ptr, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr, i64, i64, i64, i64) -> ()
// CHECK:           llvm.return
// CHECK:         }
...
// CHECK:           llvm.call @driveSignal(%[[VAL_0]], %[[VAL_6]], %[[VAL_48]], %[[VAL_43]], %[[VAL_49]], %[[VAL_50]], %[[VAL_51]]) : (!llvm.ptr, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr, i64, i64, i64, i64) -> ()
// CHECK:           llvm.br ^bb8
// CHECK:         ^bb8:
// CHECK:           llvm.br ^bb9
// CHECK:         ^bb9:
