...
// CHECK:           %[[VAL_16:.*]] = llvm.mlir.constant(dense<[1000, 0, 0]> : vector<3xi64>) : !llvm.array<3 x i64>
// CHECK:           %[[VAL_17:.*]] = llvm.mlir.constant(1 : i64) : !llvm.i64
// CHECK:           %[[VAL_18:.*]] = llvm.mlir.constant(1 : i16) : !llvm.i1
// CHECK:           %[[VAL_19:.*]] = llvm.icmp "eq" %[[VAL_15]], %[[VAL_18]] : !llvm.i1
...
// CHECK:           %[[VAL_26:.*]] = llvm.call @driveSignal(%[[VAL_0]], %[[VAL_4]], %[[VAL_22]], %[[VAL_17]], %[[VAL_23]], %[[VAL_24]], %[[VAL_25]]) : (!llvm.ptr<i8>, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr<i8>, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64) -> !llvm.void
// CHECK:           llvm.br ^bb2
// CHECK:         ^bb2:
// CHECK:           llvm.return
// CHECK:         }
