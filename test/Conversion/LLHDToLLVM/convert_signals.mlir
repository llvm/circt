...
// CHECK:           %[[VAL_11:.*]] = llvm.extractvalue %[[VAL_6]][0 : i32] : !llvm.array<3 x i64>
// CHECK:           %[[VAL_12:.*]] = llvm.extractvalue %[[VAL_6]][1 : i32] : !llvm.array<3 x i64>
// CHECK:           %[[VAL_13:.*]] = llvm.extractvalue %[[VAL_6]][2 : i32] : !llvm.array<3 x i64>
// CHECK:           %[[VAL_14:.*]] = llvm.call @drive_signal(%[[VAL_0]], %[[VAL_4]], %[[VAL_10]], %[[VAL_7]], %[[VAL_11]], %[[VAL_12]], %[[VAL_13]]) : (!llvm.ptr<i8>, !llvm.ptr<struct<(ptr<i8>, i64, i64, i64)>>, !llvm.ptr<i8>, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64) -> !llvm.void
// CHECK:           llvm.return
// CHECK:         }
