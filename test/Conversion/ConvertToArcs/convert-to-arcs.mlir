...
// CHECK-SAME:    input [[TMP:%.+]] : i4, output z : i4) {
// CHECK-NEXT:    hw.output [[TMP]]
// CHECK-NEXT:  }
hw.module @Passthrough(input %a: i4, output z: i4) {
  hw.output %a : i4
}
...
hw.module @CombOnly(input %i0: i4, input %i1: i4, output z: i4) {
...
hw.module @SplitAtConstants(output z: i4) {
...
hw.module @Pipeline(input %clock: !seq.clock, input %i0: i4, input %i1: i4, output z: i4) {
...
hw.module @Reshuffling(input %clockA: !seq.clock, input %clockB: !seq.clock, output z0: i4, output z1: i4, output z2: i4, output z3: i4) {
...
hw.module.extern private @Reshuffling2(output z0: i4, output z1: i4, output z2: i4, output z3: i4)
...
hw.module @FactorOutCommonOps(input %clock: !seq.clock, input %i0: i4, input %i1: i4, output o0: i4, output o1: i4) {
...
hw.module @SplitAtInstance(input %a: i4, output z: i4) {
...
hw.module.extern private @SplitAtInstance2(input %a: i4, output z: i4)


// CHECK-LABEL: hw.module @AbsorbNames
hw.module @AbsorbNames(input %clock: !seq.clock) {
...
hw.module.extern @AbsorbNames2(output z0: i4, output z1: i4)
...
hw.module @Trivial(input %clock: !seq.clock, input %i0: i4, input %reset: i1, output out: i4) {
...
hw.module @NonTrivial(input %clock: !seq.clock, input %i0: i4, input %reset1: i1, input %reset2: i1, output out1: i4, output out2: i4) {
