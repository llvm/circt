...
// Test control flow with multiple bb args
...
// CHECK-NEXT:       %std_sub_1.left, %std_sub_1.right, %std_sub_1.out = calyx.std_sub "std_sub_1" : i32, i32, i32
// CHECK-NEXT:       %std_sub_0.left, %std_sub_0.right, %std_sub_0.out = calyx.std_sub "std_sub_0" : i32, i32, i32
// CHECK-NEXT:       %std_ge_0.left, %std_ge_0.right, %std_ge_0.out = calyx.std_ge "std_ge_0" : i32, i32, i1
...
// CHECK-NEXT:       %bb3_arg1_reg.in, %bb3_arg1_reg.write_en, %bb3_arg1_reg.clk, %bb3_arg1_reg.reset, %bb3_arg1_reg.out, %bb3_arg1_reg.done = calyx.register "bb3_arg1_reg" : i32, i1, i1, i1, i32, i1
...
// CHECK-NEXT:       %bb2_arg0_reg.in, %bb2_arg0_reg.write_en, %bb2_arg0_reg.clk, %bb2_arg0_reg.reset, %bb2_arg0_reg.out, %bb2_arg0_reg.done = calyx.register "bb2_arg0_reg" : i32, i1, i1, i1, i32, i1
// CHECK-NEXT:       %bb1_arg0_reg.in, %bb1_arg0_reg.write_en, %bb1_arg0_reg.clk, %bb1_arg0_reg.reset, %bb1_arg0_reg.out, %bb1_arg0_reg.done = calyx.register "bb1_arg0_reg" : i32, i1, i1, i1, i32, i1
// CHECK-NEXT:       calyx.wires  {
// CHECK-NEXT:         calyx.assign %out0 = %ret_arg0_reg.out : i32
// CHECK-NEXT:         calyx.comb_group @bb0_0  {
// CHECK-NEXT:           calyx.assign %std_ge_0.left = %in0 : i32
// CHECK-NEXT:           calyx.assign %std_ge_0.right = %in1 : i32
// CHECK-NEXT:         }
// CHECK-NEXT:         calyx.group @bb0_to_bb1  {
// CHECK-NEXT:           calyx.assign %bb1_arg0_reg.in = %in0 : i32
// CHECK-NEXT:           calyx.assign %bb1_arg0_reg.write_en = %true : i1
// CHECK-NEXT:           calyx.group_done %bb1_arg0_reg.done : i1
// CHECK-NEXT:         }
// CHECK-NEXT:         calyx.group @bb0_to_bb2  {
// CHECK-NEXT:           calyx.assign %bb2_arg0_reg.in = %in1 : i32
// CHECK-NEXT:           calyx.assign %bb2_arg0_reg.write_en = %true : i1
// CHECK-NEXT:           calyx.group_done %bb2_arg0_reg.done : i1
// CHECK-NEXT:         }
...
// CHECK-NEXT:           calyx.assign %bb3_arg1_reg.in = %std_sub_1.out : i32
// CHECK-NEXT:           calyx.assign %bb3_arg1_reg.write_en = %true : i1
// CHECK-NEXT:           calyx.assign %std_sub_0.left = %bb1_arg0_reg.out : i32
// CHECK-NEXT:           calyx.assign %std_sub_0.right = %in1 : i32
// CHECK-NEXT:           calyx.assign %std_sub_1.left = %bb1_arg0_reg.out : i32
// CHECK-NEXT:           calyx.assign %std_sub_1.right = %in0 : i32
...
// CHECK-NEXT:           calyx.assign %bb3_arg1_reg.write_en = %true : i1
// CHECK-NEXT:           calyx.assign %std_add_0.left = %bb2_arg0_reg.out : i32
// CHECK-NEXT:           calyx.assign %std_add_0.right = %in1 : i32
// CHECK-NEXT:           calyx.assign %std_add_1.left = %bb2_arg0_reg.out : i32
// CHECK-NEXT:           calyx.assign %std_add_1.right = %in0 : i32
// CHECK-NEXT:           %0 = comb.and %bb3_arg0_reg.done, %bb3_arg1_reg.done : i1
// CHECK-NEXT:           calyx.group_done %true, %0 ? : i1
// CHECK-NEXT:         }
...
// CHECK-NEXT:           calyx.assign %std_add_2.left = %bb3_arg0_reg.out : i32
// CHECK-NEXT:           calyx.assign %std_add_2.right = %bb3_arg1_reg.out : i32
// CHECK-NEXT:           calyx.group_done %ret_arg0_reg.done : i1
// CHECK-NEXT:         }
// CHECK-NEXT:       }
// CHECK-NEXT:       calyx.control  {
// CHECK-NEXT:         calyx.seq  {
// CHECK-NEXT:           calyx.if %std_ge_0.out with @bb0_0  {
// CHECK-NEXT:             calyx.seq  {
// CHECK-NEXT:               calyx.enable @bb0_to_bb1 {compiledGroups = []}
// CHECK-NEXT:               calyx.enable @bb1_to_bb3 {compiledGroups = []}
// CHECK-NEXT:             }
// CHECK-NEXT:           } else  {
// CHECK-NEXT:             calyx.seq  {
// CHECK-NEXT:               calyx.enable @bb0_to_bb2 {compiledGroups = []}
...
// CHECK-NEXT:       %while_0_arg2_reg.in, %while_0_arg2_reg.write_en, %while_0_arg2_reg.clk, %while_0_arg2_reg.reset, %while_0_arg2_reg.out, %while_0_arg2_reg.done = calyx.register "while_0_arg2_reg" : i32, i1, i1, i1, i32, i1
// CHECK-NEXT:       %while_0_arg1_reg.in, %while_0_arg1_reg.write_en, %while_0_arg1_reg.clk, %while_0_arg1_reg.reset, %while_0_arg1_reg.out, %while_0_arg1_reg.done = calyx.register "while_0_arg1_reg" : i32, i1, i1, i1, i32, i1
