...
// CHECK-NEXT:             calyx.seq  {
// CHECK-NEXT:               calyx.enable @bb0_2 {compiledGroups = []}
...
// CHECK-NEXT:       calyx.control  {
// CHECK-NEXT:         calyx.seq  {
// CHECK-NEXT:           calyx.enable @bb0_1 {compiledGroups = []}
...
// CHECK-NEXT:           calyx.assign %std_slice_1.in = %c0_i32 : i32
...
// CHECK-NEXT:       calyx.control  {
// CHECK-NEXT:         calyx.seq  {
// CHECK-NEXT:           calyx.enable @bb0_0 {compiledGroups = []}
// CHECK-NEXT:           calyx.enable @bb0_1 {compiledGroups = []}
// CHECK-NEXT:           calyx.enable @ret_assign_0 {compiledGroups = []}
// CHECK-NEXT:         }
// CHECK-NEXT:       }
