...
// CHECK:   hw.module @test_fork(input %[[VAL_0:.*]] : !dc.token, output %out0 : !dc.token, output %out1 : !dc.token) {
...
// CHECK:   hw.module @test_fork_data(input %[[VAL_0:.*]] : !dc.value<i32>, output %out0 : !dc.value<i32>) {
...
// CHECK:   hw.module @top(input %[[VAL_0:.*]] : !dc.value<i64>, input %[[VAL_1:.*]] : !dc.value<i64>, input %[[VAL_2:.*]] : !dc.token, output %out0 : !dc.value<i64>, output %out1 : !dc.token) {
...
// CHECK:   hw.module @mux(input %[[VAL_0:.*]] : !dc.value<i1>, input %[[VAL_1:.*]] : !dc.value<i64>, input %[[VAL_2:.*]] : !dc.value<i64>, output %out0 : !dc.value<i64>) {
...
// CHECK:   hw.module @mux4(input %[[VAL_0:.*]] : !dc.value<i2>, input %[[VAL_1:.*]] : !dc.value<i64>, input %[[VAL_2:.*]] : !dc.value<i64>, input %[[VAL_3:.*]] : !dc.value<i64>, input %[[VAL_4:.*]] : !dc.value<i64>, output %out0 : !dc.value<i64>) {
...
// CHECK:   hw.module @test_conditional_branch(input %[[VAL_0:.*]] : !dc.value<i1>, input %[[VAL_1:.*]] : !dc.value<index>, input %[[VAL_2:.*]] : !dc.token, output %out0 : !dc.value<index>, output %out1 : !dc.value<index>, output %out2 : !dc.token) {
// CHECK:           %[[VAL_3:.*]], %[[VAL_4:.*]] = dc.unpack %[[VAL_0]] : !dc.value<i1>
...
// CHECK:   hw.module @test_conditional_branch_none(input %[[VAL_0:.*]] : !dc.value<i1>, input %[[VAL_1:.*]] : !dc.token, output %out0 : !dc.token, output %out1 : !dc.token) {
...
// CHECK:   hw.module @test_constant(input %[[VAL_0:.*]] : !dc.token, output %out0 : !dc.value<i32>) {
...
// CHECK:   hw.module @test_control_merge(input %[[VAL_0:.*]] : !dc.token, input %[[VAL_1:.*]] : !dc.token, output %out0 : !dc.token, output %out1 : !dc.value<index>) {
...
// CHECK:   hw.module @test_control_merge_data(input %[[VAL_0:.*]] : !dc.value<i2>, input %[[VAL_1:.*]] : !dc.value<i2>, output %out0 : !dc.value<i2>, output %out1 : !dc.value<index>) {
...
// CHECK:   hw.module @branch_and_merge(input %[[VAL_0:.*]] : !dc.value<i1>, input %[[VAL_1:.*]] : !dc.token, output %out0 : !dc.token, output %out1 : !dc.value<index>) {
