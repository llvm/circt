...
// CHECK:   hw.type_scope @top_enum_typedecls {
// CHECK-NEXT:     hw.typedecl @top_state_t : !hw.enum<A, B>
// CHECK-NEXT:   }

// CHECK:      hw.module @top(%a0: i1, %a1: i1, %clk: i1, %rst: i1) -> (r0: i8, r1: i8) {
// CHECK-NEXT:    %A = hw.enum.constant #hw.enum.field<A, !hw.typealias<@top_enum_typedecls::@top_state_t, !hw.enum<A, B>>>
...
// CHECK-NEXT:    %B = hw.enum.constant #hw.enum.field<B, !hw.typealias<@top_enum_typedecls::@top_state_t, !hw.enum<A, B>>>
