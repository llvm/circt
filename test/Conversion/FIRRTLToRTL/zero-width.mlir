...
module attributes {firrtl.mainModule = "Simple"} {
  ...
  rtl.module @Arithmetic(%uin3: i3) -> (i3, i4, i4, i1) {
    ...
    // CHECK-NEXT: comb.constant(0 : i3) : i3
    // CHECK-NEXT: [[MULZERO:%.+]] = comb.constant(0 : i3) : i3
    ...
    // CHECK-NEXT: %c0_i4 = comb.constant(0 : i4) : i4
