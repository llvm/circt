...
module attributes {firrtl.mainModule = "Simple"} {
  ...
  rtl.module @Simple(%in1: i4, %in2: i2, %in3: i8) -> (%out4: i4, %out5: i4) {
    ...
    // CHECK-NEXT: %c0_i8_6 = comb.constant
    // CHECK-NEXT: [[ZEXT2:%.+]] = comb.concat %c0_i8_6, [[SUB]] : (i8, i6) -> i14
    ...
    // CHECK-NEXT: %c0_i12_10 = comb.constant(0 : i12) : i12
    // CHECK-NEXT: = comb.sub %c0_i12_10, %c-873_i12 : i12
