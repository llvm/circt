...
hw.module @large_use_in_procedural(input %clock: i1, input %a: i1) {
...
hw.module @large_use_in_procedural_successive(input %clock: i1, input %a: i1) {
...
hw.module @dont_spill_to_procedural_regions(input %z: i10) {
