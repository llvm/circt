...
hw.module @BasicEmissionNonTemporal(input %a: i1, input %b: i1) {
  %0 = comb.and %a, %b : i1
  %1 = comb.or %a, %b : i1
...
hw.module @BasicEmissionTemporal(input %a: i1) {
  %p = ltl.not %a : i1
...
hw.module @Sequences(input %clk: i1, input %a: i1, input %b: i1) {
...
hw.module @Properties(input %clk: i1, input %a: i1, input %b: i1) {
...
hw.module @Precedence(input %a: i1, input %b: i1) {
...
hw.module @SystemVerilogSpecExamples(input %clk: i1, input %a: i1, input %b: i1, input %c: i1, input %d: i1, input %e: i1) {
...
hw.module @LivenessExample(input %clock: i1, input %reset: i1, input %isLive: i1) {
  %true = hw.constant true
...
hw.module @Issue5763(input %a: i3) {
