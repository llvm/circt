...
hw.module @Precedence(%a: i4, %b: i4, %c: i4) -> (out1: i1, out: i10) {
  ...
  // CHECK: wire [4:0] _GEN_0 = b + c;
  // CHECK: wire [5:0] _GEN_1 = {2'h0, a};
  // CHECK: wire [5:0] _GEN_2 = {1'h0, _GEN_0};
  // CHECK: assign _out_output = {4'h0, a + _GEN_0};
  // CHECK: wire [4:0] _GEN_3 = a + b;
  ...
  // CHECK: assign _out_output = {1'h0, a + b * c};
  // CHECK: wire [8:0] _GEN_6 = {5'h0, c};
  // CHECK: assign _out_output = {1'h0, a * b + c};
  // CHECK: assign _out_output = {1'h0, _GEN_3 * c};
  // CHECK: assign _out_output = {1'h0, a * _GEN_0};
  // CHECK: assign _out_output = _GEN_3 * _GEN_0;
