...
module {
  ...
  hw.module.extern @Rcvr (input %m: !sv.modport<@data_vr::@data_in>)

  // CHECK-LABEL: module Top
  hw.module @Top (input %clk: i1) {
    // CHECK: data_vr [[IFACE:.+]]();
...
// can't just rename it.
  hw.module.extern @regStuff (input %m: !sv.modport<@data_vr::@data_in>)
  // CHECK-LABEL: module Top2
  hw.module @Top2 (input %clk: i1) {
    // CHECK: data_vr [[IFACE:.+]]();{{.*}}//{{.+}}
    %iface = sv.interface.instance : !sv.interface<@data_vr>
