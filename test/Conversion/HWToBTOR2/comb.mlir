...
module {
  ...
  // CHECK:   [[CLKNID:[0-9]+]] input [[NID2]] clk
  hw.module @inc(in %a : i32, in %clk : !seq.clock, out pred : i1) {
    ...
    // CHECK:   [[NID11:[0-9]+]] slice [[NID2]] [[NID9]] 16 16
    %4 = comb.extract %2 from 16 : (i33) -> i1

    // CHECK:   [[NID12:[0-9]+]] ugt [[NID2]] [[NID10]] 2
    %5 = comb.icmp bin ugt %3, %a : i32

    // CHECK:   [[NID13:[0-9]+]] ulte [[NID2]] [[NID10]] 2
    %6 = comb.icmp bin ule %3, %a : i32

    // CHECK:   [[NID14:[0-9]+]] slte [[NID2]] [[NID10]] 2
    %7 = comb.icmp bin sle %3, %a : i32

    // CHECK:   [[NID15:[0-9]+]] ugte [[NID2]] [[NID10]] 2
    %8 = comb.icmp bin uge %3, %a : i32

    // CHECK:   [[NID16:[0-9]+]] sgte [[NID2]] [[NID10]] 2
    ...
    // CHECK: [[NID29:[0-9]+]] add [[NID2]] [[CLKNID]] [[CLKNID]]
    %17 = comb.add %0, %0 : i1

    // CHECK:   [[ASSERTNID1:[0-9]+]] implies [[NID2]] [[NID5]] [[NID12]]
    // CHECK:   [[ASSERTNID2:[0-9]+]] not [[NID2]] [[ASSERTNID1]]
    // CHECK:   [[ASSERTNID2:[0-9]+]] bad [[ASSERTNID2:[0-9]+]]
    sv.always posedge %0 {
      sv.if %true {
