...
func @test1(%arg0: i3) -> i50 {
  ...
  // CHECK-NEXT:    %5 = rtl.andr %4 : (i12) -> i1
  // CHECK-NEXT:    %6 = rtl.orr  %4 : (i12) -> i1
  // CHECK-NEXT:    %7 = rtl.xorr %4 : (i12) -> i1
  %andr1 = rtl.andr %conc1 : (i12) -> i1
  %orr1  = rtl.orr  %conc1 : (i12) -> i1
  %xorr1 = rtl.xorr %conc1 : (i12) -> i1
