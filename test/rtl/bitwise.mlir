...
// CHECK-NEXT:    %0 = rtl.and %arg0, %arg1 : (i7, i7) -> i7
// CHECK-NEXT:    %1 = rtl.or  %arg0, %arg1 : (i7, i7) -> i7
// CHECK-NEXT:    %2 = rtl.xor %arg0, %arg1 : (i7, i7) -> i7
  %and1 = rtl.and %a, %b : (i7, i7) -> i7
  %or1  = rtl.or  %a, %b : (i7, i7) -> i7
  %xor1 = rtl.xor %a, %b : (i7, i7) -> i7
