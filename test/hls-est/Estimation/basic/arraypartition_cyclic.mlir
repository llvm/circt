...
// CHECK-BRAM: Total BRAM: 2

module {
  func.func @kernel(%arg0: memref<1024xi32>, %arg1: memref<1024xi32>) {
    %c2_i32 = arith.constant 2 : i32
    %c1_i32 = arith.constant 1 : i32
    %alloca = memref.alloca() {hls.array_partition = [{dim = 1 : i32, factor = 2 : i32, kind = "cyclic", variable = "buf"}], polygeist.varname = "buf"} : memref<1024xi32>
    ...
    affine.for %arg2 = 0 to 1022 step 2 {
      ...
      affine.store %1, %arg1[%arg2] : memref<1024xi32>
      %2 = affine.load %alloca[%arg2 + 1] : memref<1024xi32>
      %3 = arith.muli %2, %c2_i32 : i32
      affine.store %3, %arg1[%arg2 + 1] : memref<1024xi32>
    }
    return
  }
}
