        ...
        affine.for %arg7 = 0 to 8 {
          affine.for %arg8 = 0 to 8 {
            ...
            %5 = affine.for %arg9 = 0 to 4 iter_args(%arg10 = %cst) -> (f16) {
              %8 = affine.load %alloca_3[%arg7, %arg9 + %arg5 * 16 + %arg6 * 4] : memref<8x64xf16>
              %9 = affine.load %alloca_2[%arg8, %arg9 + %arg5 * 16 + %arg6 * 4] : memref<8x64xf16>
              %10 = arith.mulf %8, %9 : f16
              %11 = arith.addf %arg10, %10 : f16
        ...
        affine.for %arg7 = 0 to 8 {
          affine.for %arg8 = 0 to 4 {
            %5 = affine.for %arg9 = 0 to 8 iter_args(%arg10 = %cst) -> (f16) {
              ...
              %7 = affine.load %alloca_1[%arg9, %arg8 + %arg5 * 16 + %arg6 * 4] : memref<8x64xf16>
              %8 = arith.mulf %6, %7 : f16
              %9 = arith.addf %arg10, %8 : f16
              affine.yield %9 : f16
            }
            affine.store %5, %4[%arg7, %arg8 + %arg5 * 16 + %arg6 * 4] : memref<8x64xf16>
          }
        }
      }
    }
