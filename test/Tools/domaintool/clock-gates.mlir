...
om.class @Foo_Class(
  ...
  A_registry_clockGates: !om.list<!om.frozenpath>
) {
  ...
  %0 = om.object @ClockDomain_out(%basepath, %A, %assocs) : (
    !om.frozenbasepath,
    !om.class.type<@ClockDomain>,
    !om.list<!om.frozenpath>
  ) -> !om.class.type<@ClockDomain_out>
  om.class.fields %0, %gates : !om.class.type<@ClockDomain_out>, !om.list<!om.frozenpath>
}
