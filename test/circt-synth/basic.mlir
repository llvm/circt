...
hw.module @and(in %a: i2, in %b: i2, in %c: i2, in %d: i1, out and: i2) {
  ...
  // CHECK-DAG: %[[AND_INV_0:.+]] = synth.aig.and_inv %[[A_0]], %[[B_0]] : i1
  // CHECK-DAG: %[[AND_INV_1:.+]] = synth.aig.and_inv %[[A_1]], %[[B_1]] : i1
  // CHECK-DAG: %[[AND_INV_2:.+]] = synth.aig.and_inv %[[AND_INV_0]], %[[C_0]] : i1
  // CHECK-DAG: %[[AND_INV_3:.+]] = synth.aig.and_inv %[[AND_INV_1]], %[[C_1]] : i1
  // CHECK-DAG: %[[CONCAT:.+]] = comb.concat %[[AND_INV_3]], %[[AND_INV_2]] : i1, i1
