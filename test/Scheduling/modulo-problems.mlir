...
ssp.instance @canis14_fig2 of "ModuloProblem" [II<3>] {
  ...
  graph {
    %0 = operation<@L1_1> uses[@L1_rsrc](@op3 [dist<1>]) [t<2>]
    %1 = operation<@L1_1> uses[@L1_rsrc]() [t<0>]
    %2 = operation<@_1>(%0, %1) [t<3>]
    %3 = operation<@L1_1> uses[@L1_rsrc] @op3(%2) [t<4>]
...
ssp.instance @minII_feasible of "ModuloProblem" [II<3>] {
  ...
  graph {
    ...
    %4 = operation<@L1_3> uses[@L1_rsrc](%3, %2) [t<3>]
    %5 = operation<@L1_3> uses[@L1_rsrc] @op5(%0, %4) [t<7>]
    %6 = operation<@L1_3> uses[@L1_rsrc] @op6(%4, %5) [t<11>]
    // SIMPLEX: @last(%{{.*}}) [t<14>]
...
ssp.instance @minII_infeasible of "ModuloProblem" [II<4>] {
  ...
  graph {
    ...
    %2 = operation<@L2_1> uses[@L2_rsrc](%1) [t<2>]
    %3 = operation<@L2_1> uses[@L2_rsrc](%1) [t<3>]
    %4 = operation<@L2_1> uses[@L2_rsrc](%1) [t<2>]
...
ssp.instance @four_read_pipeline of "ModuloProblem" [II<4>] {
  ...
  graph {
    ...
    %2 = operation<@L1_1> uses[@L1_rsrc](%1) [t<2>]
    %3 = operation<@L1_1> uses[@L1_rsrc](%1) [t<3>]
    %4 = operation<@L1_1> uses[@L1_rsrc](%1) [t<4>]
    %5 = operation<@L1_1> uses[@L1_rsrc](%1) [t<5>]
