...
/// If the type is an RTGTest BogusReg.
MLIR_CAPI_EXPORTED bool rtgTypeIsABogusReg(MlirType type);

/// Creates an RTGTest BogusReg type in the context.
MLIR_CAPI_EXPORTED MlirType rtgBogusRegTypeGet(MlirContext ctxt);
