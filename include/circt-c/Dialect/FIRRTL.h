...
typedef struct FirrtlStatementWhenBegin {
  FirrtlExpr condition;
} FirrtlStatementWhenBegin;

typedef struct FirrtlStatementElse {
  // No fields
} FirrtlStatementElse;

typedef struct FirrtlStatementWhenEnd {
  // No fields
...
typedef struct FirrtlStatementSkip {
  // No fields
} FirrtlStatementSkip;

typedef struct FirrtlStatementStop {
  FirrtlExpr clock;
  FirrtlExpr condition;
  int32_t exitCode;
  FirrtlStringRef *name; // Optional, `NULL` for empty
...
typedef struct FirrtlStatementAssert {
  FirrtlExpr clock;
  FirrtlExpr predicate;
  FirrtlExpr enable;
  FirrtlStringRef message;
  FirrtlStringRef *name; // Optional, `NULL` for empty
} FirrtlStatementAssert;

typedef struct FirrtlStatementAssume {
  FirrtlExpr clock;
  FirrtlExpr predicate;
  FirrtlExpr enable;
  FirrtlStringRef message;
