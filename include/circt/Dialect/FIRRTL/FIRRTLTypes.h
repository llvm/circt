...
/// Returns whether the destType is structually equivalent to srcType.
bool areTypesStructuallyEquivalent(Type destType, Type srcType);
bool areTypesStructuallyEquivalent(mlir::TypeRange l, mlir::TypeRange r);
