//===- Server.h - ESI llcosim RPC server ------------------------*- C++ -*-===//
//
...
#ifndef CIRCT_DIALECT_ESI_LLCOSIM_SERVER_H
#define CIRCT_DIALECT_ESI_LLCOSIM_SERVER_H
...
#endif // CIRCT_DIALECT_ESI_LLCOSIM_SERVER_H
