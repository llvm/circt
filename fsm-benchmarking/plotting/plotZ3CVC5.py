...
# Plot each DataFrame
ax.plot(df1['#states'], df1['time'], color=colors[1], label='linear-z3')
ax.plot(df2['#states'], df2['time'], color=colors[2], label='linear-cvc5')
# ax.plot(df3['#states'], df3['time'], color=colors[3], label='err-state')


# Set title and labels
ax.set_title('Verification time: Z3 vs. CVC5')
...
# Show the plot
plt.savefig('plots/compare-z3-cvc5.pdf')
