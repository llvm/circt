...
file = open("../z3/z3-linear-p1-3007.txt", "r")
...
file2 = open("../z3/z3-loop-p1-3007.txt", "r")
...
ax.set_title('Verification time for synthetic FSMs - Z3')
...
# Show the plot
plt.savefig('plots/synth-z3.pdf')