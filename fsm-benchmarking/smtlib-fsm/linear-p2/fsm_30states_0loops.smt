...
(assert
 (exists ((time Int) )(let (($x490 (forall ((var0 Int) )(let (($x495 (= var0 29)))
 (let (($x402 (_29 var0 time)))
 (and (distinct $x402 $x495) true))))
 ))
 (=> (and (>= time 0) (< time 39)) $x490)))
 )
(check-sat)
