...
(assert
 (exists ((time Int) )(let (($x3340 (forall ((var0 Int) )(let (($x3345 (= var0 219)))
 (let (($x2682 (_219 var0 time)))
 (and (distinct $x2682 $x3345) true))))
 ))
 (=> (and (>= time 0) (< time 229)) $x3340)))
 )
(check-sat)
