...
(assert
 (exists ((time Int) )(let (($x2290 (forall ((var0 Int) )(let (($x2295 (= var0 149)))
 (let (($x1842 (_149 var0 time)))
 (and (distinct $x1842 $x2295) true))))
 ))
 (=> (and (>= time 0) (< time 159)) $x2290)))
 )
(check-sat)
