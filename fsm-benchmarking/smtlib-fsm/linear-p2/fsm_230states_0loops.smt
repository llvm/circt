...
(assert
 (exists ((time Int) )(let (($x3490 (forall ((var0 Int) )(let (($x3495 (= var0 229)))
 (let (($x2802 (_229 var0 time)))
 (and (distinct $x2802 $x3495) true))))
 ))
 (=> (and (>= time 0) (< time 239)) $x3490)))
 )
(check-sat)
