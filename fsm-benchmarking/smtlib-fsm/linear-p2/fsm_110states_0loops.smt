...
(assert
 (exists ((time Int) )(let (($x1690 (forall ((var0 Int) )(let (($x1695 (= var0 109)))
 (let (($x1362 (_109 var0 time)))
 (and (distinct $x1362 $x1695) true))))
 ))
 (=> (and (>= time 0) (< time 119)) $x1690)))
 )
(check-sat)
