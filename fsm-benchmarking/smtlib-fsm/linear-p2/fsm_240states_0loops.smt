...
(assert
 (exists ((time Int) )(let (($x3640 (forall ((var0 Int) )(let (($x3645 (= var0 239)))
 (let (($x2922 (_239 var0 time)))
 (and (distinct $x2922 $x3645) true))))
 ))
 (=> (and (>= time 0) (< time 249)) $x3640)))
 )
(check-sat)
