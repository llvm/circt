...
(assert
 (exists ((time Int) )(let (($x4390 (forall ((var0 Int) )(let (($x4395 (= var0 289)))
 (let (($x3522 (_289 var0 time)))
 (and (distinct $x3522 $x4395) true))))
 ))
 (=> (and (>= time 0) (< time 299)) $x4390)))
 )
(check-sat)
