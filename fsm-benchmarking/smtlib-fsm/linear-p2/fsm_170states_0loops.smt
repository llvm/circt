...
(assert
 (exists ((time Int) )(let (($x2590 (forall ((var0 Int) )(let (($x2595 (= var0 169)))
 (let (($x2082 (_169 var0 time)))
 (and (distinct $x2082 $x2595) true))))
 ))
 (=> (and (>= time 0) (< time 179)) $x2590)))
 )
(check-sat)
