...
(assert
 (exists ((time Int) )(let (($x1240 (forall ((var0 Int) )(let (($x1245 (= var0 79)))
 (let (($x1002 (_79 var0 time)))
 (and (distinct $x1002 $x1245) true))))
 ))
 (=> (and (>= time 0) (< time 89)) $x1240)))
 )
(check-sat)
