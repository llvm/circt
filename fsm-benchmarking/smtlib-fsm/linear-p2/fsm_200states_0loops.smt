...
(assert
 (exists ((time Int) )(let (($x3040 (forall ((var0 Int) )(let (($x3045 (= var0 199)))
 (let (($x2442 (_199 var0 time)))
 (and (distinct $x2442 $x3045) true))))
 ))
 (=> (and (>= time 0) (< time 209)) $x3040)))
 )
(check-sat)
