...
(assert
 (exists ((time Int) )(let (($x1090 (forall ((var0 Int) )(let (($x1095 (= var0 69)))
 (let (($x882 (_69 var0 time)))
 (and (distinct $x882 $x1095) true))))
 ))
 (=> (and (>= time 0) (< time 79)) $x1090)))
 )
(check-sat)
