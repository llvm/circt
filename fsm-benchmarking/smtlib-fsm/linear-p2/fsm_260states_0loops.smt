...
(assert
 (exists ((time Int) )(let (($x3940 (forall ((var0 Int) )(let (($x3945 (= var0 259)))
 (let (($x3162 (_259 var0 time)))
 (and (distinct $x3162 $x3945) true))))
 ))
 (=> (and (>= time 0) (< time 269)) $x3940)))
 )
(check-sat)
