...
(assert
 (exists ((time Int) )(let (($x3190 (forall ((var0 Int) )(let (($x3195 (= var0 209)))
 (let (($x2562 (_209 var0 time)))
 (and (distinct $x2562 $x3195) true))))
 ))
 (=> (and (>= time 0) (< time 219)) $x3190)))
 )
(check-sat)
