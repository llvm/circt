...
(assert
 (exists ((time Int) )(let (($x2140 (forall ((var0 Int) )(let (($x2145 (= var0 139)))
 (let (($x1722 (_139 var0 time)))
 (and (distinct $x1722 $x2145) true))))
 ))
 (=> (and (>= time 0) (< time 149)) $x2140)))
 )
(check-sat)
