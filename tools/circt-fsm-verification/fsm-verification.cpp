...
void parse_fsm(string input_file, int time_bound, string to_check){
  ...
  s.add(forall(solverVars->at(solverVars->size()-1),  implies((solverVars->at(solverVars->size()-1)>=0), nestedForall(*solverVars,body,0))));
