...
def place_inst(inst):
  ...
  if inst.modname == "Nothing":
    ...
    inst.place(["memory", "bank"], msft.DSP, x, y, 0)
...
# CHECK-NEXT:  set_location_assignment MPDSP_X0_Y10_N0 -to $parent|pycde_UnParameterized|memory|bank
# CHECK-NEXT:  set_location_assignment MPDSP_X1_Y12_N0 -to $parent|pycde_UnParameterized|pycde_Nothing|dsp_inst
# CHECK-NEXT:  set_location_assignment MPDSP_X2_Y14_N0 -to $parent|pycde_UnParameterized_0|memory|bank
