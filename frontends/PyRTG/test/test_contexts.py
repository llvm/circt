...
# CHECK-NEXT:   [[V0:%.+]] = rtg.constant #rtg.all_contexts : !rtgtest.cpu
...
# CHECK-NEXT:   [[V3:%.+]] = rtg.get_sequence @_context_seq_4 : !rtg.sequence<index, index, !rtgtest.cpu, !rtgtest.cpu>
# CHECK-NEXT:   [[V4:%.+]] = rtg.substitute_sequence [[V3]](%a, %b, %cpu0, %cpu1) : !rtg.sequence<index, index, !rtgtest.cpu, !rtgtest.cpu>
# CHECK-NEXT:   rtg.on_context [[V0]], [[V4]] : !rtgtest.cpu
# CHECK-NEXT:   rtg.test.failure
...
# CHECK-NEXT:   rtg.embed_sequence [[V2]]
# CHECK-NEXT: }
# CHECK-NEXT: rtg.sequence @_context_seq_4([[ARG0:%.+]]: index, [[ARG1:%.+]]: index, [[ARG2:%.+]]: !rtgtest.cpu, [[ARG3:%.+]]: !rtgtest.cpu) {
# CHECK-NEXT:   [[V0:%.+]] = rtg.get_sequence @consumer : !rtg.sequence<index>
# CHECK-NEXT:   [[V1:%.+]] = rtg.substitute_sequence [[V0]]([[ARG0]]) : !rtg.sequence<index>
# CHECK-NEXT:   [[V2:%.+]] = rtg.randomize_sequence [[V1]]
# CHECK-NEXT:   rtg.embed_sequence [[V2]]
