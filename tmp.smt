...
(assert
 (forall ((time Int) )(forall ((var0 Int) )(let (($x209 (_10 var0 time)))
 (let (($x162 (_9 var0 time)))
 (let (($x150 (_8 var0 time)))
 (let (($x138 (_7 var0 time)))
 (let (($x126 (_6 var0 time)))
 (let (($x114 (_5 var0 time)))
 (let (($x102 (_4 var0 time)))
 (let (($x90 (_3 var0 time)))
 (let (($x213 (xor (xor (xor (xor (_0 var0 time) (_1 var0 time)) (_2 var0 time)) $x90) $x102)))
 (xor (xor (xor (xor (xor (xor $x213 $x114) $x126) $x138) $x150) $x162) $x209)))))))))))
 )
 )
(check-sat)
