...
class alignas(VL_CACHE_LINE_BYTES) VESI_Cosim_Top__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_ESI_Cosim_Top__read_address;
    VerilatedScope __Vscope_ESI_Cosim_Top__read_address__out_pipe;
    VerilatedScope __Vscope_ESI_Cosim_Top__read_address__unnamedblk1;
    VerilatedScope __Vscope_ESI_Cosim_Top__read_address__unnamedblk2;
    VerilatedScope __Vscope_ESI_Cosim_Top__read_data;
    VerilatedScope __Vscope_ESI_Cosim_Top__read_data__unnamedblk1;
    VerilatedScope __Vscope_ESI_Cosim_Top__read_data__unnamedblk2;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_ack;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_ack__unnamedblk1;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_ack__unnamedblk2;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_req;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_req__out_pipe;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_req__unnamedblk1;
    VerilatedScope __Vscope_ESI_Cosim_Top__write_req__unnamedblk2;
