...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc10_TOP__Cosim_DpiPkg(std::string endpoint_id, const VlUnpacked<CData/*7:0*/, 8> &data, IData/*31:0*/ data_size, IData/*31:0*/ &cosim_ep_tryput__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc10_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc7_TOP__Cosim_DpiPkg(std::string endpoint_id, const VlUnpacked<CData/*7:0*/, 4> &data, IData/*31:0*/ data_size, IData/*31:0*/ &cosim_ep_tryput__Vfuncrtn) {
    ...
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
    static const int data__Vopenprops__ulims[2] = {3, 0};
    static const int data__Vopenprops__plims[2] = {7, 0};
    static const VerilatedVarProps data__Vopenprops(VLVT_UINT8, VLVD_IN|VLVF_DPI_CLAY, VerilatedVarProps::Unpacked{}, 1, data__Vopenprops__ulims, VerilatedVarProps::Packed{}, 1, data__Vopenprops__plims);
    VerilatedDpiOpenVar data__Vopenarray (&data__Vopenprops, &data);
    int data_size__Vcvt;
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_set_manifest__Vdpioc2_TOP__Cosim_DpiPkg(IData/*31:0*/ esi_version, const VlUnpacked<CData/*7:0*/, 3018> &compressed_manifest) {
    ...
    static const int compressed_manifest__Vopenprops__ulims[2] = {3017, 0};
