module {
  hw.module @fsm40(in %clk : !seq.clock, in %rst : i1) {
    %is_second_state = comb.icmp bin eq %c38_i16, %state_reg : i16
    ...
    %state_reg = seq.compreg sym @state_reg  %185, %clk reset %rst, %c0_i16 : i16  
    %c0_i16_0 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %182, %clk reset %rst, %c0_i16_0 : i16  
    %c10_i16_1 = hw.constant 10 : i16
    ...
    %21 = comb.add bin %x0, %c1_i16_2 : i16
    ...
    %38 = comb.icmp bin uge %x0, %c10_i16_1 : i16
    %39 = comb.icmp bin eq %state_reg, %c9_i16 : i16
    %40 = comb.add bin %x0, %c1_i16_2 : i16
    %41 = comb.icmp bin ult %x0, %c10_i16_1 : i16
    %42 = comb.icmp bin eq %state_reg, %c9_i16 : i16
    %43 = comb.mux bin %42, %c9_i16, %35 : i16
    %44 = comb.mux bin %41, %c7_i16, %c9_i16 : i16
