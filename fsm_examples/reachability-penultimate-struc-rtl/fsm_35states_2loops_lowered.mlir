module {
  hw.module @fsm35(in %clk : !seq.clock, in %rst : i1) {
    %is_second_state = comb.icmp bin eq %c33_i16, %state_reg : i16
    ...
    %state_reg = seq.compreg sym @state_reg  %165, %clk reset %rst, %c0_i16 : i16  
    %c0_i16_0 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %162, %clk reset %rst, %c0_i16_0 : i16  
    %c16_i16_1 = hw.constant 16 : i16
    %c17_i16_2 = hw.constant 17 : i16
    %c1_i16_3 = hw.constant 1 : i16
    %0 = comb.icmp bin eq %state_reg, %c0_i16 : i16
    %1 = comb.add bin %x0, %c1_i16_3 : i16
    %2 = comb.mux bin %0, %1, %162 : i16
    ...
    %74 = comb.icmp bin uge %x0, %c17_i16_2 : i16
    %75 = comb.icmp bin eq %state_reg, %c15_i16 : i16
    %76 = comb.add bin %x0, %c1_i16_3 : i16
    %77 = comb.icmp bin ult %x0, %c17_i16_2 : i16
    %78 = comb.icmp bin eq %state_reg, %c15_i16 : i16
    %79 = comb.mux bin %78, %c15_i16, %71 : i16
    %80 = comb.mux bin %77, %c6_i16, %c15_i16 : i16
    %81 = comb.and bin %77, %75 : i1
    %82 = comb.mux bin %81, %76, %70 : i16
    %83 = comb.mux bin %75, %80, %79 : i16
    %84 = comb.mux bin %74, %c16_i16, %80 : i16
    %85 = comb.and bin %74, %72 : i1
    %86 = comb.mux bin %85, %73, %82 : i16
    %87 = comb.mux bin %72, %84, %83 : i16
    ...
    %165 = comb.mux bin %164, %c35_i16, %163 : i16
    hw.output
  }
}
