module {
  hw.module @fsm25(in %clk : !seq.clock, in %rst : i1) {
    %is_second_state = comb.icmp bin eq %c23_i16, %state_reg : i16
    ...
    %state_reg = seq.compreg sym @state_reg  %125, %clk reset %rst, %c0_i16 : i16  
    %c0_i16_0 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %122, %clk reset %rst, %c0_i16_0 : i16  
    %c17_i16_1 = hw.constant 17 : i16
    %c21_i16_2 = hw.constant 21 : i16
    %c1_i16_3 = hw.constant 1 : i16
    %0 = comb.icmp bin eq %state_reg, %c0_i16 : i16
    %1 = comb.add bin %x0, %c1_i16_3 : i16
    %2 = comb.mux bin %0, %1, %122 : i16
    ...
    %42 = comb.icmp bin uge %x0, %c17_i16_1 : i16
    %43 = comb.icmp bin eq %state_reg, %c10_i16 : i16
    %44 = comb.add bin %x0, %c1_i16_3 : i16
    %45 = comb.icmp bin ult %x0, %c17_i16_1 : i16
    %46 = comb.icmp bin eq %state_reg, %c10_i16 : i16
    %47 = comb.mux bin %46, %c10_i16, %39 : i16
    %48 = comb.mux bin %45, %c5_i16, %c10_i16 : i16
    %49 = comb.and bin %45, %43 : i1
    %50 = comb.mux bin %49, %44, %38 : i16
    %51 = comb.mux bin %43, %48, %47 : i16
    %52 = comb.mux bin %42, %c11_i16, %48 : i16
    %53 = comb.and bin %42, %40 : i1
    %54 = comb.mux bin %53, %41, %50 : i16
    %55 = comb.mux bin %40, %52, %51 : i16
    ...
    %90 = comb.icmp bin uge %x0, %c21_i16_2 : i16
    %91 = comb.icmp bin eq %state_reg, %c19_i16 : i16
    %92 = comb.add bin %x0, %c1_i16_3 : i16
    %93 = comb.icmp bin ult %x0, %c21_i16_2 : i16
    %94 = comb.icmp bin eq %state_reg, %c19_i16 : i16
    %95 = comb.mux bin %94, %c19_i16, %87 : i16
    %96 = comb.mux bin %93, %c5_i16, %c19_i16 : i16
    %97 = comb.and bin %93, %91 : i1
    %98 = comb.mux bin %97, %92, %86 : i16
    %99 = comb.mux bin %91, %96, %95 : i16
    %100 = comb.mux bin %90, %c20_i16, %96 : i16
    %101 = comb.and bin %90, %88 : i1
    %102 = comb.mux bin %101, %89, %98 : i16
    %103 = comb.mux bin %88, %100, %99 : i16
    ...
    %125 = comb.mux bin %124, %c25_i16, %123 : i16
    hw.output
  }
}
