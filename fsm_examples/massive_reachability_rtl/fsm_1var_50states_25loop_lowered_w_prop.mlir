module {
  hw.module @fsm1(in %clk : !seq.clock, in %rst : i1) {
    ...
    %state_reg = seq.compreg sym @state_reg  %209, %clk reset %rst, %c0_i6 : i6  
    %c0_i16 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %206, %clk reset %rst, %c0_i16 : i16  
    ...
    %101 = comb.icmp bin uge %x0, %c27_i16 : i16
    %102 = comb.icmp bin eq %state_reg, %c25_i6 : i6
    %103 = comb.icmp bin ult %x0, %c27_i16 : i16
    %104 = comb.icmp bin eq %state_reg, %c25_i6 : i6
    %105 = comb.mux bin %104, %c25_i6, %99 : i6
    %106 = comb.mux bin %103, %c2_i6, %c25_i6 : i6
    %107 = comb.and bin %103, %102 : i1
    %108 = comb.mux bin %102, %106, %105 : i6
    %109 = comb.mux bin %101, %c26_i6, %106 : i6
    %110 = comb.and bin %101, %100 : i1
    %111 = comb.mux bin %100, %109, %108 : i6
    %112 = comb.icmp bin eq %state_reg, %c26_i6 : i6
    %113 = comb.add bin %x0, %c1_i16 : i16
    %114 = comb.mux bin %112, %113, %98 : i16
    %115 = comb.mux bin %112, %c27_i6, %111 : i6
    %116 = comb.icmp bin eq %state_reg, %c27_i6 : i6
    %117 = comb.add bin %x0, %c1_i16 : i16
    %118 = comb.mux bin %116, %117, %114 : i16
    %119 = comb.mux bin %116, %c28_i6, %115 : i6
    %120 = comb.icmp bin eq %state_reg, %c28_i6 : i6
    %121 = comb.add bin %x0, %c1_i16 : i16
    %122 = comb.mux bin %120, %121, %118 : i16
    %123 = comb.mux bin %120, %c29_i6, %119 : i6
    %124 = comb.icmp bin eq %state_reg, %c29_i6 : i6
    %125 = comb.add bin %x0, %c1_i16 : i16
    %126 = comb.mux bin %124, %125, %122 : i16
    %127 = comb.mux bin %124, %c30_i6, %123 : i6
    %128 = comb.icmp bin eq %state_reg, %c30_i6 : i6
    %129 = comb.add bin %x0, %c1_i16 : i16
    %130 = comb.mux bin %128, %129, %126 : i16
    %131 = comb.mux bin %128, %c31_i6, %127 : i6
    %132 = comb.icmp bin eq %state_reg, %c31_i6 : i6
    %133 = comb.add bin %x0, %c1_i16 : i16
    %134 = comb.mux bin %132, %133, %130 : i16
    %135 = comb.mux bin %132, %c-32_i6, %131 : i6
    %136 = comb.icmp bin eq %state_reg, %c-32_i6 : i6
    %137 = comb.add bin %x0, %c1_i16 : i16
    %138 = comb.mux bin %136, %137, %134 : i16
    %139 = comb.mux bin %136, %c-31_i6, %135 : i6
    %140 = comb.icmp bin eq %state_reg, %c-31_i6 : i6
    %141 = comb.add bin %x0, %c1_i16 : i16
    %142 = comb.mux bin %140, %141, %138 : i16
    %143 = comb.mux bin %140, %c-30_i6, %139 : i6
    %144 = comb.icmp bin eq %state_reg, %c-30_i6 : i6
    %145 = comb.add bin %x0, %c1_i16 : i16
    %146 = comb.mux bin %144, %145, %142 : i16
    %147 = comb.mux bin %144, %c-29_i6, %143 : i6
    %148 = comb.icmp bin eq %state_reg, %c-29_i6 : i6
    %149 = comb.add bin %x0, %c1_i16 : i16
    %150 = comb.mux bin %148, %149, %146 : i16
    %151 = comb.mux bin %148, %c-28_i6, %147 : i6
    %152 = comb.icmp bin eq %state_reg, %c-28_i6 : i6
    %153 = comb.add bin %x0, %c1_i16 : i16
    %154 = comb.mux bin %152, %153, %150 : i16
    %155 = comb.mux bin %152, %c-27_i6, %151 : i6
    %156 = comb.icmp bin eq %state_reg, %c-27_i6 : i6
    %157 = comb.add bin %x0, %c1_i16 : i16
    %158 = comb.mux bin %156, %157, %154 : i16
    %159 = comb.mux bin %156, %c-26_i6, %155 : i6
    %160 = comb.icmp bin eq %state_reg, %c-26_i6 : i6
    %161 = comb.add bin %x0, %c1_i16 : i16
    %162 = comb.mux bin %160, %161, %158 : i16
    %163 = comb.mux bin %160, %c-25_i6, %159 : i6
    %164 = comb.icmp bin eq %state_reg, %c-25_i6 : i6
    %165 = comb.add bin %x0, %c1_i16 : i16
    %166 = comb.mux bin %164, %165, %162 : i16
    %167 = comb.mux bin %164, %c-24_i6, %163 : i6
    %168 = comb.icmp bin eq %state_reg, %c-24_i6 : i6
    %169 = comb.add bin %x0, %c1_i16 : i16
    %170 = comb.mux bin %168, %169, %166 : i16
    %171 = comb.mux bin %168, %c-23_i6, %167 : i6
    %172 = comb.icmp bin eq %state_reg, %c-23_i6 : i6
    %173 = comb.add bin %x0, %c1_i16 : i16
    %174 = comb.mux bin %172, %173, %170 : i16
    %175 = comb.mux bin %172, %c-22_i6, %171 : i6
    %176 = comb.icmp bin eq %state_reg, %c-22_i6 : i6
    %177 = comb.add bin %x0, %c1_i16 : i16
    %178 = comb.mux bin %176, %177, %174 : i16
    %179 = comb.mux bin %176, %c-21_i6, %175 : i6
    %180 = comb.icmp bin eq %state_reg, %c-21_i6 : i6
    %181 = comb.add bin %x0, %c1_i16 : i16
    %182 = comb.mux bin %180, %181, %178 : i16
    %183 = comb.mux bin %180, %c-20_i6, %179 : i6
    %184 = comb.icmp bin eq %state_reg, %c-20_i6 : i6
    %185 = comb.add bin %x0, %c1_i16 : i16
    %186 = comb.mux bin %184, %185, %182 : i16
    %187 = comb.mux bin %184, %c-19_i6, %183 : i6
    %188 = comb.icmp bin eq %state_reg, %c-19_i6 : i6
    %189 = comb.add bin %x0, %c1_i16 : i16
    %190 = comb.mux bin %188, %189, %186 : i16
    %191 = comb.mux bin %188, %c-18_i6, %187 : i6
    %192 = comb.icmp bin eq %state_reg, %c-18_i6 : i6
    %193 = comb.add bin %x0, %c1_i16 : i16
    %194 = comb.mux bin %192, %193, %190 : i16
    %195 = comb.mux bin %192, %c-17_i6, %191 : i6
    %196 = comb.icmp bin eq %state_reg, %c-17_i6 : i6
    %197 = comb.add bin %x0, %c1_i16 : i16
    %198 = comb.mux bin %196, %197, %194 : i16
    %199 = comb.mux bin %196, %c-16_i6, %195 : i6
    %200 = comb.icmp bin eq %state_reg, %c-16_i6 : i6
    %201 = comb.add bin %x0, %c1_i16 : i16
    %202 = comb.mux bin %200, %201, %198 : i16
    %203 = comb.mux bin %200, %c-15_i6, %199 : i6
    %204 = comb.icmp bin eq %state_reg, %c-15_i6 : i6
    %205 = comb.add bin %x0, %c1_i16 : i16
    %206 = comb.mux bin %204, %205, %202 : i16
    %207 = comb.mux bin %204, %c-14_i6, %203 : i6
    %208 = comb.icmp bin eq %state_reg, %c-14_i6 : i6
    %209 = comb.mux bin %208, %c-14_i6, %207 : i6
