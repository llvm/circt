module {
  hw.module @fsm1(in %clk : !seq.clock, in %rst : i1) {
    ...
    %state_reg = seq.compreg sym @state_reg  %809, %clk reset %rst, %c0_i8 : i8  
    %c0_i16 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %806, %clk reset %rst, %c0_i16 : i16  
    %c1_i16 = hw.constant 1 : i16
    %c113_i16 = hw.constant 113 : i16
    ...
    %401 = comb.icmp bin uge %x0, %c113_i16 : i16
    %402 = comb.icmp bin eq %state_reg, %c100_i8 : i8
    %403 = comb.icmp bin ult %x0, %c113_i16 : i16
    %404 = comb.icmp bin eq %state_reg, %c100_i8 : i8
    %405 = comb.mux bin %404, %c100_i8, %399 : i8
    %406 = comb.mux bin %403, %c16_i8, %c100_i8 : i8
    %407 = comb.and bin %403, %402 : i1
    %408 = comb.mux bin %402, %406, %405 : i8
    %409 = comb.mux bin %401, %c101_i8, %406 : i8
    %410 = comb.and bin %401, %400 : i1
    %411 = comb.mux bin %400, %409, %408 : i8
    %412 = comb.icmp bin eq %state_reg, %c101_i8 : i8
    %413 = comb.add bin %x0, %c1_i16 : i16
    %414 = comb.mux bin %412, %413, %398 : i16
    ...
    %809 = comb.mux bin %808, %c-56_i8, %807 : i8
