module {
  hw.module @fsm1(in %clk : !seq.clock, in %rst : i1) {
    ...
    %state_reg = seq.compreg sym @state_reg  %609, %clk reset %rst, %c0_i8 : i8  
    %c0_i16 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %606, %clk reset %rst, %c0_i16 : i16  
    %c1_i16 = hw.constant 1 : i16
    %c114_i16 = hw.constant 114 : i16
    ...
    %301 = comb.icmp bin uge %x0, %c114_i16 : i16
    %302 = comb.icmp bin eq %state_reg, %c75_i8 : i8
    %303 = comb.icmp bin ult %x0, %c114_i16 : i16
    %304 = comb.icmp bin eq %state_reg, %c75_i8 : i8
    %305 = comb.mux bin %304, %c75_i8, %299 : i8
    %306 = comb.mux bin %303, %c37_i8, %c75_i8 : i8
    %307 = comb.and bin %303, %302 : i1
    %308 = comb.mux bin %302, %306, %305 : i8
    %309 = comb.mux bin %301, %c76_i8, %306 : i8
    %310 = comb.and bin %301, %300 : i1
    %311 = comb.mux bin %300, %309, %308 : i8
    %312 = comb.icmp bin eq %state_reg, %c76_i8 : i8
    %313 = comb.add bin %x0, %c1_i16 : i16
    %314 = comb.mux bin %312, %313, %298 : i16
    %315 = comb.mux bin %312, %c77_i8, %311 : i8
    %316 = comb.icmp bin eq %state_reg, %c77_i8 : i8
    %317 = comb.add bin %x0, %c1_i16 : i16
    %318 = comb.mux bin %316, %317, %314 : i16
    %319 = comb.mux bin %316, %c78_i8, %315 : i8
    %320 = comb.icmp bin eq %state_reg, %c78_i8 : i8
    %321 = comb.add bin %x0, %c1_i16 : i16
    %322 = comb.mux bin %320, %321, %318 : i16
    %323 = comb.mux bin %320, %c79_i8, %319 : i8
    %324 = comb.icmp bin eq %state_reg, %c79_i8 : i8
    %325 = comb.add bin %x0, %c1_i16 : i16
    %326 = comb.mux bin %324, %325, %322 : i16
    %327 = comb.mux bin %324, %c80_i8, %323 : i8
    %328 = comb.icmp bin eq %state_reg, %c80_i8 : i8
    %329 = comb.add bin %x0, %c1_i16 : i16
    %330 = comb.mux bin %328, %329, %326 : i16
    %331 = comb.mux bin %328, %c81_i8, %327 : i8
    %332 = comb.icmp bin eq %state_reg, %c81_i8 : i8
    %333 = comb.add bin %x0, %c1_i16 : i16
    %334 = comb.mux bin %332, %333, %330 : i16
    %335 = comb.mux bin %332, %c82_i8, %331 : i8
    %336 = comb.icmp bin eq %state_reg, %c82_i8 : i8
    %337 = comb.add bin %x0, %c1_i16 : i16
    %338 = comb.mux bin %336, %337, %334 : i16
    %339 = comb.mux bin %336, %c83_i8, %335 : i8
    %340 = comb.icmp bin eq %state_reg, %c83_i8 : i8
    %341 = comb.add bin %x0, %c1_i16 : i16
    %342 = comb.mux bin %340, %341, %338 : i16
    %343 = comb.mux bin %340, %c84_i8, %339 : i8
    %344 = comb.icmp bin eq %state_reg, %c84_i8 : i8
    %345 = comb.add bin %x0, %c1_i16 : i16
    %346 = comb.mux bin %344, %345, %342 : i16
    %347 = comb.mux bin %344, %c85_i8, %343 : i8
    %348 = comb.icmp bin eq %state_reg, %c85_i8 : i8
    %349 = comb.add bin %x0, %c1_i16 : i16
    %350 = comb.mux bin %348, %349, %346 : i16
    %351 = comb.mux bin %348, %c86_i8, %347 : i8
    %352 = comb.icmp bin eq %state_reg, %c86_i8 : i8
    %353 = comb.add bin %x0, %c1_i16 : i16
    %354 = comb.mux bin %352, %353, %350 : i16
    %355 = comb.mux bin %352, %c87_i8, %351 : i8
    %356 = comb.icmp bin eq %state_reg, %c87_i8 : i8
    %357 = comb.add bin %x0, %c1_i16 : i16
    %358 = comb.mux bin %356, %357, %354 : i16
    %359 = comb.mux bin %356, %c88_i8, %355 : i8
    %360 = comb.icmp bin eq %state_reg, %c88_i8 : i8
    %361 = comb.add bin %x0, %c1_i16 : i16
    %362 = comb.mux bin %360, %361, %358 : i16
    %363 = comb.mux bin %360, %c89_i8, %359 : i8
    %364 = comb.icmp bin eq %state_reg, %c89_i8 : i8
    %365 = comb.add bin %x0, %c1_i16 : i16
    %366 = comb.mux bin %364, %365, %362 : i16
    %367 = comb.mux bin %364, %c90_i8, %363 : i8
    %368 = comb.icmp bin eq %state_reg, %c90_i8 : i8
    %369 = comb.add bin %x0, %c1_i16 : i16
    %370 = comb.mux bin %368, %369, %366 : i16
    %371 = comb.mux bin %368, %c91_i8, %367 : i8
    %372 = comb.icmp bin eq %state_reg, %c91_i8 : i8
    %373 = comb.add bin %x0, %c1_i16 : i16
    %374 = comb.mux bin %372, %373, %370 : i16
    %375 = comb.mux bin %372, %c92_i8, %371 : i8
    %376 = comb.icmp bin eq %state_reg, %c92_i8 : i8
    %377 = comb.add bin %x0, %c1_i16 : i16
    %378 = comb.mux bin %376, %377, %374 : i16
    %379 = comb.mux bin %376, %c93_i8, %375 : i8
    %380 = comb.icmp bin eq %state_reg, %c93_i8 : i8
    %381 = comb.add bin %x0, %c1_i16 : i16
    %382 = comb.mux bin %380, %381, %378 : i16
    %383 = comb.mux bin %380, %c94_i8, %379 : i8
    %384 = comb.icmp bin eq %state_reg, %c94_i8 : i8
    %385 = comb.add bin %x0, %c1_i16 : i16
    %386 = comb.mux bin %384, %385, %382 : i16
    %387 = comb.mux bin %384, %c95_i8, %383 : i8
    %388 = comb.icmp bin eq %state_reg, %c95_i8 : i8
    %389 = comb.add bin %x0, %c1_i16 : i16
    %390 = comb.mux bin %388, %389, %386 : i16
    %391 = comb.mux bin %388, %c96_i8, %387 : i8
    %392 = comb.icmp bin eq %state_reg, %c96_i8 : i8
    %393 = comb.add bin %x0, %c1_i16 : i16
    %394 = comb.mux bin %392, %393, %390 : i16
    %395 = comb.mux bin %392, %c97_i8, %391 : i8
    %396 = comb.icmp bin eq %state_reg, %c97_i8 : i8
    %397 = comb.add bin %x0, %c1_i16 : i16
    %398 = comb.mux bin %396, %397, %394 : i16
    %399 = comb.mux bin %396, %c98_i8, %395 : i8
    %400 = comb.icmp bin eq %state_reg, %c98_i8 : i8
    %401 = comb.add bin %x0, %c1_i16 : i16
    %402 = comb.mux bin %400, %401, %398 : i16
    %403 = comb.mux bin %400, %c99_i8, %399 : i8
    %404 = comb.icmp bin eq %state_reg, %c99_i8 : i8
    %405 = comb.add bin %x0, %c1_i16 : i16
    %406 = comb.mux bin %404, %405, %402 : i16
    %407 = comb.mux bin %404, %c100_i8, %403 : i8
    %408 = comb.icmp bin eq %state_reg, %c100_i8 : i8
    %409 = comb.add bin %x0, %c1_i16 : i16
    %410 = comb.mux bin %408, %409, %406 : i16
    %411 = comb.mux bin %408, %c101_i8, %407 : i8
    %412 = comb.icmp bin eq %state_reg, %c101_i8 : i8
    %413 = comb.add bin %x0, %c1_i16 : i16
    %414 = comb.mux bin %412, %413, %410 : i16
    %415 = comb.mux bin %412, %c102_i8, %411 : i8
    %416 = comb.icmp bin eq %state_reg, %c102_i8 : i8
    %417 = comb.add bin %x0, %c1_i16 : i16
    %418 = comb.mux bin %416, %417, %414 : i16
    %419 = comb.mux bin %416, %c103_i8, %415 : i8
    %420 = comb.icmp bin eq %state_reg, %c103_i8 : i8
    %421 = comb.add bin %x0, %c1_i16 : i16
    %422 = comb.mux bin %420, %421, %418 : i16
    %423 = comb.mux bin %420, %c104_i8, %419 : i8
    %424 = comb.icmp bin eq %state_reg, %c104_i8 : i8
    %425 = comb.add bin %x0, %c1_i16 : i16
    %426 = comb.mux bin %424, %425, %422 : i16
    %427 = comb.mux bin %424, %c105_i8, %423 : i8
    %428 = comb.icmp bin eq %state_reg, %c105_i8 : i8
    %429 = comb.add bin %x0, %c1_i16 : i16
    %430 = comb.mux bin %428, %429, %426 : i16
    %431 = comb.mux bin %428, %c106_i8, %427 : i8
    %432 = comb.icmp bin eq %state_reg, %c106_i8 : i8
    %433 = comb.add bin %x0, %c1_i16 : i16
    %434 = comb.mux bin %432, %433, %430 : i16
    %435 = comb.mux bin %432, %c107_i8, %431 : i8
    %436 = comb.icmp bin eq %state_reg, %c107_i8 : i8
    %437 = comb.add bin %x0, %c1_i16 : i16
    %438 = comb.mux bin %436, %437, %434 : i16
    %439 = comb.mux bin %436, %c108_i8, %435 : i8
    %440 = comb.icmp bin eq %state_reg, %c108_i8 : i8
    %441 = comb.add bin %x0, %c1_i16 : i16
    %442 = comb.mux bin %440, %441, %438 : i16
    %443 = comb.mux bin %440, %c109_i8, %439 : i8
    %444 = comb.icmp bin eq %state_reg, %c109_i8 : i8
    %445 = comb.add bin %x0, %c1_i16 : i16
    %446 = comb.mux bin %444, %445, %442 : i16
    %447 = comb.mux bin %444, %c110_i8, %443 : i8
    %448 = comb.icmp bin eq %state_reg, %c110_i8 : i8
    %449 = comb.add bin %x0, %c1_i16 : i16
    %450 = comb.mux bin %448, %449, %446 : i16
    %451 = comb.mux bin %448, %c111_i8, %447 : i8
    %452 = comb.icmp bin eq %state_reg, %c111_i8 : i8
    %453 = comb.add bin %x0, %c1_i16 : i16
    %454 = comb.mux bin %452, %453, %450 : i16
    %455 = comb.mux bin %452, %c112_i8, %451 : i8
    %456 = comb.icmp bin eq %state_reg, %c112_i8 : i8
    %457 = comb.add bin %x0, %c1_i16 : i16
    %458 = comb.mux bin %456, %457, %454 : i16
    %459 = comb.mux bin %456, %c113_i8, %455 : i8
    %460 = comb.icmp bin eq %state_reg, %c113_i8 : i8
    %461 = comb.add bin %x0, %c1_i16 : i16
    %462 = comb.mux bin %460, %461, %458 : i16
    %463 = comb.mux bin %460, %c114_i8, %459 : i8
    %464 = comb.icmp bin eq %state_reg, %c114_i8 : i8
    %465 = comb.add bin %x0, %c1_i16 : i16
    %466 = comb.mux bin %464, %465, %462 : i16
    %467 = comb.mux bin %464, %c115_i8, %463 : i8
    %468 = comb.icmp bin eq %state_reg, %c115_i8 : i8
    %469 = comb.add bin %x0, %c1_i16 : i16
    %470 = comb.mux bin %468, %469, %466 : i16
    %471 = comb.mux bin %468, %c116_i8, %467 : i8
    %472 = comb.icmp bin eq %state_reg, %c116_i8 : i8
    %473 = comb.add bin %x0, %c1_i16 : i16
    %474 = comb.mux bin %472, %473, %470 : i16
    %475 = comb.mux bin %472, %c117_i8, %471 : i8
    %476 = comb.icmp bin eq %state_reg, %c117_i8 : i8
    %477 = comb.add bin %x0, %c1_i16 : i16
    %478 = comb.mux bin %476, %477, %474 : i16
    %479 = comb.mux bin %476, %c118_i8, %475 : i8
    %480 = comb.icmp bin eq %state_reg, %c118_i8 : i8
    %481 = comb.add bin %x0, %c1_i16 : i16
    %482 = comb.mux bin %480, %481, %478 : i16
    %483 = comb.mux bin %480, %c119_i8, %479 : i8
    %484 = comb.icmp bin eq %state_reg, %c119_i8 : i8
    %485 = comb.add bin %x0, %c1_i16 : i16
    %486 = comb.mux bin %484, %485, %482 : i16
    %487 = comb.mux bin %484, %c120_i8, %483 : i8
    %488 = comb.icmp bin eq %state_reg, %c120_i8 : i8
    %489 = comb.add bin %x0, %c1_i16 : i16
    %490 = comb.mux bin %488, %489, %486 : i16
    %491 = comb.mux bin %488, %c121_i8, %487 : i8
    %492 = comb.icmp bin eq %state_reg, %c121_i8 : i8
    %493 = comb.add bin %x0, %c1_i16 : i16
    %494 = comb.mux bin %492, %493, %490 : i16
    %495 = comb.mux bin %492, %c122_i8, %491 : i8
    %496 = comb.icmp bin eq %state_reg, %c122_i8 : i8
    %497 = comb.add bin %x0, %c1_i16 : i16
    %498 = comb.mux bin %496, %497, %494 : i16
    %499 = comb.mux bin %496, %c123_i8, %495 : i8
    %500 = comb.icmp bin eq %state_reg, %c123_i8 : i8
    %501 = comb.add bin %x0, %c1_i16 : i16
    %502 = comb.mux bin %500, %501, %498 : i16
    %503 = comb.mux bin %500, %c124_i8, %499 : i8
    %504 = comb.icmp bin eq %state_reg, %c124_i8 : i8
    %505 = comb.add bin %x0, %c1_i16 : i16
    %506 = comb.mux bin %504, %505, %502 : i16
    %507 = comb.mux bin %504, %c125_i8, %503 : i8
    %508 = comb.icmp bin eq %state_reg, %c125_i8 : i8
    %509 = comb.add bin %x0, %c1_i16 : i16
    %510 = comb.mux bin %508, %509, %506 : i16
    %511 = comb.mux bin %508, %c126_i8, %507 : i8
    ...
    %609 = comb.mux bin %608, %c-106_i8, %607 : i8
