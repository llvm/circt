module {
  hw.module @fsm1(in %clk : !seq.clock, in %rst : i1) {
    ...
    %state_reg = seq.compreg sym @state_reg  %409, %clk reset %rst, %c0_i7 : i7  
    %c0_i16 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %406, %clk reset %rst, %c0_i16 : i16  
    %c1_i16 = hw.constant 1 : i16
    %c79_i16 = hw.constant 79 : i16
    ...
    %201 = comb.icmp bin uge %x0, %c79_i16 : i16
    %202 = comb.icmp bin eq %state_reg, %c50_i7 : i7
    %203 = comb.icmp bin ult %x0, %c79_i16 : i16
    %204 = comb.icmp bin eq %state_reg, %c50_i7 : i7
    %205 = comb.mux bin %204, %c50_i7, %199 : i7
    %206 = comb.mux bin %203, %c21_i7, %c50_i7 : i7
    %207 = comb.and bin %203, %202 : i1
    %208 = comb.mux bin %202, %206, %205 : i7
    %209 = comb.mux bin %201, %c51_i7, %206 : i7
    %210 = comb.and bin %201, %200 : i1
    %211 = comb.mux bin %200, %209, %208 : i7
    %212 = comb.icmp bin eq %state_reg, %c51_i7 : i7
    %213 = comb.add bin %x0, %c1_i16 : i16
    %214 = comb.mux bin %212, %213, %198 : i16
    %215 = comb.mux bin %212, %c52_i7, %211 : i7
    %216 = comb.icmp bin eq %state_reg, %c52_i7 : i7
    %217 = comb.add bin %x0, %c1_i16 : i16
    %218 = comb.mux bin %216, %217, %214 : i16
    %219 = comb.mux bin %216, %c53_i7, %215 : i7
    %220 = comb.icmp bin eq %state_reg, %c53_i7 : i7
    %221 = comb.add bin %x0, %c1_i16 : i16
    %222 = comb.mux bin %220, %221, %218 : i16
    %223 = comb.mux bin %220, %c54_i7, %219 : i7
    %224 = comb.icmp bin eq %state_reg, %c54_i7 : i7
    %225 = comb.add bin %x0, %c1_i16 : i16
    %226 = comb.mux bin %224, %225, %222 : i16
    %227 = comb.mux bin %224, %c55_i7, %223 : i7
    %228 = comb.icmp bin eq %state_reg, %c55_i7 : i7
    %229 = comb.add bin %x0, %c1_i16 : i16
    %230 = comb.mux bin %228, %229, %226 : i16
    %231 = comb.mux bin %228, %c56_i7, %227 : i7
    %232 = comb.icmp bin eq %state_reg, %c56_i7 : i7
    %233 = comb.add bin %x0, %c1_i16 : i16
    %234 = comb.mux bin %232, %233, %230 : i16
    %235 = comb.mux bin %232, %c57_i7, %231 : i7
    %236 = comb.icmp bin eq %state_reg, %c57_i7 : i7
    %237 = comb.add bin %x0, %c1_i16 : i16
    %238 = comb.mux bin %236, %237, %234 : i16
    %239 = comb.mux bin %236, %c58_i7, %235 : i7
    %240 = comb.icmp bin eq %state_reg, %c58_i7 : i7
    %241 = comb.add bin %x0, %c1_i16 : i16
    %242 = comb.mux bin %240, %241, %238 : i16
    %243 = comb.mux bin %240, %c59_i7, %239 : i7
    %244 = comb.icmp bin eq %state_reg, %c59_i7 : i7
    %245 = comb.add bin %x0, %c1_i16 : i16
    %246 = comb.mux bin %244, %245, %242 : i16
    %247 = comb.mux bin %244, %c60_i7, %243 : i7
    %248 = comb.icmp bin eq %state_reg, %c60_i7 : i7
    %249 = comb.add bin %x0, %c1_i16 : i16
    %250 = comb.mux bin %248, %249, %246 : i16
    %251 = comb.mux bin %248, %c61_i7, %247 : i7
    %252 = comb.icmp bin eq %state_reg, %c61_i7 : i7
    %253 = comb.add bin %x0, %c1_i16 : i16
    %254 = comb.mux bin %252, %253, %250 : i16
    %255 = comb.mux bin %252, %c62_i7, %251 : i7
    %256 = comb.icmp bin eq %state_reg, %c62_i7 : i7
    %257 = comb.add bin %x0, %c1_i16 : i16
    %258 = comb.mux bin %256, %257, %254 : i16
    %259 = comb.mux bin %256, %c63_i7, %255 : i7
    %260 = comb.icmp bin eq %state_reg, %c63_i7 : i7
    %261 = comb.add bin %x0, %c1_i16 : i16
    %262 = comb.mux bin %260, %261, %258 : i16
    %263 = comb.mux bin %260, %c-64_i7, %259 : i7
    %264 = comb.icmp bin eq %state_reg, %c-64_i7 : i7
    %265 = comb.add bin %x0, %c1_i16 : i16
    %266 = comb.mux bin %264, %265, %262 : i16
    %267 = comb.mux bin %264, %c-63_i7, %263 : i7
    %268 = comb.icmp bin eq %state_reg, %c-63_i7 : i7
    %269 = comb.add bin %x0, %c1_i16 : i16
    %270 = comb.mux bin %268, %269, %266 : i16
    %271 = comb.mux bin %268, %c-62_i7, %267 : i7
    %272 = comb.icmp bin eq %state_reg, %c-62_i7 : i7
    %273 = comb.add bin %x0, %c1_i16 : i16
    %274 = comb.mux bin %272, %273, %270 : i16
    %275 = comb.mux bin %272, %c-61_i7, %271 : i7
    %276 = comb.icmp bin eq %state_reg, %c-61_i7 : i7
    %277 = comb.add bin %x0, %c1_i16 : i16
    %278 = comb.mux bin %276, %277, %274 : i16
    %279 = comb.mux bin %276, %c-60_i7, %275 : i7
    %280 = comb.icmp bin eq %state_reg, %c-60_i7 : i7
    %281 = comb.add bin %x0, %c1_i16 : i16
    %282 = comb.mux bin %280, %281, %278 : i16
    %283 = comb.mux bin %280, %c-59_i7, %279 : i7
    %284 = comb.icmp bin eq %state_reg, %c-59_i7 : i7
    %285 = comb.add bin %x0, %c1_i16 : i16
    %286 = comb.mux bin %284, %285, %282 : i16
    %287 = comb.mux bin %284, %c-58_i7, %283 : i7
    %288 = comb.icmp bin eq %state_reg, %c-58_i7 : i7
    %289 = comb.add bin %x0, %c1_i16 : i16
    %290 = comb.mux bin %288, %289, %286 : i16
    %291 = comb.mux bin %288, %c-57_i7, %287 : i7
    %292 = comb.icmp bin eq %state_reg, %c-57_i7 : i7
    %293 = comb.add bin %x0, %c1_i16 : i16
    %294 = comb.mux bin %292, %293, %290 : i16
    %295 = comb.mux bin %292, %c-56_i7, %291 : i7
    %296 = comb.icmp bin eq %state_reg, %c-56_i7 : i7
    %297 = comb.add bin %x0, %c1_i16 : i16
    %298 = comb.mux bin %296, %297, %294 : i16
    %299 = comb.mux bin %296, %c-55_i7, %295 : i7
    %300 = comb.icmp bin eq %state_reg, %c-55_i7 : i7
    %301 = comb.add bin %x0, %c1_i16 : i16
    %302 = comb.mux bin %300, %301, %298 : i16
    %303 = comb.mux bin %300, %c-54_i7, %299 : i7
    %304 = comb.icmp bin eq %state_reg, %c-54_i7 : i7
    %305 = comb.add bin %x0, %c1_i16 : i16
    %306 = comb.mux bin %304, %305, %302 : i16
    %307 = comb.mux bin %304, %c-53_i7, %303 : i7
    %308 = comb.icmp bin eq %state_reg, %c-53_i7 : i7
    %309 = comb.add bin %x0, %c1_i16 : i16
    %310 = comb.mux bin %308, %309, %306 : i16
    %311 = comb.mux bin %308, %c-52_i7, %307 : i7
    %312 = comb.icmp bin eq %state_reg, %c-52_i7 : i7
    %313 = comb.add bin %x0, %c1_i16 : i16
    %314 = comb.mux bin %312, %313, %310 : i16
    %315 = comb.mux bin %312, %c-51_i7, %311 : i7
    %316 = comb.icmp bin eq %state_reg, %c-51_i7 : i7
    %317 = comb.add bin %x0, %c1_i16 : i16
    %318 = comb.mux bin %316, %317, %314 : i16
    %319 = comb.mux bin %316, %c-50_i7, %315 : i7
    %320 = comb.icmp bin eq %state_reg, %c-50_i7 : i7
    %321 = comb.add bin %x0, %c1_i16 : i16
    %322 = comb.mux bin %320, %321, %318 : i16
    %323 = comb.mux bin %320, %c-49_i7, %319 : i7
    %324 = comb.icmp bin eq %state_reg, %c-49_i7 : i7
    %325 = comb.add bin %x0, %c1_i16 : i16
    %326 = comb.mux bin %324, %325, %322 : i16
    %327 = comb.mux bin %324, %c-48_i7, %323 : i7
    %328 = comb.icmp bin eq %state_reg, %c-48_i7 : i7
    %329 = comb.add bin %x0, %c1_i16 : i16
    %330 = comb.mux bin %328, %329, %326 : i16
    %331 = comb.mux bin %328, %c-47_i7, %327 : i7
    %332 = comb.icmp bin eq %state_reg, %c-47_i7 : i7
    %333 = comb.add bin %x0, %c1_i16 : i16
    %334 = comb.mux bin %332, %333, %330 : i16
    %335 = comb.mux bin %332, %c-46_i7, %331 : i7
    %336 = comb.icmp bin eq %state_reg, %c-46_i7 : i7
    %337 = comb.add bin %x0, %c1_i16 : i16
    %338 = comb.mux bin %336, %337, %334 : i16
    %339 = comb.mux bin %336, %c-45_i7, %335 : i7
    %340 = comb.icmp bin eq %state_reg, %c-45_i7 : i7
    %341 = comb.add bin %x0, %c1_i16 : i16
    %342 = comb.mux bin %340, %341, %338 : i16
    %343 = comb.mux bin %340, %c-44_i7, %339 : i7
    %344 = comb.icmp bin eq %state_reg, %c-44_i7 : i7
    %345 = comb.add bin %x0, %c1_i16 : i16
    %346 = comb.mux bin %344, %345, %342 : i16
    %347 = comb.mux bin %344, %c-43_i7, %343 : i7
    %348 = comb.icmp bin eq %state_reg, %c-43_i7 : i7
    %349 = comb.add bin %x0, %c1_i16 : i16
    %350 = comb.mux bin %348, %349, %346 : i16
    %351 = comb.mux bin %348, %c-42_i7, %347 : i7
    %352 = comb.icmp bin eq %state_reg, %c-42_i7 : i7
    %353 = comb.add bin %x0, %c1_i16 : i16
    %354 = comb.mux bin %352, %353, %350 : i16
    %355 = comb.mux bin %352, %c-41_i7, %351 : i7
    %356 = comb.icmp bin eq %state_reg, %c-41_i7 : i7
    %357 = comb.add bin %x0, %c1_i16 : i16
    %358 = comb.mux bin %356, %357, %354 : i16
    %359 = comb.mux bin %356, %c-40_i7, %355 : i7
    %360 = comb.icmp bin eq %state_reg, %c-40_i7 : i7
    %361 = comb.add bin %x0, %c1_i16 : i16
    %362 = comb.mux bin %360, %361, %358 : i16
    %363 = comb.mux bin %360, %c-39_i7, %359 : i7
    %364 = comb.icmp bin eq %state_reg, %c-39_i7 : i7
    %365 = comb.add bin %x0, %c1_i16 : i16
    %366 = comb.mux bin %364, %365, %362 : i16
    %367 = comb.mux bin %364, %c-38_i7, %363 : i7
    %368 = comb.icmp bin eq %state_reg, %c-38_i7 : i7
    %369 = comb.add bin %x0, %c1_i16 : i16
    %370 = comb.mux bin %368, %369, %366 : i16
    %371 = comb.mux bin %368, %c-37_i7, %367 : i7
    %372 = comb.icmp bin eq %state_reg, %c-37_i7 : i7
    %373 = comb.add bin %x0, %c1_i16 : i16
    %374 = comb.mux bin %372, %373, %370 : i16
    %375 = comb.mux bin %372, %c-36_i7, %371 : i7
    %376 = comb.icmp bin eq %state_reg, %c-36_i7 : i7
    %377 = comb.add bin %x0, %c1_i16 : i16
    %378 = comb.mux bin %376, %377, %374 : i16
    %379 = comb.mux bin %376, %c-35_i7, %375 : i7
    %380 = comb.icmp bin eq %state_reg, %c-35_i7 : i7
    %381 = comb.add bin %x0, %c1_i16 : i16
    %382 = comb.mux bin %380, %381, %378 : i16
    %383 = comb.mux bin %380, %c-34_i7, %379 : i7
    %384 = comb.icmp bin eq %state_reg, %c-34_i7 : i7
    %385 = comb.add bin %x0, %c1_i16 : i16
    %386 = comb.mux bin %384, %385, %382 : i16
    %387 = comb.mux bin %384, %c-33_i7, %383 : i7
    %388 = comb.icmp bin eq %state_reg, %c-33_i7 : i7
    %389 = comb.add bin %x0, %c1_i16 : i16
    %390 = comb.mux bin %388, %389, %386 : i16
    %391 = comb.mux bin %388, %c-32_i7, %387 : i7
    %392 = comb.icmp bin eq %state_reg, %c-32_i7 : i7
    %393 = comb.add bin %x0, %c1_i16 : i16
    %394 = comb.mux bin %392, %393, %390 : i16
    %395 = comb.mux bin %392, %c-31_i7, %391 : i7
    %396 = comb.icmp bin eq %state_reg, %c-31_i7 : i7
    %397 = comb.add bin %x0, %c1_i16 : i16
    %398 = comb.mux bin %396, %397, %394 : i16
    %399 = comb.mux bin %396, %c-30_i7, %395 : i7
    %400 = comb.icmp bin eq %state_reg, %c-30_i7 : i7
    %401 = comb.add bin %x0, %c1_i16 : i16
    %402 = comb.mux bin %400, %401, %398 : i16
    %403 = comb.mux bin %400, %c-29_i7, %399 : i7
    %404 = comb.icmp bin eq %state_reg, %c-29_i7 : i7
    %405 = comb.add bin %x0, %c1_i16 : i16
    %406 = comb.mux bin %404, %405, %402 : i16
    %407 = comb.mux bin %404, %c-28_i7, %403 : i7
    %408 = comb.icmp bin eq %state_reg, %c-28_i7 : i7
    %409 = comb.mux bin %408, %c-28_i7, %407 : i7
