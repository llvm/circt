module {
  hw.module @fsm105(in %clk : !seq.clock, in %rst : i1) {
    ...
    %state_reg = seq.compreg sym @state_reg  %421, %clk reset %rst, %c0_i7 powerOnValue %pon, %c0_i7: i7  
    %c0_i16 = hw.constant 0 : i16
    %x0 = seq.compreg sym @x0  %418, %clk reset %rst, %c0_i16 powerOnValue %pon, %c0_i16: i16  
    %c1_i16 = hw.constant 1 : i16
    %0 = comb.icmp bin eq %state_reg, %c0_i7 : i7
    %1 = comb.add bin %x0, %c1_i16 : i16
    %2 = comb.mux bin %0, %1, %418 : i16
    ...
    %323 = comb.mux bin %320, %c-47_i7, %319 : i7
    %324 = comb.icmp bin eq %state_reg, %c-47_i7 : i7
    %325 = comb.add bin %x0, %c1_i16 : i16
    %326 = comb.mux bin %324, %325, %322 : i16
    %327 = comb.mux bin %324, %c-46_i7, %323 : i7
    %328 = comb.icmp bin eq %state_reg, %c-46_i7 : i7
    %329 = comb.add bin %x0, %c1_i16 : i16
    %330 = comb.mux bin %328, %329, %326 : i16
    %331 = comb.mux bin %328, %c-45_i7, %327 : i7
    %332 = comb.icmp bin eq %state_reg, %c-45_i7 : i7
    %333 = comb.add bin %x0, %c1_i16 : i16
    %334 = comb.mux bin %332, %333, %330 : i16
    %335 = comb.mux bin %332, %c-44_i7, %331 : i7
    %336 = comb.icmp bin eq %state_reg, %c-44_i7 : i7
    %337 = comb.add bin %x0, %c1_i16 : i16
    %338 = comb.mux bin %336, %337, %334 : i16
    %339 = comb.mux bin %336, %c-43_i7, %335 : i7
    %340 = comb.icmp bin eq %state_reg, %c-43_i7 : i7
    %341 = comb.add bin %x0, %c1_i16 : i16
    %342 = comb.mux bin %340, %341, %338 : i16
    %343 = comb.mux bin %340, %c-42_i7, %339 : i7
    %344 = comb.icmp bin eq %state_reg, %c-42_i7 : i7
    %345 = comb.add bin %x0, %c1_i16 : i16
    %346 = comb.mux bin %344, %345, %342 : i16
    %347 = comb.mux bin %344, %c-41_i7, %343 : i7
    %348 = comb.icmp bin eq %state_reg, %c-41_i7 : i7
    %349 = comb.add bin %x0, %c1_i16 : i16
    %350 = comb.mux bin %348, %349, %346 : i16
    %351 = comb.mux bin %348, %c-40_i7, %347 : i7
    %352 = comb.icmp bin eq %state_reg, %c-40_i7 : i7
    %353 = comb.add bin %x0, %c1_i16 : i16
    %354 = comb.mux bin %352, %353, %350 : i16
    %355 = comb.mux bin %352, %c-39_i7, %351 : i7
    %356 = comb.icmp bin eq %state_reg, %c-39_i7 : i7
    %357 = comb.add bin %x0, %c1_i16 : i16
    %358 = comb.mux bin %356, %357, %354 : i16
    %359 = comb.mux bin %356, %c-38_i7, %355 : i7
    %360 = comb.icmp bin eq %state_reg, %c-38_i7 : i7
    %361 = comb.add bin %x0, %c1_i16 : i16
    %362 = comb.mux bin %360, %361, %358 : i16
    %363 = comb.mux bin %360, %c-37_i7, %359 : i7
    %364 = comb.icmp bin eq %state_reg, %c-37_i7 : i7
    %365 = comb.add bin %x0, %c1_i16 : i16
    %366 = comb.mux bin %364, %365, %362 : i16
    %367 = comb.mux bin %364, %c-36_i7, %363 : i7
    %368 = comb.icmp bin eq %state_reg, %c-36_i7 : i7
    %369 = comb.add bin %x0, %c1_i16 : i16
    %370 = comb.mux bin %368, %369, %366 : i16
    %371 = comb.mux bin %368, %c-35_i7, %367 : i7
    %372 = comb.icmp bin eq %state_reg, %c-35_i7 : i7
    %373 = comb.add bin %x0, %c1_i16 : i16
    %374 = comb.mux bin %372, %373, %370 : i16
    %375 = comb.mux bin %372, %c-34_i7, %371 : i7
    %376 = comb.icmp bin eq %state_reg, %c-34_i7 : i7
    %377 = comb.add bin %x0, %c1_i16 : i16
    %378 = comb.mux bin %376, %377, %374 : i16
    %379 = comb.mux bin %376, %c-33_i7, %375 : i7
    %380 = comb.icmp bin eq %state_reg, %c-33_i7 : i7
    %381 = comb.add bin %x0, %c1_i16 : i16
    %382 = comb.mux bin %380, %381, %378 : i16
    %383 = comb.mux bin %380, %c-32_i7, %379 : i7
    %384 = comb.icmp bin eq %state_reg, %c-32_i7 : i7
    %385 = comb.add bin %x0, %c1_i16 : i16
    %386 = comb.mux bin %384, %385, %382 : i16
    %387 = comb.mux bin %384, %c-31_i7, %383 : i7
    %388 = comb.icmp bin eq %state_reg, %c-31_i7 : i7
    %389 = comb.add bin %x0, %c1_i16 : i16
    %390 = comb.mux bin %388, %389, %386 : i16
    %391 = comb.mux bin %388, %c-30_i7, %387 : i7
    %392 = comb.icmp bin eq %state_reg, %c-30_i7 : i7
    %393 = comb.add bin %x0, %c1_i16 : i16
    %394 = comb.mux bin %392, %393, %390 : i16
    %395 = comb.mux bin %392, %c-29_i7, %391 : i7
    %396 = comb.icmp bin eq %state_reg, %c-29_i7 : i7
    %397 = comb.add bin %x0, %c1_i16 : i16
    %398 = comb.mux bin %396, %397, %394 : i16
    %399 = comb.mux bin %396, %c-28_i7, %395 : i7
    %400 = comb.icmp bin eq %state_reg, %c-28_i7 : i7
    %401 = comb.add bin %x0, %c1_i16 : i16
    %402 = comb.mux bin %400, %401, %398 : i16
    %403 = comb.mux bin %400, %c-27_i7, %399 : i7
    %404 = comb.icmp bin eq %state_reg, %c-27_i7 : i7
    %405 = comb.add bin %x0, %c1_i16 : i16
    %406 = comb.mux bin %404, %405, %402 : i16
    %407 = comb.mux bin %404, %c-26_i7, %403 : i7
    %408 = comb.icmp bin eq %state_reg, %c-26_i7 : i7
    %409 = comb.add bin %x0, %c1_i16 : i16
    %410 = comb.mux bin %408, %409, %406 : i16
    %411 = comb.mux bin %408, %c-25_i7, %407 : i7
    %412 = comb.icmp bin eq %state_reg, %c-25_i7 : i7
    %413 = comb.add bin %x0, %c1_i16 : i16
    %414 = comb.mux bin %412, %413, %410 : i16
    %415 = comb.mux bin %412, %c-24_i7, %411 : i7
    %416 = comb.icmp bin eq %state_reg, %c-24_i7 : i7
    %417 = comb.add bin %x0, %c1_i16 : i16
    %418 = comb.mux bin %416, %417, %414 : i16
    %419 = comb.mux bin %416, %c-23_i7, %415 : i7
    %420 = comb.icmp bin eq %state_reg, %c-23_i7 : i7
    %421 = comb.mux bin %420, %c-23_i7, %419 : i7
    // Assertion:
