...
```    
Once this is added, compile CIRCT. This will cause a decent amount of code to be generated
and will cause some errors due to unimplemented functions. Your goal is to now implement those.  

2) Create a new file that contains your pass. This file should implement:  
  ...
  void visit(/*...*/) { /*...*/ }
  void FooWires::runOnOperation() {
    getOperation().walk([&](Operation* op) { (op); });
  }
  ```
