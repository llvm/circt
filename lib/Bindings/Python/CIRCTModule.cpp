...
NB_MODULE(_circt, m) {
  ...
  m.def(
      ...
      [](nb::object capsule) {
        ...
        // We don't load the LLVM, cf, or func dialects here since they don't load all of their
        // promised interfaces. If you need to load them, you can do so by calling
