...
std::unique_ptr<mlir::Pass> hls::createAffineToLoopSchedule() {
  return std::make_unique<AffineToLoopSchedule>();
}

void hls::registerAffineToLoopScheduleAnalysisPass() {
