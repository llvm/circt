  ...
  void runOnOperation() override {
    auto result = mlir::failableParallelForEach(
        ...
        [](auto module) {
          ...
          auto walkResult = module->template walk<mlir::WalkOrder::PostOrder,
