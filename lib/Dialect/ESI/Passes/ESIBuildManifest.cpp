...
private:
  ...
  llvm::json::Value json(Operation *errorOp, Type, bool useCache = true);
  /// Get a JSON representation of a type.
...
llvm::json::Value ESIBuildManifestPass::json(Operation *errorOp, Type type,
  ...
  if (useCache && typeLookup.contains(type)) {
  ...
  Object o =
      ...
      TypeSwitch<Type, Object>(type)
          .Case([&](ChannelType t) {
            m = "channel";
            return Object({{"inner", json(errorOp, t.getInner(), useCache)}});
          })
            ...
            for (auto field : t.getChannels())
              channels.push_back(Object(
                  {{"name", field.name.getValue()},
                   ...
                   {"type", json(errorOp, field.type, useCache)}}));
          ...
          .Case([&](ListType t) {
            m = "list";
            return Object(
                {{"element", json(errorOp, t.getElementType(), useCache)}});
          })
          .Case([&](hw::ArrayType t) {
            m = "array";
            return Object(
          ...
          .Case([&](hw::TypeAliasType t) {
            ...
            return Object(
                {{"name", t.getTypeDecl(symCache).getPreferredName()},
                 {"inner", json(errorOp, t.getInnerType(), useCache)}});
          })
          .Case([&](IntegerType t) {
            m = "int";
