...
public:
  ...
  virtual std::string rawJsonManifest() const;

  /// Return the zlib compressed JSON system manifest.
  virtual std::vector<uint8_t> rawCompressedManifest() const = 0;
};
...
public:
  ...
  /// Return the zlib compressed JSON system manifest.
  virtual std::vector<uint8_t> rawCompressedManifest() const override;
