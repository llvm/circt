...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc5_TOP__Cosim_DpiPkg(std::string endpoint_id, const VlUnpacked<CData/*7:0*/, 8> &data, IData/*31:0*/ data_size, IData/*31:0*/ &cosim_ep_tryput__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryput__Vdpioc5_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc5_TOP__Cosim_DpiPkg(std::string endpoint_id, VlUnpacked<CData/*7:0*/, 13> &data, IData/*31:0*/ &data_size, IData/*31:0*/ &cosim_ep_tryget__Vfuncrtn) {
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc4_TOP__Cosim_DpiPkg(std::string endpoint_id, VlUnpacked<CData/*7:0*/, 9> &data, IData/*31:0*/ &data_size, IData/*31:0*/ &cosim_ep_tryget__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc4_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc3_TOP__Cosim_DpiPkg(std::string endpoint_id, VlUnpacked<CData/*7:0*/, 1> &data, IData/*31:0*/ &data_size, IData/*31:0*/ &cosim_ep_tryget__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_ep_tryget__Vdpioc3_TOP__Cosim_DpiPkg\n"); );
    // Body
    const char* endpoint_id__Vcvt;
    endpoint_id__Vcvt = endpoint_id.c_str();
...
void VESI_Cosim_Top_Cosim_DpiPkg____Vdpiimwrap_cosim_set_manifest__Vdpioc2_TOP__Cosim_DpiPkg(IData/*31:0*/ esi_version, const VlUnpacked<CData/*7:0*/, 16332> &compressed_manifest) {
    ...
    static const int compressed_manifest__Vopenprops__ulims[2] = {16331, 0};
