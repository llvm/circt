...
#ifndef VERILATED_VESI_COSIM_TOP_WRITEMEM_WIDTH512_H_
#define VERILATED_VESI_COSIM_TOP_WRITEMEM_WIDTH512_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VESI_Cosim_Top_WriteMem_width512 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_IN8(host_ackTag,7,0);
        VL_IN8(host_ackTag_valid,0,0);
        ...
        CData/*0:0*/ address_command__DOT____Vcellinp__Counter__increment;
        ...
        IData/*31:0*/ __PVT__Counter__DOT___GEN;
    ...
    // CONSTRUCTORS
    VESI_Cosim_Top_WriteMem_width512(VESI_Cosim_Top__Syms* symsp, const char* v__name);
    ~VESI_Cosim_Top_WriteMem_width512();
    VL_UNCOPYABLE(VESI_Cosim_Top_WriteMem_width512);
