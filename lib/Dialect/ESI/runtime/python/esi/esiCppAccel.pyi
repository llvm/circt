...
import typing
__all__ = ['Accelerator', 'AcceleratorConnection', 'AnyType', 'AppID', 'ArrayType', 'BitVectorType', 'BitsType', 'BundlePort', 'BundleType', 'ChannelPort', 'ChannelType', 'Cosim', 'CosimManifestMethod', 'Direction', 'From', 'HWModule', 'Instance', 'IntegerType', 'MMIO', 'Manifest', 'ModuleInfo', 'ReadChannelPort', 'SIntType', 'StructType', 'SysInfo', 'To', 'Type', 'UIntType', 'VoidType', 'WriteChannelPort']
...
class CosimManifestMethod:
    ...
    Members:
      ...
      MMIO
    """
    Cosim: typing.ClassVar[CosimManifestMethod]  # value = <CosimManifestMethod.Cosim: 0>
    MMIO: typing.ClassVar[CosimManifestMethod]  # value = <CosimManifestMethod.MMIO: 1>
    __members__: typing.ClassVar[dict[str, CosimManifestMethod]]  # value = {'Cosim': <CosimManifestMethod.Cosim: 0>, 'MMIO': <CosimManifestMethod.MMIO: 1>}
