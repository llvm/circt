...
# Maximum PCIe read request size in bytes. Reads larger than this must be split
# by the requester into multiple requests. Mirrors kPcieMaxReadRequestBytes in
# the Cosim backend (cpp/lib/backends/Cosim.cpp).
PCIE_MAX_READ_REQUEST_BYTES = 4096
