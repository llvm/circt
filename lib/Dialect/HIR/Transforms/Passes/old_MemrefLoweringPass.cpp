...
//------------------------------------------------------------------------------
void MemrefLoweringPass::visitOp(hir::FuncOp op) {
...
void MemrefLoweringPass::visitOp(hir::AllocaOp op) {
...
void MemrefLoweringPass::visitOp(hir::LoadOp op) {
  //  mlir::OpBuilder builder(op.getOperation()->getParentOp()->getContext());
  //  MLIRContext *context = builder.getContext();
  //  builder.setInsertionPoint(op);
  //
...
void MemrefLoweringPass::visitOp(hir::StoreOp op) {
  //  mlir::OpBuilder builder(op.getOperation()->getParentOp()->getContext());
  //  MLIRContext *context = builder.getContext();
  //  builder.setInsertionPoint(op);
  //
...
void MemrefLoweringPass::visitOp(hir::CallOp op) {
  //  mlir::OpBuilder builder(op.getOperation()->getParentOp()->getContext());
  //  MLIRContext *context = builder.getContext();
  //  builder.setInsertionPoint(op);
  //
...
void MemrefLoweringPass::dispatch(Operation *operation) {
