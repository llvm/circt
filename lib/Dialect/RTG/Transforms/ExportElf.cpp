...
namespace {
struct ExportRTGToElfPass
    : public rtg::impl::ExportRTGToElfBase<ExportRTGToElfPass> {
  ExportRTGToElfPass() : rtg::impl::ExportRTGToElfBase<ExportRTGToElfPass>() {}
  ExportRTGToElfPass(const rtg::ExportRTGToElfOptions &options)
      : rtg::impl::ExportRTGToElfBase<ExportRTGToElfPass>(options) {}
