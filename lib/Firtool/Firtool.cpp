...
void mlir::registerFirtoolCLOptions() {
...
preserveAggregate(PreserveAggregate::None),
preserveMode(PreserveValues::None),
...
vbtoBV(false),
noDedup(false),
companionMode(CompanionMode::Bind),
